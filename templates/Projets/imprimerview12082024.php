                ...
                <div style="display: flex; justify-content: space-between;margin-top: -12px;margin-left: -1.5%;">
                    <div style="width: 65%;">
                        ...
                        <div class="boxbordergray" style="height: 30px; margin-left: 3%; margin-right: 5%;font-size: 12px;margin-top: 5px;">
                            <div style="margin-left: 3%;"> <?php echo ucfirst(int2str(sprintf("%01." . $commandeclient->nbfergule . "f", str_replace(",", ".", $commandeclient->totalttc)))); ?></div>
                        </div>
                        <div style="margin-left: 3%; margin-right: 5%;font-size: 11px;">
                            <strong style="display: inline-block;">Conditions de règlement
                                :</strong><?php echo $commandeclient->conditinreglement->condionn; ?>

                        </div><br><br>
                        <div style="margin-left: 3%; margin-right: 5%;font-size: 11px;margin-top: -18px;">
                            <strong>Délai prévue de livraison
                                :</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $commandeclient->delailivraison->name; ?>
                        ...
                        <div style="margin-left: 3%; margin-right: 5%;font-size: 11px;margin-top: -10px;">
                            ...
                            Nom du propriétaire du compte: <?php echo $proprietaire; ?> <br><strong>Code IBAN:
                            <?php echo $compbanq ?></strong><br>
