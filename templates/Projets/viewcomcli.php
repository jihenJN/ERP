        ...
        <div class="col-md-12">
            <div class="box ">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div height="60px">
                                ...
                                OUI <input type="radio" disabled id="1" id="OUI" name='tvaOnOff'
                                ...
                                NON <input type="radio" disabled value="0" id="NON" class="toggleEditcomclient"
                                    name='tvaOnOff' <?php if ($commandeclient->tvaOnOff == 0)
                                        echo "checked"; ?>>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <?php echo $this->Form->input('pay', ['readonly' => true, 'type' => 'text', 'class' => 'form-control ', 'id' => 'pay_id', 'label' => 'Destination']); ?>
                        </div>

                        <div class="col-md-6 deviseSelect">
                            <?php echo $this->Form->input('devisachat_id', ['disabled' => true, 'empty' => 'Veuillez choisir !!', 'value' => $commandeclient->devisachat_id, 'class' => 'form-control', 'id' => 'devisachat_id', 'label' => 'Devises Achat ', 'options' => $devises]); ?>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6" id="">
                            <?php echo $this->Form->input('devis_id', ['disabled' => true, 'value' => $commandeclient->devis_id, 'empty' => 'Veuillez choisir !!', 'class' => 'form-control', 'id' => 'devis_id', 'label' => 'Devises Vente', 'options' => $devises]); ?>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-xs-6" id="">
                            <?php echo $this->Form->input('devis2_id', ['disabled' => true, 'value' => $commandeclient->devis2_id, 'class' => 'form-control', 'id' => 'devis_id2', 'label' => 'Devises par rapport au dinar ', 'options' => $devises, 'empty' => 'Veuillez choisir !!']); ?>
                        </div>
                        <div class="col-xs-6">
                        ...
                        <!-- <div class="col-md-6">
                            <?php echo $this->Form->control('remisetotal', ['readonly' => true, 'value' => $commandeclient->remisetotal, 'label' => 'Remise relative sur le total en %', 'id' => 'remisetotal', 'type' => 'nombre', 'class' => 'form-control']); ?>
                        </div>
                        <div class="col-md-6">
                            <?php echo $this->Form->control('remisetotalval', ['readonly' => true, 'value' => $commandeclient->remisetotalval, 'label' => 'Remise relative sur le total en valeur', 'id' => 'remisetotalval', 'type' => 'nombre', 'class' => 'form-control']); ?>
                        </div> -->
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div height="60px">
                                <label class="control-label" style="margin-top: 25px;">Détait des montant de transport
                                    en pdf:</label>
                                OUI <input type="radio" disabled name="detaittransport" value="1" id="OUItransport"
                                    class="toggleOffreGGBtransport " <?php if ($commandeclient->detaittransport == 1)
                                        echo "checked"; ?> style="margin-right: 17px">
                                NON <input type="radio" disabled name="detaittransport" value="0" id="NONtransport"
                                    class="toggleOffreGGBtransport " <?php if ($commandeclient->detaittransport == 0)
                                        echo "checked"; ?>>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <?php echo $this->Form->control('banque_id', ['value' => $commandeclient->banque_id, 'disabled', 'empty' => 'Veuillez choisir !!!! ', 'id' => 'banque_id', 'class' => 'form-control select2', 'label' => 'Banque']); ?>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-xs-6">
                            <div id="Compteee_id">
                                ...
                                <select name="comptesBank_id" id="comptesBank_id" disabled class="form-control select2">
                                        ...
                                        <table class="table table-bordered table-striped table-bottomless"
                                            ...
                                            <thead>
                                                <tr width:20px>
                                                    ...
                                                    <td align="center" nowrap="nowrap"><strong>HT</strong></td>
                                                ...
                                                foreach ($lignecommandeclients as $res):
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 5%;" hidden>
                                                            <br>
                                                            <select champ="unite_id" id="unite_id<?php echo $i; ?>" disabled
                                                                index="<?php echo $i; ?>"
                                                        ...
                                                        <td align="center">
                                                            <?php if ($res['tauxdemarge'] !== null) {
                                                                ...
                                                                echo $this->Form->input('prixht', array('readonly' => true, 'label' => '', 'value' => sprintf("%01.3f", $res['prixht']), 'name' => 'data[lignecommandeclients][' . $i . '][prixht]', 'type' => 'text', 'id' => 'prixht' . $i, 'table' => 'lignecommandeclients', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control getprixhtson getprixarticle'));
                                                            }
                                                            ?>

                                                        </td>
                                                        <td>
                                                            <?php echo $this->Form->control('typeremise_id', ['disabled' => true,'label' => '', 'value' => $res['typeremise_id'], 'name' => 'data[lignecommandeclients][' . $i . '][typeremise_id]', 'id' => 'typeremise_id' . $i, 'table' => 'lignecommandeclients', 'index' => $i, 'class' => "form-control select2 typeremise_idl", 'options' => $typeremises]);
                                                            ?>
                                                        </td>
                                                        <td align="center">
                                                            <div id="divremise<?php echo $i; ?>"
                                                                ...
                                                                <?php echo $this->Form->input('remise', array('readonly' => true,'label' => '', 'value' => $res['remise'], 'name' => 'data[lignecommandeclients][' . $i . '][remise]', 'type' => 'text', 'id' => 'remise' . $i, 'table' => 'lignecommandeclients', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control getprixhtson number testremise')); ?>
                                                                <i style="    margin-top: 19%;font-size: 18px;" class="fa fa-percent"></i>&thinsp;&thinsp;&thinsp;
                                                            ...
                                                            <div id="divremiseval<?php echo $i; ?>"
                                                                ...
                                                                table="lignecommandeclients" index="<?php echo $i; ?>">
                                                                <?php echo $this->Form->input('remiseval', array('readonly' => true,'label' => '', 'value' => $res['remiseval'], 'name' => 'data[lignecommandeclients][' . $i . '][remiseval]', 'type' => 'text', 'id' => 'remiseval' . $i, 'table' => 'lignecommandeclients', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control getprixhtson number testremiseval')); ?>
                                                            </div>
                                                        </td>
                                                    ...
                                                    if ($parametretaus->tauxmarque == 1) { ?>
                                                        ...
                                                        <td align="center">
                                                            <div id="divremise<?php echo $i; ?>"
                                                                ...
                                                                table="lignecommandeclients" index="<?php echo $i; ?>">
                                                                <?php echo $this->Form->input('remise', array('readonly' => true,'label' => '', 'value' => $res['remise'], 'name' => 'data[lignecommandeclients][' . $i . '][remise]', 'type' => 'text', 'id' => 'remise' . $i, 'table' => 'lignecommandeclients', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control getprixhtson number testremise')); ?>
                                                                <i style="    margin-top: 29%;font-size: 18px;" class="fa fa-percent"></i>&thinsp;&thinsp;&thinsp;
                    ...
                    <div class="col-md-6">
                        <?php
                        echo $this->Form->control('typeremise_id', ['disabled'=>true,'id' => 'typeremise_id', 'class' => "form-control select2 getprixhtson", 'options' => $typeremises]);
                        ?>
                    </div>
                    <div class="col-md-6">
                        <div id="remisetotaldiv" style="display: <?php if($commandeclient->typeremise_id==1){ ?>block<?php }else{ ?>none<?php } ?>">
                            <?php echo $this->Form->control('remisetotal', ['disabled'=>true,'id' => 'remisetotal', 'value' => $commandeclient->remisetotal, 'label' => 'Remise relative sur le total en %', 'type' => 'text', 'min' => 0, 'max' => 100, 'class' => 'form-control number getprixhtson testremise']); ?>

                        </div>
                        <div id="remisetotalvaldiv" style="display: <?php if($commandeclient->typeremise_id==2){ ?>block<?php }else{ ?>none<?php } ?>">
                            <?php echo $this->Form->control('remisetotalval', ['disabled'=>true,'id' => 'remisetotalval', 'value' => $commandeclient->remisetotalval, 'label' => 'Remise relative sur le total en valeur', 'type' => 'text', 'class' => 'form-control number getprixhtson testremiseval']); ?>
                    ...
                    <div class="col-md-6">
                        <?php echo $this->Form->control('totalht', ['readonly' => true, 'value' => sprintf("%01.3f", $commandeclient->totalht)]); ?>
                    </div>
                    <div id="divtva" class="col-xs-3"
                        style="display:<?php echo ($commandeclient->tvaOnOff == 1) ? 'block' : 'none'; ?>">
                        <?php echo $this->Form->control('totaltva', ['readonly' => true, 'value' => sprintf("%01.3f", $commandeclient->totaltva)]); ?>
                    </div>
                    <?php if ($parametretaus->tauxmarque == 1) { ?>
                        <div class="col-md-6">
                            <?php echo $this->Form->control('totalfodec', ['readonly' => true, 'label' => 'Total Taux de Marque', 'id' => 'totalmarque', 'value' => sprintf("%01.3f", $commandeclient->totalfodec)]); ?>
                        </div>
                    <?php }
                    if ($parametretaus->tauxdemarge == 1) { ?>
                        <div class="col-md-6">
                            <?php echo $this->Form->control('totalmarge', ['readonly' => true, 'label' => 'Total Taux de Marge', 'value' => sprintf("%01.3f", $commandeclient->totalmarge), 'id' => 'totalmarge']); ?>
                        </div>
                    <?php } ?>
                    <div class="col-md-6">
                        <?php echo $this->Form->control('totalremise', ['readonly' => true, 'value' => sprintf("%01.3f", $commandeclient->totalremise)]); ?>
                    </div>
                    <div class="col-md-6">
                        <?php echo $this->Form->control('totalttc', ['readonly' => true, 'value' => sprintf("%01.3f", $totalttc)]) ?>
                        <?php
                        echo $this->Form->control('totalttcdl', ['readonly' => true, 'id' => 'totalttcdl', 'type' => 'hidden', 'value' => sprintf("%01.3f", $commandeclient->totalttcdl), 'table' => 'tablecommandeclient', 'label' => 'Total TTC', 'readonly' => true]); ?>
