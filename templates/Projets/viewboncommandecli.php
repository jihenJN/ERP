                                        ...
                                        <table class="table table-bordered table-striped table-bottomless" id="tabligne3">
                                            ...
                                            <thead>
                                                ...
                                                <?php if ($parametretaus->tauxdemarge == 1) { ?>
                                                    ...
                                                    <td align="center" nowrap="nowrap" style="/* word-wrap: break-word;white-space: normal; */"><strong> Pr V</strong></td>
                                                      ...
                                                      <!--  <td style="width: 8%;" align="center">
                                                        ...
                                                        <td>
                                                            <div style="display:flex">
                                                                <div>
                                                                    <?php echo $this->Form->control('typeremise_id', ['label' => '','disabled'=>true, 'value' => $res['typeremise_id'], 'name' => 'data[lignecommandeclients][' . $i . '][typeremise_id]', 'id' => 'typeremise_id' . $i, 'table' => 'lignecommandeclients', 'index' => $i, 'class' => "form-control select2 typeremise_idl", 'options' => $typeremises]);
                                                                    ?>
                                                                </div>
                                                                ...
                                                                <div id="divremise<?php echo $i; ?>" style="display:<?php if ($res['typeremise_id'] == 1) {
                                                                    ...
                                                                    index="<?php echo $i; ?>">
                                                                    <?php echo $this->Form->input('remise', array('label' => '','disabled'=>true, 'value' => $res['remise'], 'name' => 'data[lignecommandeclients][' . $i . '][remise]', 'type' => 'text', 'id' => 'remise' . $i, 'table' => 'lignecommandeclients', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control getprixhtson number testremiseval')); ?>
                                                                ...
                                                                <div id="divremiseval<?php echo $i; ?>" style="display:<?php if ($res['typeremise_id'] == 2) {
                                                                    ...
                                                                    index="<?php echo $i; ?>">
                                                                    <?php echo $this->Form->input('remiseval', array('label' => '','disabled'=>true, 'value' => $res['remiseval'], 'name' => 'data[lignecommandeclients][' . $i . '][remiseval]', 'type' => 'text', 'id' => 'remiseval' . $i, 'table' => 'lignecommandeclients', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control getprixhtson number testremiseval')); ?>
                                                                </div>
                                                            </div>
                                                        </td>
