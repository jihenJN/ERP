...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="<?php echo $this->Url->build(['action' => 'vieww/', $commandeclient->projet_id]); ?>"><i class="fa fa-reply"></i>
                <?php echo __('Retour'); ?>
            </a></li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class=" ">
                <div class="choisir" align="center" style="margin-left:50px; margin-top:20px;">
                    ...
                    <!-- <button type="button" id='demandeclientbtn' style="width: 10%;" class="btn btn-primary btn-sm <?= $act ?>">Demande Client</button> -->
                    <!-- <button type="button" id='offreggbbtn' style="width: 10%;" class="btn btn-primary btn-sm <?= $act ?>">Demande Client</button>
                    <button type="button" id='demandeoffredeprixbtn' style="width: 12%;" class="deduction btn btn-primary btn-sm">Demande Fournisseur</button> -->
                    <!--  <button type="button" id='detaitrans' style="width: 10%;" class="btn btn-primary btn-sm <?= $act ?>">Détails transport</button>-->
                  
                    <!-- <button type="button" id='offreggbbtn' style="width: 10%;" class="btn btn-primary btn-sm <?= $act ?>">Offre GGB</button> -->
                    <!-- <button type="button" id='commandeclientbtn' style="width: 10%;" class="deduction btn btn-primary btn-sm">Commande Client</button> -->
                    <!-- <button type="button" id='commandefournisseurbtn' style="width: 12%;" class="deduction btn btn-primary btn-sm">Commande Fournisseur</button>
