...
<div style="position: relative; top: 3px;">
    ...
    <div style="position: absolute; top: 10px; left: 10%; transform: translateX(-50%); z-index: 1;">
        <?php echo $this->Html->image('logoggb.png', ['alt' => 'CakePHP', 'height' => '80px', 'width' => '110px']); ?>
    </div>
</div>
...
<div class="box" style="width: 96%;height :655px; margin-left:0%;margin-right:5%;margin-top: -8px;">
                ...
                <div style="width: 65%;">
                    <div style="margin-left: 3%; margin-right: 5%;font-size: 11px;margin-top: -6px;">
                        <strong style="display: inline-block;">Conditions de règlement
                            :</strong>50% Avance , le Reste contre Attachement et
                        Décompte
                    ...
                    <!-- <div style="margin-left: 3%; margin-right: 5%;font-size: 11px;margin-top: -15px;">
                    ...
                    <div style="margin-left: 3%; margin-right: 5%;font-size: 11px;margin-top: -10px;">
                        ...
                        Nom du propriétaire du compte: GGB <br><strong>Code IBAN: TN59 0704 0005 8141 0429
                            5479</strong><br>
                        <strong>Code BIC/SWIFT: </strong><strong>CFCTTNTTXXX</strong>
                    </div><br>
