...
<div style="position: relative; top: 0;">
    ...
    <div style="position: absolute; top: 20px; right: 10%; z-index: 1;">
        <a onclick='openWindow(1000, 1000, `<?php echo $wr; ?>/projets/downloadPdf/<?php echo @$id; ?>`)'>
            ...
            <div class="table-responsive ls-table">
                ...
                <div style="display: flex; justify-content: space-between;margin-top: -14px;margin-left: -1.5%;">
                    <div style="width: 65%;">
                        ...
                        <div
                            style="margin-left: 3%; margin-right: 5%;font-size: 10px ;<?php if ($compbanq) { ?>margin-top: -6px;<?php } ?>">
