...
<section class="content">
                    ...
                    <div class="row">
                        ...
                        <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <?php echo $this->Form->control('taux', ['label' => 'Taux de change de devise', 'value' => $commandeclient->tauxdechange, 'id' => 'tauxChange', 'class' => 'form-control  '/* , 'readonly' */]); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <div height="60px">
                                        ...
                                        OUI <input type="radio" id="1" id="OUI" name='tvaOnOff'
                                            class="toggleEditcomclient" <?php if ($commandeclient->tvaOnOff == 1)
                                                echo "checked"; ?>>
                                        NON <input type="radio" value="0" id="NON" class="toggleEditcomclient"
                                    ...
                                    <div class="panel-body">
                                        <div class="table-responsive ls-table">
                                            <table class="table table-bordered table-striped table-bottomless"
                                                ...
                                                <thead>
                                                    <tr width:20px>
                                                        <td align="center" nowrap="nowrap"><strong>Fournisseur</strong>
                                                        </td>

                                                        <td align="center" nowrap="nowrap"
                                                            style="width: 20% !important;word-wrap: break-word;white-space: normal;">
                                                            <strong>&thinsp; &thinsp;
                                                                &thinsp; Produit&thinsp; &thinsp; &thinsp; </strong>
                                                        </td>
                                                        ...
                                                        <td align="center" nowrap="nowrap"><strong>Prix de
                                                                revient</strong></td>
                                                        <?php if ($parametretaus->tauxdemarge == 1) { ?>
                                                            <td align="center" nowrap="nowrap"><strong>Taux de
                                                                    marge</strong></td>
                                                        <?php }
                                                        ...
                                                        <td align="center" nowrap="nowrap"><strong>&thinsp; &thinsp;
                                                                &thinsp; &thinsp; &thinsp; PrixHT&thinsp; &thinsp;
                                                                &thinsp; &thinsp; &thinsp; </strong></td>
                                                        <!-- <td align="center" nowrap="nowrap"><strong>&thinsp; &thinsp;
                                                        ...
                                                        <td align="center" nowrap="nowrap"><strong>&thinsp;
                                                                &thinsp;&thinsp; &thinsp;
                                                                &thinsp; &thinsp; &thinsp;
                                                                &thinsp; PUNHT&thinsp; &thinsp; &thinsp;&thinsp;
                                                                &thinsp;
                                                                &thinsp; &thinsp; &thinsp; </strong></td>
                                                        <td nowrap="nowrap" id='thtva' align="center"
                                                            ...
                                                            <strong>&thinsp; &thinsp; &thinsp; &thinsp; &thinsp;
                                                                Tva&thinsp; &thinsp; &thinsp;&thinsp; &thinsp; </strong>
                                                        </td>
                                                        <!-- <td align="center" nowrap="nowrap">
                                                        ...
                                                        <td align="center" nowrap="nowrap"><strong>&thinsp;
                                                                &thinsp;&thinsp; &thinsp;
                                                                &thinsp; &thinsp; &thinsp;
                                                                &thinsp; &thinsp; &thinsp; TTC&thinsp; &thinsp;
                                                                &thinsp;&thinsp; &thinsp;
                                                                &thinsp; &thinsp; &thinsp;
                                                                &thinsp; &thinsp; </strong></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div style="display:flex">
                                                                    <div>
                                                                        <?php echo $this->Form->control('typeremise_id', ['label' => '', 'value' => $res['typeremise_id'], 'name' => 'data[ligner][' . $i . '][typeremise_id]', 'id' => 'typeremise_id' . $i, 'table' => 'ligner', 'index' => $i, 'class' => "form-control select2 typeremise_idl", 'options' => $typeremises]);
                                                                        ?>
                                                                    ...
                                                                    <div id="divremise<?php echo $i; ?>" style="display:<?php if ($res['typeremise_id'] == 1) {
                                                                        ...
                                                                        index="<?php echo $i; ?>">
                                                                        <?php echo $this->Form->input('remise', array('label' => '', 'value' => $res['remise'], 'name' => 'data[ligner][' . $i . '][remise]', 'type' => 'text', 'id' => 'remise' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control getprixhtson number testremiseval')); ?>
                                                                    ...
                                                                    <div id="divremiseval<?php echo $i; ?>" style="display:<?php if ($res['typeremise_id'] == 2) {
                                                                        ...
                                                                        index="<?php echo $i; ?>">
                                                                        <?php echo $this->Form->input('remiseval', array('label' => '', 'value' => $res['remiseval'], 'name' => 'data[ligner][' . $i . '][remiseval]', 'type' => 'text', 'id' => 'remiseval' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control getprixhtson number testremiseval')); ?>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td champ="tdtva" table="tablelignetva"
                                                                id="tdtva<?php echo $i; ?>"
                                                                name="data[ligner]['<?php echo $i; ?>'][tdtva]"
                                                                index="<?php echo $i; ?>"
                                                                style=" width: 5%;display:<?php echo ($commandeclient->tvaOnOff == 1) ? 'table-cell' : 'none'; ?>"
                                                                align="center">
                                            ...
                                            <table class="table table-bordered table-striped table-bottomless"
                                                ...
                                                <thead>
                                                    <tr width:20px>
                                                        ...
                                                        <td align="center" nowrap="nowrap"><strong>&thinsp; &thinsp;
                                                                &thinsp; Service&thinsp; &thinsp; &thinsp; </strong>
                                                        </td>
                                                        <td align="center" nowrap="nowrap"><strong>Description</strong>
                                                        </td>
                                                        <td align="center" nowrap="nowrap"><strong>Unité</strong></td>
                                                        ...
                                                        <td align="center" nowrap="nowrap"><strong>&thinsp; &thinsp;
                                                                ...
                                                                &thinsp; &thinsp; &thinsp; </strong></td>
                                                        <td align="center" nowrap="nowrap"><strong>&thinsp; &thinsp;
                                                                &thinsp; &thinsp; &thinsp; PUNHT&thinsp; &thinsp;
                                                                &thinsp; &thinsp; &thinsp; </strong></td>
                                                        <td nowrap="nowrap" id='thtva' align="center"
                                                            style="display:<?php echo ($commandeclient->tvaOnOff == 1) ? 'table-cell' : 'none'; ?>">
                                                            <strong>&thinsp; &thinsp; &thinsp; &thinsp; &thinsp;
                                                                Tva&thinsp; &thinsp; &thinsp; &thinsp; &thinsp;
                                                            </strong>
                                                        </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <!-- <td align="center">
                                                                <div id="divremise<?php echo $i; ?>" style="display:<?php if ($res['typeremise_id'] == 1) {
                                                                       ...
                                                                       echo "none";
                                                                   } ?> " table="ligner" index="<?php echo $i; ?>">
                                                                    <?php echo $this->Form->input('remise', array('label' => '', 'value' => $res['remise'], 'name' => 'data[ligner][' . $i . '][remise]', 'type' => 'text', 'id' => 'remise' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control getprixhtson number testremise')); ?>
 ...
 -->
                    ...
                    <div class="col-md-6">
                        ...
                        echo $this->Form->control('totalht', ['label' => 'Total HT', 'readonly' => true, 'value' => $commandeclient->totalht]); ?>
                    </div>
                    ...
                    <?php if ($parametretaus->tauxmarque == 1) { ?>
                        <div class="col-md-6">
                            <?php echo $this->Form->control('totalmarque', ['readonly' => true, 'label' => 'Total Taux de Marque', 'id' => 'totalmarque', 'value' => $commandeclient->totalfodec]); ?>
                        </div>
                    <?php }
                    ...
                    <?php } ?>
                    <div class="col-md-6">
                        <?php echo $this->Form->control('totalremise', ['label' => 'Total remise', 'readonly' => true, 'value' => $commandeclient->totalremise]); ?>
                    </div>
                    <div class="col-md-6">
                        <?php echo $this->Form->control('totalttc', ['label' => 'Total TTC', 'readonly' => true, 'value' => $commandeclient->totalttc]) ?>
                        <?php
                        echo $this->Form->control('totalttcdl', ['label' => 'Total TTC en Dinar', 'readonly' => true, 'id' => 'totalttcdl', 'type' => 'hidden', 'value' => $commandeclient->totalttcdl, 'table' => 'tablecommandeclient']); ?>
                    ...
                    <div align="center">
                        <button type="submit" class="pull-right btn btn-success btn-sm Testqtestock chauff"
                            id="boutonlivraison"
