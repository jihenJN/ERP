...
if ($authData && is_object($authData)) {
    ...
    if ($userSignature) {
        ...
        $signatureData = file_get_contents($w.'/webroot/img/logosignature/' . $userSignature->filename);
...
?>
<?php
$imageUrl = $w.'/webroot/img/logoggb.png';
$imageData = file_get_contents($imageUrl);
if ($imageData !== false) {
    $base64Image = 'data:image/png;base64,' . base64_encode($imageData);
}
$footerUrl = $w.'/webroot/img/footer.png';
...
<div style="margin:30px">
    ...
    <div style="width: 87%;height: 20px;margin-left:75%;margin-right:5%; margin-top: -30px;">
        ...
        <div 
            style=" display: flex; position: relative; justify-content: flex-end !important; color: #103458; font-size: 1.2em; ">
            <strong>Réf. :</strong>
    ...
    <div style="display:flex">
        ...
        <div style=" width: 60%; margin-left:50%;font-size: 12px;margin-top:-4%;">
            Adressé à:
        </div>
    </div>
    <div style="display:flex">
        ...
        <div class="boxblanc" style="width: 53%;height: 160px;margin-left:50%;font-size: 13px;margin-top:-22.59%; ">
    ...
    <div class="boxbordergray" style="width: 104%; height: 19px; margin-left: -1%; margin-right: 5%;margin-top: 2%;">
    ...
    <div class="boxbordergray" style="width: 104%; height: 19px; margin-left: -1%; margin-right: 5%;margin-top: 1%;">
        <div style="font-size: 13px;">
            Note Publique :
            <span style="color: red; font-weight: bold;">
                <?php
                    ...
                    <thead>
                        <tr height="7px">
                            <td align="center" class="solid-border"
                                style="width: 10% !important;border:1px solid gray;">
                                Référence
                            </td>
    ...
    white-space: normal; " class="dotted-border">
                        ...
                        ?>
                                        <tr>
                                            ...
                                            <td height="<?php echo $heighttd; ?>"
                                                style="border-left:1px solid gray;border-bottom:1px solid gray;vertical-align:top;">
                                            </td>
                                            ...
                                            <td style="border-left:1px solid gray;border-right:1px solid gray;border-bottom:1px solid gray;vertical-align:top;">
                                            </td>
                                ...
                                <div style="display: flex; justify-content: space-between;margin-top: -70px;">
                                    ...
                                    <div style="width: 50%;margin-left: 59%;margin-top:-40%;font-size: 13px;">
                                ...
                                <?php if ($userSignature): ?>
                                    <?php echo '<img src="' . $base64Signature . '" alt="Image" height="80px" width="130px" style="float: right; margin-top: 20px; margin-right: 10px;">'; ?>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div  >
                            <hr style="color: black;border: 2px solid;width:80%;  <?php  if($total_transportt!=0 && $total_transportt!=''){ ?> margin-top: 150px; <?php }else{ echo " margin-top: 170px;"; } ?>" class="footerr-textt" />
                            <div align="center" class="footerr-text" style=" <?php  if($total_transportt!=0 && $total_transportt!=''){ ?> margin-top: 150px; <?php }else{ echo " margin-top: 170px;"; } ?>">
                                <table border="0">
                                    <thead>
                                        <tr>
                                            <td style="width:5%"></td>
                                            <td style="width:5%">
                                                ...
                                                $mail_jpg = file_get_contents($w.'/webroot/img/mail.png');
                                                $maps_jpg = file_get_contents($w.'/webroot/img/maps.png');
                                                if ($mail_jpg !== false) {
                                                ...
                                                echo '<img src="' . $imgmail . '" alt="Image" height="30px" width="30px" style="">'; ?>
                                            </td>
                                            <td style="width:5%"> <span style="margin-top:-20%">
                                                    <strong>contact@genuisgb.net</strong> </span></td>
                                            <td style="width:20%"></td>

                                            <td style="width:10%">
                                                <?php echo '<img src="' . $imgmaps . '" alt="Image" height="30px" width="30px" style=" ">'; ?>
