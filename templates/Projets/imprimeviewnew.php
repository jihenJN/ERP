...
<div style="display:flex; width: 90%; margin-left:1%;">
    ...
    <div class="boxblanc" style="margin-left:51%;width: 58%;height: 160px;font-size: 13px;margin-top:-23.4%; ">
        <div style="margin-left:1%">
            ...
            <?php if ($commandeclient->client->Tel) { ?>
                Téléphone:
                <?= h($commandeclient->client->Tel) ?> <?php } ?>
            <br> <?php if ($commandeclient->client->Fax) { ?>
                Fax :
                <?= h($commandeclient->client->Fax) ?> <?php } ?>
            <br> <?php if ($commandeclient->client->Email) { ?>
                Email :
        ...
        foreach ($commandeclient->lignecommandeclients as $lignecommandeclient):
            ...
            if ($lignecommandeclient->type == 1) {
                ...
                <tr class="tr">
                    <td align="center"
                        style="<?php $heitd0 = '';
                        if ($heitab > $tabheight[0]['height'] && $pag == 0 && $nbpage != 0) {
                            $heitd0 = 450 / (float) $tabheight[0]['nbtr'];
                        } else if ($heipin > $tabheight[$pag]['height'] && $pag != $nbpage && $nbpage != 0) {
