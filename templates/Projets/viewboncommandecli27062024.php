            ...
            <div class="box ">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <?php echo $this->Form->input('datelivraison', array('disabled' => true,'value' => $commandeclient->datelivraison, 'type' => 'date',  'value' => $this->Time->format('now', 'd/MM/y'), 'label' => 'Date de livraison', 'id' => 'datelivraison', 'div' => 'form-group ', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control')); ?>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <?php echo $this->Form->input('modetransport_id', ['value' => $commandeclient->modetransport_id, 'value' => '', 'class' => 'form-control select2', 'id' => 'modetransport_id', 'label' => 'Mode transports', 'empty' => 'Veuillez choisir !!']); ?>
