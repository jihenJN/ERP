    ...
    <div style="font-size: 12px;">
        ...
        <span style="color: red; font-weight: bold;">
            ...
            <?php if ($commandefournisseur->fournisseur->port!='') {
                                 ...
                                 ?>-
             <?php } h($commandefournisseur->fournisseur->port); ?>
            <?php if ($commandefournisseur['pay']!='') {
                                    #
                                ?>- <?php } echo $commandefournisseur['pay'] ?>
        </span>
    </div>
</div>
...
<div class="box" style="width: 96%;height :600px; margin-left:0%;margin-right:5%;margin-top: -8px;">
                        ...
                        <div style="margin-left: 60px;">
                            <strong>Total :
                                ...
                                <?php if ($commandefournisseur->fournisseur->port!='') {
                                 ...
                                 ?>-
             <?php }echo $commandefournisseur->fournisseur->port ?>
                                <?php if ($commandefournisseur['pay']!='') {
                                    #
                                ?>- <?php } echo $commandefournisseur['pay'] ?>
                            </strong>
    ...
    <div style="margin-top: -30px;">
        <?php if ($userSignature): ?>
            <?php echo '<img src="' . $base64Signature . '" alt="Image" height="80px" width="200px" style="float: right; margin-top: -6px; margin-right: 20px;">'; ?>
