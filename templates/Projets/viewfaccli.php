                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            <div class="row">
                                <div class="col-xs-6">
                                    <?php echo $this->Form->control('client_id', ['disabled'=>true,'value' => $factureclient->client_id, 'id' => 'client', 'options' => $clients, 'empty' => 'Veuillez choisir !!', 'label' => 'Clients', 'class' => 'form-control select2 control-label']); ?>
                                </div>
                                <div class="col-xs-6">
                                ...
                                <div class="col-xs-6">
                                    <?php echo $this->Form->control('projet_id', ['disabled'=>true,'value' => $factureclient->projet_id, 'options' => $projets, 'empty' => 'Veuillez choisir !!', 'required' => 'off', 'label' => 'Projet', 'class' => 'form-control select2 control-label']); ?>
                                </div>
                                <div class="col-xs-6">
                                    <?php

                                    //debug( $commandeclient);
                                    echo $this->Form->control('remisetotal', ['disabled'=>true,'value' => $factureclient->remisetotal, 'id' => 'remisetotal', 'label' => 'Remise relative sure le total', 'class' => 'form-control getprixhtson number']); ?>
                                </div>
                                <div class="col-xs-6">
                                    <?php

                                    //debug( $commandeclient);
                                    echo $this->Form->control('remisetotalval', ['disabled'=>true,'value' => $factureclient->remisetotalval, 'id' => 'remisetotalval', 'label' => 'Remise relative sure le total par valeur', 'class' => 'form-control getprixhtson number']); ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-2">
                                    <?php echo $this->Form->control('incoterm_id', ['disabled'=>true,'options' => $incoterms, 'empty' => 'Veuillez choisir !!', 'id' => 'incoterm_id', 'class' => 'form-control select2']); ?>
                                </div>
                                <div class="col-xs-2">
                                    <?php echo $this->Form->control('location_incoterms', ['disabled'=>true,'empty' => 'Veuillez choisir !!', 'id' => 'location_incoterms', 'class' => 'form-control']); ?>
                                </div>
                                <div class="col-xs-2">
                                    <?php echo $this->Form->control('options_incotermtotalpdf', ['disabled'=>true,'options' => $incoterms, 'label' => 'Incoterm du total en pdf', 'empty' => 'Veuillez choisir !!', 'id' => 'options_incotermtotalpdf', 'class' => 'form-control select2']); ?>
                                </div>
                                <div class="col-xs-6">
                                    <?php $options_istotaltransportdetaille = [1  => 'Oui', 2 => 'Non'];
                                    echo $this->Form->control('options_istotaltransportdetaille', ['disabled'=>true,'options' => $options_istotaltransportdetaille, 'label' => 'Détail des montants de transport en pdf ', 'empty' => 'Veuillez choisir !!', 'id' => 'options_incotermtotalpdf', 'class' => 'form-control select2']); ?>
                                </div>
                                <div class="col-xs-12">
                                    <?php echo $this->Form->control('options_indicationenpdf', ['readonly'=>true,'type' => 'textarea', 'label' => 'Transports incoterm entre le port d embarquement et le port de destination', 'empty' => 'Veuillez choisir !!', 'id' => 'options_indicationenpdf', 'class' => 'form-control']); ?>
                                </div>
                                <div class="col-xs-6">
                            <div height="60px">
                                <label class="control-label" for="unipxte-id">TVA:</label>
                                OUI <input type="radio" disabled id="1" id="OUI" name='tvaOnOff' class="toggleEditcomclient" <?php if ($factureclient->tvaOnOff == 1)
                                                                                                                            echo "checked"; ?>>
                                NON <input type="radio" disabled value="0" id="NON" class="toggleEditcomclient" name='tvaOnOff' <?php if ($factureclient->tvaOnOff == 0)
                                                                                                                            echo "checked"; ?>>
                            </div>
                        </div>
                            </div>
                    ...
                    <?php foreach ($bonlivraison as $key => $v) { ?>
                        <div style=" position: static;">
                            <div class="col-xs-3">
                                <?php echo $this->Form->control('nbligne', ['readonly'=>true,'value' => $v->commande->nbligne, 'nbligne' => 'Poids', 'readonly' => 'readonly', 'label' => 'Ligne bon de commande', 'name', 'required' => 'off']); ?>
                            </div>
                            <div class="col-xs-3">
                                <?php echo $this->Form->control('Poids', ['readonly'=>true,'id' => 'Poids', 'value' => $v->commande->Poids, 'readonly' => 'readonly', 'label' => 'Poids', 'name', 'required' => 'off']); ?>
                            </div>
                            <div class="col-xs-3">
                                <?php echo $this->Form->control('Coeff', ['readonly'=>true,'id' => 'Coeff', 'value' => $v->commande->Coeff, 'readonly' => 'readonly', 'label' => 'NB Palette', 'name', 'required' => 'off']); ?>
                            </div>
                            <div class="col-xs-3">
                                <?php echo $this->Form->control('pallette', ['readonly'=>true,'id' => 'pallette', 'value' => $v->commande->pallette, 'readonly' => 'readonly', 'label' => 'Poids Par palette', 'name', 'required' => 'off']); ?>
                            </div>
                        </div>
                    <?php } ?>
                    <section class="content-header">
                                        ...
                                        <table class="table table-bordered table-striped table-bottomless" id="addtable">
                                            ...
                                            <thead>
                                                <tr width:20px>
                                                    ...
                                                    <td nowrap="nowrap" id='thtva' align="center" style="display:<?php echo ($factureclient->tvaOnOff == 1) ? 'block' : 'none'; ?>">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td style="width: 10% !important;" align="center">
                                                        ...
                                                        <td style="width: 10%;">
                                                            <?php echo $this->Form->input('description', array('readonly'=>true,'label' => '', 'value' => $res['description'], 'name' => 'data[ligner][' . $i . '][description]',  'id' => 'description' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control  ')); ?>


                                                        </td>

                                                        <td style="width: 5%;">
                                                            <?php echo $this->Form->control('unite_id', ['disabled'=>true,'empty' => 'Veuillez choisir !!!', 'index' => $i, 'id' => 'unite_id' . $i, 'options' => $unites, 'value' => $res['unite_id'], 'name' => 'data[ligner][' . $i . '][unite_id]', 'label' => '', 'table' => 'ligner', 'champ' => 'unite_id', 'class' => 'form-control select2 ']); ?>


                                                        </td>
                                                        <td style="width: 5%;" align="center">
                                                            <?php echo $this->Form->input('qte', array('readonly'=>true,'label' => '', 'value' => $res['qte'], 'name' => 'data[ligner][' . $i . '][qte]', 'type' => 'text', 'id' => 'qte' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control number getprixhtson ')); ?>
                                                        </td>
                                                        <td style="width: 10%;" align="center">
                                                            <?php echo $this->Form->input('coutrevient', array('readonly'=>true,'label' => '', 'value' => $res['coutrevient'], 'name' => 'data[ligner][' . $i . '][coutrevient]', 'type' => 'text', 'id' => 'coutrevient' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control  number getprixhtson getprixarticle calculprix')); ?>
                                                        </td>
                                                        <td style="width: 5%;" align="center">
                                                            <?php echo $this->Form->input('tauxdemarge', array('readonly'=>true,'label' => '', 'value' => $res['tauxdemarge'], 'name' => 'data[ligner][' . $i . '][tauxdemarge]', 'type' => 'text', 'id' => 'tauxdemarge' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control number getprixhtson getprixarticle calculprix')); ?>
                                                        </td>
                                                        <td style="width: 5%;" align="center">
                                                            <?php echo $this->Form->input('tauxdemarque', array('readonly'=>true,'label' => '', 'value' => $res['tauxdemarque'], 'name' => 'data[ligner][' . $i . '][tauxdemarque]', 'type' => 'text', 'id' => 'tauxdemarque' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control number getprixhtson getprixarticle calculprix')); ?>
                                                        </td>

                                                        <td align="center" style="width: 10%;">
                                                            <?php if ($res['tauxdemarge'] !== null) {

                                                                echo $this->Form->input('prixht', array('readonly'=>true,'label' => '', 'value' => intval($res['prixht']), 'name' => 'data[ligner][' . $i . '][prixht]', 'type' => 'text', 'id' => 'prixht' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control getprixhtson getprixarticle number calculprix'));
                                                            } else {
                                                                echo $this->Form->input('prixht', array('readonly'=>true,'label' => '', 'value' => sprintf("%01.3f", $res['prixht']), 'name' => 'data[ligner][' . $i . '][prixht]', 'type' => 'text', 'id' => 'prixht' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control getprixhtson number getprixarticle calculprix'));
                                                            }
                                                            ?>

                                                        </td>
                                                        <td style="width: 5%;" align="center">
                                                            <?php echo $this->Form->input('remise', array('readonly'=>true,'label' => '', 'value' => $res['remise'], 'name' => 'data[ligner][' . $i . '][remise]', 'type' => 'text', 'id' => 'remise' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control getprixhtson number calculprix')); ?>
                                                        </td>
                                                        <td style="width: 10%;" align="center">
                                                            <?php echo $this->Form->input('punht', array('readonly'=>true,'label' => '', 'value' => $res['punht'], 'name' => 'data[ligner][' . $i . '][punht]', 'type' => 'text', 'id' => 'punht' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control getprixhtson number calculprix')); ?>
                                                        </td>
                                                        <td style="width: 5%;display:<?php echo ($factureclient->tvaOnOff == 1) ? 'block' : 'none'; ?>" champ="tdtva" table="tablelignetva" id="tdtva<?php echo $i; ?>" name="data[ligner]['<?php echo $i; ?>'][tdtva]" index="<?php echo $i; ?>" align="center">
                                                            <?php echo $this->Form->input('tva', array('readonly'=>true,'label' => '', 'value' => $res->tva, 'name' => 'data[ligner][' . $i . '][tva]', 'type' => 'text', 'id' => 'tva' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control getprixhtson number calculprix')); ?>
                                                        </td>
                                                        <!-- <td style="width: 5%;" align="center">
                                                            <?php echo $this->Form->input('fodec', array('readonly'=>true,'label' => '', 'value' => $res['fodec'], 'name' => 'data[ligner][' . $i . '][fodec]', 'type' => 'text', 'id' => 'fodec' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control getprixhtson number calculprix')); ?>
                                                        </td> -->
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!-- <td style="width: 8%;" align="center"> -->
                                                        <!-- <?php echo $this->Form->input('prixht', array('readonly'=>true,'label' => '', 'value' => $res['prixht'], 'name' => 'data[ligner][' . $i . '][prixht]', 'type' => 'text', 'id' => 'prixht' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control number getprixhtson getprixarticle')); ?> -->
                                                        <!-- </td> -->
                                                        <td align="center">
                                                            <?php if ($res['tauxdemarge'] !== null) {

                                                                echo $this->Form->input('prixht', array('readonly'=>true,'label' => '', 'value' => intval($res['prixht']), 'name' => 'data[ligner][' . $i . '][prixht]', 'type' => 'text', 'id' => 'prixht' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control number getprixhtson getprixarticle'));
                                                            } else {
                                                                echo $this->Form->input('prixht', array('readonly'=>true,'label' => '', 'value' => sprintf("%01.3f", $res['prixht']), 'name' => 'data[ligner][' . $i . '][prixht]', 'type' => 'text', 'id' => 'prixht' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control number getprixhtson getprixarticle'));
                                                            }
                                                            ?>

                                                        </td>
                                                        <td style="width: 8%;" align="center">
                                                            <?php echo $this->Form->input('remise', array('readonly'=>true,'label' => '', 'value' => $res['remise'], 'name' => 'data[ligner][' . $i . '][remise]', 'type' => 'text', 'id' => 'remise' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control number getprixhtson ')); ?>
                                                        </td>
                                                        <td style="width: 8%;" align="center">
                                                            <?php echo $this->Form->input('punht', array('readonly'=>true,'label' => '', 'value' => $res['punht'], 'name' => 'data[ligner][' . $i . '][punht]', 'type' => 'text', 'id' => 'punht' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control number getprixhtson ')); ?>
                                                        </td>
                                                        <td champ="tdtva" table="tablelignetva" id="tdtva<?php echo $i; ?>" name="data[ligner]['<?php echo $i; ?>'][tdtva]" index="<?php echo $i; ?>"  align="center">
                                                            <?php echo $this->Form->input('tva', array('readonly'=>true,'label' => '', 'value' => $res->tva, 'name' => 'data[ligner][' . $i . '][tva]', 'type' => 'text', 'id' => 'tva' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control number getprixhtson ')); ?>
                                                        </td>
