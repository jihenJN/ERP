      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <div class="row">
            ...
            <div class="col-xs-6">
              <?php echo $this->Form->control('personnel_id', ['required' => 'off', 'empty' => 'Veuillez choisir !!!!', 'style' => "pointer-events: none;", 'readonly', 'id' => 'personnel_id', 'value' => $personnel_id, 'class' => 'form-control', 'label' => 'Commercial']); ?>
            </div>
            <!-- <div class="col-xs-1" style="margin-top: 31px;">
          ...
          <div class="row">
            ...
            <div class="col-xs-1" style="margin-top: 31px;">
              <a><i class="fa fa fa-plus urldevise" style="color:success;font-size: 25px;"></i></a>
            </div>
            <div class="col-xs-6">
              <?php echo $this->Form->control('budget', ['class' => 'form-control ', 'type' => 'number', 'champ' => 'name', 'label' => 'Budget']); ?>
            </div>
            <!-- <div class="col-xs-5">
              <?= $this->Form->control('banque_id', ['required' => 'off', 'empty' => 'Veuillez choisir !!!!', 'id' => 'banque_id', 'class' => 'form-control select2', 'label' => 'Banque/Devises', 'options' => $banquesssss]); ?>
            </div>
            <div class="col-xs-1" style="margin-top: 31px;">
              <a><i class="fa fa fa-plus urlbanque" style="color:success;font-size: 25px;"></i></a>
            </div> -->
          </div>
          <!-- <div class="row">
            ...
            <div class="col-xs-6">
                <div id="Compteee_id">
                <?= $this->Form->control('comptesBank_id', ['required' => 'off', 'empty' => 'Veuillez choisir !!!!', 'id' => 'comptesBank_id', 'class' => 'form-control select2', 'label' => 'Comptes bancaires', 'options' => $comptesBanks]); ?>
              </div> 
            </div> 
          </div>-->
          <div class="row">
            <div class="col-xs-6">
              <?php echo $this->Form->control('montant', ['class' => 'form-control ', 'type' => 'number', 'champ' => 'montant', 'label' => 'Montant opportunité']); ?>
            </div>
            <div class="col-xs-6">
              <?php echo $this->Form->control('lien', ['required' => 'off', 'id' => 'lien', 'type' => 'text', 'class' => 'form-control', 'label' => 'Lien Export']); ?>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-6">
              <?= $this->Form->control('tagcategorie_id', ['required' => 'off', 'empty' => 'Veuillez choisir !!!!', 'id' => 'tagcategorie_id', 'class' => 'form-control select2', 'label' => 'Tag categories', 'options' => $tagcategories]); ?>
            </div>

            <div class="col-xs-6">
              <?php echo $this->Form->control('lienetude', ['required' => 'off', 'id' => 'lienetude', 'type' => 'text', 'class' => 'form-control', 'label' => 'Lien Etude']); ?>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-6">
                    ...
                    <tbody>
                      <tr class="tr" index="" name="" champ="trarticle" table="client" style="display: none !important">
                        <td align="center">
                          ...
                          <!-- <div index="" id="" champ="cliinput" class="col-md-10" style="display: none !important">
                            <?php echo $this->Form->input('a', array('label' => '', 'name' => '', 'id' => 'id', 'class' => 'form-control', 'champ' => 'clientname', 'table' => 'lignec', 'div' => 'form-group', 'between' => '<div class="col-sm-12 " >', 'after' => '</div>')); ?>
                          </div>
                          <br>
                          <span title="ajout article"> <a href="javascript:;" class="btn btn-primary ajoclient"><i
                                class='fa fa fa-plus'></i></a></span> -->
                        </td>
                        <!-- <td align="center">
                          <div style="position: static; margin-top: 6px;">
                            <a><i class="fa fa fa-plus urlclient" style="color: success; font-size: 20px;"></i></a>
                          </div>
                        </td> -->
                        <td align="center">
                          <div class="col-xs-1" style="margin-top: 31px;">
