...
<!-- <section class="content-header">
    <td colspan="3">
        <div style="float: left;font-size: 12px;margin-left:10px;"><strong> Nouveau produit | Service</strong></div>
            ...
            <div class="box ">
                    ...
                    <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                        <div class="col-xs-6">
                            ...
                            <select name="typearticle" class="form-control" id="ch81">
                                ...
                                <option value="1" selected> produit
                            </select>
                        </div>
                        <div class="col-xs-6">
                        </div>
                ...
                <div class="row" style="font-size: 12px;">
                    <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                        <div class="col-xs-12">
                            ...
                            <?php echo $this->Form->control('Description', ['maxlength'=>'524288','class' => 'form-control', 'type' => 'textarea', 'label' => 'Description']); ?>
                        </div>
                ...
                <div class="row">
                    <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                        ...
                        <div class="col-xs-12" style="font-size: 12px;">
                            <?php echo $this->Form->control('note', ['maxlength'=>'524288','class' => 'form-control', 'type' => 'textarea', 'label' => 'Note (non visible sur les factures, propals...)']); ?>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                        ...
                        <div class="col-xs-3" style="font-size: 12px;">
                            <div id="showlist10">
                                <?php echo $this->Form->control('fournisseur_id', ['label' => 'Fournisseurs', 'id' => 'fournisseur_id', 'class' => 'form-control select2 control-label']); ?>
                            </div>
                        </div>
                        <!-- <div class="col-xs-1" style="margin-top: 31px;">
                            <div id="showlist11">
                                <a><i class="fa fa fa-plus urlfournisseurs"
                ...
                <div class="row" style="font-size: 12px;">
                    <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                        ...
                        <div class="col-xs-3">
                            <?php echo $this->Form->control('categorie_id', ['required' => 'off', 'empty' => 'Veuillez choisir !!!!', 'id' => 'categorie_id', 'class' => 'form-control select2', 'label' => 'Categorie']); ?>
                        </div>
                        <!-- <div class="col-xs-1" style="margin-top: 31px;">
                            <a><i class="fa fa fa-plus urlcategorie" style="color:success;font-size: 25px;"></i></a>
                        </div> -->
                        <!-- <div class="col-xs-1" style="margin-top: 31px;">
                ...
                <div class="row" style="font-size: 12px;">
                    <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                        <div class="col-xs-3">
                            <?php echo $this->Form->control('PrixV', ['label' => 'Prix de vente', 'type' => 'text', 'class' => 'form-control number ']); ?>
                        </div>
                        <div class="col-xs-3">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        addButton.addEventListener('click', function (event) {
            ...
            const prixv = document.getElementById('prixv');
            const Dsignation = document.getElementById('Dsignation');
            const unite = document.getElementById('unite-id');
            ...
            if (!categorieField.value && typearticleField.value == 1) {
                alert('NB: Les champs en bleu sont obligatoire, Le champ "Catégorie" est manquant.');
                event.preventDefault();
                return;
            }
            if (!prixv.value) {
                alert('NB: Les champs en bleu sont obligatoire, Le champ "Prix de vente" est manquant.');
                event.preventDefault();
                return;
            }
            if (!Dsignation.value) {
                alert('NB: Les champs en bleu sont obligatoire, Le champ "Libellé" est manquant.');
                event.preventDefault();
                return;
            }
            if (!unite.value) {
                alert('NB: Les champs en bleu sont obligatoire, Le champ "Unité" est manquant.');
                event.preventDefault();
                return;
            }
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('.urlcategorie').on('click', function () {
            var currentUrl = window.location.href;
            var parentUrl = currentUrl.split('/').slice(0, -2).join('/');
