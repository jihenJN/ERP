...
$heiii+=$vmp;
  ...
  $hei+=$vmp;
                ...
                ?>
                <tr class="tr">
                    <td align="center" style="vertical-align:top;fontSieze;: 16px !important;word-break: break-word;  white-space: normal; "
    ...
    font-size: 18px;">contact@genuisgb.net</strong> </span></td>
            ...
            <br><br>
            <br><br><br><br><br>
            <table class="tabstyle" style="margin-left:1%;width: 98%;heigth:1000px!important" >
                <thead>
                    <tr height="7px">
     ...
     /*   switch ($k) {
       ...
       /* for ($s = 0; $s <= $tl; $s++) {
        ...
        <tr>
            ...
            <td style="border-left:1px solid gray;border-bottom:1px solid gray;vertical-align:top;height:<?php echo $heighttd1; ?>px !important;">
...
function calculateTdHeight($content, $fontSize, $lineHeight, $charsPerLine) {
    ...
    $lines = ceil(strlen($content) / $charsPerLine);
