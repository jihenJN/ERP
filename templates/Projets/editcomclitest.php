        ...
        <div class="col-md-12">
            <div class="box ">
                ...
                <div class="box-body">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($lignecommandeclients as $res):
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <div id="divremise<?php echo $i; ?>"  style="display:<?php if($res['typeremise_id']==1){ echo "block"; }else{ echo "none";} ?> "
                                                            ...
                                                            <div id="divremiseval<?php echo $i; ?>" style="display:<?php if($res['typeremise_id']==2){ echo "block"; }else{ echo "none";} ?> "
                                                                table="lignecommandeclients" index="<?php echo $i; ?>">
                                                ...
                                                <tr class='tr' style="display: none !important">
                                                    ...
                                                    <td>
                                                        <?php
                                                        echo $this->Form->control('typeremise_id', ['champ' => 'typeremise_id', 'label' => '', 'name' => '', 'table' => 'lignecommandeclients', 'class' => "form-control select2 typeremise_idl", 'options' => $typeremises]);
                                                        ?>
                                                    </td>
                                                    <td align="center">
                                                        <div champ="divremise"
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($lignecommandeclient2s as $res):
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 8%;" align="center">
                                                        <div id="divremise<?php echo $i; ?>" table="lignecommandeclients" index="<?php echo $i; ?>"  style="display:<?php if($res['typeremise_id']==1){ echo "block"; }else{ echo "none";} ?> "> 
                                                       ...
                                                       <div id="divremiseval<?php echo $i; ?>" table="lignecommandeclients" index="<?php echo $i; ?>" style="display:<?php if($res['typeremise_id']==2){ echo "block"; }else{ echo "none";} ?> "> 
                                                ...
                                                <tr class='tr' style="display: none !important">
                                                    ...
                                                    <div champ="divremiseval" table="lignecommandeclients"  style="display:none">
                    ...
                    <div class="col-md-6">
                        <?php
                        echo $this->Form->control('typeremise_id', ['id' => 'typeremise_id', 'class' => "form-control select2 getprixhtson", 'options' => $typeremises]);
                        ?>
                    </div>
                    <div class="col-md-6">
