                ...
                <div class="box-body">
                        ...
                        <div class="row">
                            <div class="box">
                                <div class="box-header with-border">
                                    <a class="btn btn-primary  ajoutfrart" table='addtable' index='index'
                                        id='ajouter_ligne33s' style="
                                       float: right;
                                       margin-bottom: 5px;
                                       ">
                                        ...
                                        <table class="table table-bordered  table-bottomless" id="tabligne3">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td align="center"  >
                                                        <strong>&thinsp; &thinsp; &thinsp;&thinsp; &thinsp;
                                                            &thinsp;&thinsp; &thinsp; &thinsp;&thinsp; &thinsp;
                                                            &thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;Fournisseur&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;
                                                            &thinsp; &thinsp;&thinsp; &thinsp; &thinsp;&thinsp; &thinsp;
                                                            &thinsp;&thinsp; &thinsp; &thinsp;</strong>
                                                    </td>

                                                    <td align="center" style="width: 20% !important;word-wrap: break-word;white-space: normal;">
                                                    ...
                                                    <td align="center" nowrap="nowrap"><strong>&thinsp; &thinsp;
                                                            &thinsp; &thinsp; &thinsp; HT&thinsp; &thinsp; &thinsp;
                                                            &thinsp; &thinsp; </strong></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <div style="display:flex">
                                                                <div style="    width: 85%;">
                                                                    <?php
                                                                    echo $this->Form->control('fournisseur_id', ['empty' => 'Veuillez choisir !!!', 'index' => $i, 'id' => 'fournisseur_id' . $i, 'options' => $fournisseurs, 'value' => $res['fournisseur_id'], 'name' => 'data[lignecommandeclients][' . $i . '][fournisseur_id]', 'style'=>'width: 100%;','label' => '', 'table' => 'lignecommandeclients', 'champ' => 'fournisseur_id', 'class' => 'form-control select2 frarticle ']); ?>
                                                        ...
                                                        <td >
                                                            ...
                                                            <br>
                                                            <div>
                                                            <select style="    width: 193.75px;"
                                                                name="data[lignecommandeclients][<?php echo $i ?>][article_id]"
                                                                id="article_id<?php echo $i ?>" index="<?php echo $i ?>"
                                                                class="form-control select2 getprixarticle Testdep getart getprixhtson">
                                                                <option value="">Veuillez choisir !!!</option>
                                                                <?php foreach ($articles as $key => $art) {

                                                                    ?>
                                                                    <option value="<?php echo $art['id'] ?>" <?php if ($art['id'] == $res['article_id']) { ?>selected<?php } ?>>
                                                                        <?php echo $art['Dsignation'] . ' ' . $art['Description'] ?>
                                                                    </option>
                                                                <?php } ?>
                                                        ...
                                                        <td>
                                                            <div style="display:flex">
                                                                ...
                                                                <div id="divremise<?php echo $i; ?>" style="display:<?php if ($res['typeremise_id'] == 1) {
                                                                    ...
                                                                    index="<?php echo $i; ?>">
                                                                    <?php echo $this->Form->input('remise', array('label' => '', 'value' => $res['remise'], 'name' => 'data[lignecommandeclients][' . $i . '][remise]', 'type' => 'text', 'id' => 'remise' . $i, 'table' => 'lignecommandeclients', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control getprixhtson number testremiseval')); ?>
                                                ...
                                                <tr class='tr' style="display: none !important">
                                                    ...
                                                    <td style="width: 20%;" align="center">
                                                        ...
                                                        <div style="display:flex;width:100%">
                                                            ...
                                                            <i style="color:#3c8dbc;font-size: 25px;    margin-top: 11%;"
                                                    ...
                                                    <td style="width: 10%;" align="center">
                                                        ...
                                                        <br>
                                                        <select table="lignecommandeclients" champ="article_id" style="width: 193.75px"
                                                            class="form-control getart  getprixarticle Testdep getprixhtson">
                                                            <option value="">Veuillez choisir !!!</option>
                                                    ...
                                                    <td>
                                                        <div style="display:flex">
                                                            ...
                                                            <div champ="divremise" table="lignecommandeclients"
                                                                style="display:block">
                                                                <?php echo $this->Form->input('remise', array('champ' => 'remise', 'label' => '', 'name' => '', 'type' => 'text', 'id' => '', 'table' => 'lignecommandeclients', 'index' => '', 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control getprixhtson number testremiseval ')); ?>

                                                                <!-- <i style="    margin-top: 26%;font-size: 18px;"
                                                                    class="fa fa-percent"></i>&thinsp;&thinsp;&thinsp; -->
                                        ...
                                        <table class="table table-bordered table-striped table-bottomless"
                                            ...
                                            <thead>
                                                <tr width:20px>
                                                    ...
                                                    <td align="center" nowrap="nowrap"width="10%"><strong>&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;Pr A
                                                    &thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;<!-- <span id="diviseachat">
                                                            <?php echo $deviseprojet ?> </span> -->
                                                        </strong></td>
                                                    <td align="center" nowrap="nowrap" width="10%"><strong>Pr R
                                                    ...
                                                    <?php } ?>
                                                    <td align="center" nowrap="nowrap"  width="10%"><strong>&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp; &thinsp;
                                                            &thinsp; &thinsp; &thinsp; Pr V&thinsp; &thinsp;
                                                            &thinsp;
                                                            &thinsp; &thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp;&thinsp; </strong></td>
                                                    <!-- <td align="center" nowrap="nowrap"><strong>&thinsp; &thinsp;
                                                            &thinsp; &thinsp; &thinsp;Type remise&thinsp; &thinsp;
                                                            &thinsp;
                                                            &thinsp; &thinsp; </strong></td> -->
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($lignecommandeclient2s as $res):
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 15%;" align="center">
                                                            ...
                                                            echo $this->Form->input('sup0', array('name' => 'data[lignecommandeclients][' . $i . '][sup0]', 'id' => 'sup0' . $i, 'champ' => 'sup0', 'table' => 'lignecommandeclients', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'type' => 'hidden', 'class' => 'form-control'));
                                                            echo $this->Form->input('id', array('label' => '', 'value' => $res['id'], 'name' => 'data[lignecommandeclients][' . $i . '][id]', 'type' => 'hidden', 'id' => 'id' . $i, 'table' => 'lignecommandeclients', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control'));
                                                            echo $this->Form->control('article_id', ['empty' => 'Veuillez choisir !!!', 'index' => $i, 'id' => 'article_id' . $i, 'options' => $articleservises, 'value' => $res['article_id'], 'name' => 'data[lignecommandeclients][' . $i . '][article_id]', 'label' => '', 'table' => 'lignecommandeclients', 'champ' => 'article_id', 'class' => 'form-control select2 getart getprixarticle Testdep getprixhtson ']); ?>
                                                        </td>
                                                        <td style="width: 10%;">
                                                            <br>
                                                            <div style="display:flex">
                                                        ...
                                                        <td>
                                                            <div style="display:flex">
                                                                ...
                                                                <div id="divremise<?php echo $i; ?>"
                                                                    ...
                                                                    <?php echo $this->Form->input('remise', array('label' => '', 'value' => $res['remise'], 'name' => 'data[lignecommandeclients][' . $i . '][remise]', 'type' => 'text', 'id' => 'remise' . $i, 'table' => 'lignecommandeclients', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control number getprixhtson testremiseval')); ?>
                                                                    <!-- <i style="    margin-top: 26%;font-size: 18px;"
                                                                        class="fa fa-percent"></i>&thinsp;&thinsp;&thinsp; -->
                                                ...
                                                <tr class='tr' style="display: none !important">
                                                    ...
                                                    <td style="width: 15%;" align="center">
                                                        ...
                                                        echo $this->Form->input('sup0', array('name' => '', 'id' => '', 'champ' => 'sup0', 'table' => 'lignecommandeclients', 'index' => '', 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'type' => 'hidden'));
                                                        echo $this->Form->control('article_id', ['options' => $articleservises, 'empty' => 'Veuillez choisir !!', 'label' => '', 'table' => 'lignecommandeclients', 'champ' => 'article_id', 'class' => 'form-control getart getprixhtson getprixarticle']); ?>
                                                    </td>
                                                    <td style="width: 10%;">
                                                        <br>
                                                    ...
                                                    <td>
                                                        <div style="display:flex">
                                                            ...
                                                            <div champ="divremise" style="display:block"
                                                                table="lignecommandeclients">
                                                                <?php echo $this->Form->input('remise', array('champ' => 'remise', 'label' => '', 'name' => '', 'type' => 'text', 'id' => '', 'table' => 'lignecommandeclients', 'index' => '', 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control number getprixhtson testremiseval')); ?>
                                                    ...
                                                    <!-- <td align="center">
                                                        <div champ="divremise" style="display:flex"
                                                            table="lignecommandeclients">
                                                            <?php echo $this->Form->input('remise', array('champ' => 'remise', 'label' => '', 'name' => '', 'type' => 'text', 'id' => '', 'table' => 'lignecommandeclients', 'index' => '', 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control number getprixhtson testremiseval')); ?>
                                                            <i style="    margin-top: 26%;font-size: 18px;"
                                                                class="fa fa-percent"></i>&thinsp;&thinsp;&thinsp;
                    ...
                    <div class="col-md-6">
                        <div id="remisetotaldiv"
                            style="display: <?php if ($commandeclient->typeremise_id == 1) { ?>block<?php } else { ?>none<?php } ?>">
                            <?php echo $this->Form->control('remisetotal', ['id' => 'remisetotal', 'value' => $commandeclient->remisetotal, 'label' => 'Remise relative sur le total en %', 'type' => 'text', 'min' => 0, 'max' => 100, 'class' => 'form-control number getprixhtson testremiseval']); ?>

                        </div>
                        <div id="remisetotalvaldiv"
                            style="display: <?php if ($commandeclient->typeremise_id == 2) { ?>block<?php } else { ?>none<?php } ?>">
                    ...
                    <div  class="btnEditCmdClient ">
                        <br><br>
                        <div align="center"> 
                        <button type="submit" class=" btn btn-success " id="poi1ntv"
                            style="/* margin-right:48%;margin-top: 20px;margin-bottom:20px; */">Enregistrer</button>
                            <a  onclick="openWindow(1000, 1000,` <?php echo $this->Url->build(['action' => 'impfichier',$commandeclient->id,$commandeclient->projet_id]); ?>`)"
...
//$('.getart').select2(); // Assurez-vous que Select2 est bien initialisé

$('.getart').on('select2:open', function () {
    console.log('Select2 ouvert');

    // Utiliser un délai pour s'assurer que les options sont prêtes
    setTimeout(function() {
        // Délégation d'événements pour les options de résultats
        $(document).on('click', '.select2-results__option', function () {
            let id = $(this).data('data').id;  // Récupérer l'ID de l'option
            console.log('Clic détecté sur l\'option avec ID :', id);
            
            // Gérer le timer pour détecter le double-clic
            if (clickTimer) {
                clearTimeout(clickTimer);  // Annuler le timer
                clickTimer = null;  // Réinitialiser le timer
                console.log('Double-clic détecté sur :', id);

                // Ouvrir le lien
                let currentUrl = window.location.href;
                let parentUrl = currentUrl.split("/").slice(0, 4).join("/");
                let link = parentUrl + "/articles/view/" + id;
                window.open(link, "_blank", "width=1000,height=1000");
            } else {
                // Premier clic : démarrer un timer
                clickTimer = setTimeout(function () {
                    clickTimer = null;  // Réinitialiser après 300 ms si pas de second clic
                    console.log('Clic simple sur :', id);
                }, 300);  // Délai pour détecter le double-clic
            }
        });
    }, 1); // Délai pour laisser le DOM se mettre à jour
});

// Nettoyer l'événement lors de la fermeture de Select2
$('.getart').on('select2:close', function () {
    $(document).off('click', '.select2-results__option');
        ...
        // $('.getart').on('select2:open', function () {
        //     // Lorsque le menu est ouvert, ajoutez un événement de clic sur les options
        //     $('.getart').on('select2:select', function (e) {
        //         let id = $(this).val();  // Récupérer l'ID de l'option
        //         let optionText = $(this).text(); // Récupérer le texte de l'option
        ...
        //             clearTimeout(clickTimer);  // Annuler le timer
        //             clickTimer = null;  // Réinitialiser le timer
        //           //  alert('Double-clic sur : ' + id);  // Afficher une alerte
        //             // Ouvrir le lien ou exécuter d'autres actions ici
        //             window.open(link, "_blank", "width=1000,height=1000");
        //         } else {
        //             // Premier clic : démarrer un timer
        //             clickTimer = setTimeout(function () {
        //                 // Réinitialiser après 300 ms si pas de second clic
        //                 clickTimer = null;
        //                 // Vous pouvez ici gérer le cas du clic simple si nécessaire
        //             }, 300);  // Délai pour détecter le double-clic
        //         }
        //     });
        // });
        ...
        //     let id = $(this).val();
        //     let currentUrl = window.location.href;
        //     let parentUrl = currentUrl.split("/").slice(0, -2).join("/");
        //     let link = parentUrl + "/articles/" + id;
        //     clickTimer++;
        //     alert(clickTimer)
        //     alert(lastSelectedId)
        //     if (clickTimer && lastSelectedId === id) {
        //         // Double-clic détecté
        //         clearTimeout(clickTimer);
        //         clickTimer = null;
        //         lastSelectedId = null;  // Réinitialiser
        //         window.open(link, "_blank", "width=1000,height=1000");
        //     } else {
        //         // Clic simple : démarrer un timer
        //         lastSelectedId = id;
        //         clickTimer = setTimeout(function () {
        //             clickTimer = null;
        //             lastSelectedId = null;
        //         }, 300);  // Délai de 300 ms pour détecter le double-clic
        //     }
        // });
        // // $('.select2:select').on('dblclick', function () {
        //     let id = $(this).attr('id').split('-').pop();  // Récupérer l'ID de l'option
        //     let currentUrl = window.location.href;
        //     let parentUrl = currentUrl.split("/").slice(0, -2).join("/");
        //     let link = parentUrl + "/articles/view/" + id;
        ...
        // Sélectionner toutes les options visibles de la liste déroulante et écouter le double-clic
        // $('.select2:select').on('dblclick', function () {
        //     let id = $(this).attr('id').split('-').pop();  // Récupérer l'ID de l'option
        //     let currentUrl = window.location.href;
        //     let parentUrl = currentUrl.split("/").slice(0, -2).join("/");
...
<style>
    ...
    .getprixarticle .select2-container {
    display: block;
    /*width: 100% !important;*/
    /* width: auto !important; */
}
