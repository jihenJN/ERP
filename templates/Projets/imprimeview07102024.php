    ...
    <div class="" style="width: 104%;height :600px; margin-left:-1%;margin-right:5%;">
        <div class="panel-body">
            <div class="table-responsive ls-table">
                <table class="tabstyle"  height="1000px">
                    <thead>
                        <tr height="7px">
                            ...
                            <td align="center" class="solid-border"
                                style="width: 50% !important;  word-wrap: break-word;white-space: normal; border:1px solid gray;">
                                Désignation
                            </td>
                            <td align="center" class="solid-border"
                                style="width: 10% !important;border:1px solid gray;">
                            ...
                            <td align="center" class="solid-border"
                                style="width: 8% !important; border:1px solid gray;">
                                Unité
                            </td>
                            <td align="center" class="solid-border"
                                style="width: 12% !important;border:1px solid gray;">
                                Total HT
                            </td>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        ?>
                            ...
                            ?>
                                <tr class="tr">
                                    <td align="center" style="vertical-align:top;height: 1px;" class="dotted-border">
                                        <?php echo h($articl[0]['Refggb']); ?>
                                    </td>
                                    <td align="center" style="height: 1px;vertical-align:top; word-break: break-word;  white-space: normal; " class="dotted-border">
                                    ...
                                    <?php if ($commandeclient->devise->name === 'Dollars US'): ?>
                                        <td align="center" style="height: 1px;vertical-align:top;" class="dotted-border">
                ...
                <div style="margin:30px">
                    ...
                    <div class="" style="width: 104%;height :600px; margin-left:-1%;margin-right:5%;">
                        ...
                        <div>
                            <hr style="color: black;border: 2px solid;width:80%; <?php if ($total_transportt != 0 && $total_transportt != '') { ?> margin-top: 200px; <?php } else {
                                                                                                                                                                        echo " margin-top: 220px;";
                                                                                                                                                                    } ?>"
                                class="footerr-textt" />
                            <div align="center" class="footerr-text"
                                style=" <?php if ($total_transportt != 0 && $total_transportt != '') { ?> margin-top: 200px; <?php } else {
                                                                                                                                echo " margin-top: 220px;";
                                                                                                                            } ?>">
                                <table border="0">
                                    <thead>
