...
<section class="content">
    <div class="row">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            ...
                            <div class="col-xs-6">
                                <?php
                                echo $this->Form->control('Date', ['readonly' => true, 'empty' => true, 'value' => date("d/m/Y"), 'class' => 'form-control', 'id' => 'date']);
                    ...
                    <div class="col-xs-6">
                        ...
                        <div class="form-group input select required">
                            ...
                            <select disabled name="client_id" id="client_id" class="form-control select2 control-label paiement_id clientreglement " value='<?php $this->request->getQuery('client_id') ?>'>
                            ...
                            <input type="hidden" value="<?php echo $client->id; ?>" name="client_id">
                        </div>
                    </div>
                                            ...
                                            <table id="exemple1" class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php
                                                                        echo ($reste);
                                                                        echo $this->Form->control('rest', array('value' => $reste, 'index' => $i, 'id' => 'reste' . $i, 'label' => '', 'class' => 'form-control getrest number', 'readonly' => 'readonly', 'type' => 'hidden'));
                                                                        ?>
                                                                    </td>
                                                                    <td>
                                                                        <input checked type="checkbox" name="data[Lignereglementclient][<?php echo $i; ?>][factureclient_id]" id="facture_id<?php echo $i; ?>" index="<?php echo $i; ?>" class=" afficheinputmontantreglementclient chekreglementfacachat " value="<?php echo $fac->id ?>" mnttounssi="<?php echo $fac->totalttc; ?>" mnt="<?php echo $reste; ?>" compte="">

                                                                        <?php

                                                                        echo $this->Form->input('Montanttt', array('value' => $reste, 'style' => 'display:true', 'index' => $i, 'name' => 'data[Lignereglementclient][' . $i . '][Montanttt]', 'id' => 'Montantregler' . $i, 'label' => '', 'type' => 'text', 'class' => 'form-control testmontantreglementclient1  chekreglementfacachat checkmaxfac number calculmontantt bl'));
                                                                        ?>
                                                    ...
                                                    <tr id="totalefacture">
                                                        ...
                                                        <td colspan="3">
                                                            <input type="number" name="data[Reglementclient][ttpayer]" id="ttpayer" class="form-control" value="<?php echo $reste ?>" readonly>
                                                            <?php
                                                    ...
                                                    <tr id="montantpayer">
                                                        ...
                                                        <td colspan="3">
                                                            ...
                                                            ?>
                                                            <input type="number" name="data[Reglementclient][Montant]" id="Montant" class="form-control" value="0.000" readonly>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3">
                                                            <input type="number" name="data[Reglementclient][differance]" id="difference" class="form-control differance" value="0.000" readonly>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <div class="panel-body">
                                        <div class="table-responsive ls-table">
                                            <table class="table table-bordered table-striped table-bottomless" id="addtable">
                                                    ...
                                                    <td colspan="8" style="vertical-align: top;">
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <select table="pieceregelemnt" index="" champ="paiement_id" id="paiement_id" class="modereglement2 paiement_id  limite form-control ">
                                                                    ...
                                                                    <?php echo $this->Form->input('sup', array('name' => '', 'id' => '', 'champ' => 'sup', 'table' => 'pieceregelemnt', 'index' => '', 'type' => 'hidden', 'class' => 'form', 'label' => '')); ?>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td name="data[piece][0][trtaux]" id="" index="0" champ="trtauxb" table="piece" style="display:none" class="modecheque"><?php
                                                                                                                                                                                        echo $this->Form->input('valeur_id', array('div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => ' form-control limite montantbrut', 'label' => '', 'index' => 0, 'champ' => 'taux', 'table' => 'pieceregelemnt', 'name' => 'data[pieceregelemnt][0][taux]', 'empty' => 'Veuillez choisir'));
                                                                                                                                                                                        ?> </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td name="data[piece][0][trechance]" id="" index="0" champ="trechanceb" table="piece" style="display:none" class="modecheque"><?php
                                                                                                                                                                                                echo $this->Form->input('echance', array('div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'value' => '99/99/9999', 'class' => 'form-control limite depassedate ', 'label' => '', 'type' => 'date', 'index' => 0, 'champ' => 'echance', 'table' => 'pieceregelemnt', 'name' => 'data[pieceregelemnt][0][echance]'));
                                                                                                                                                                                                ?> </td>
                                                            </tr>
                                                ...
                                                <tr>
                                                    <td name="data[piece][0][trnum]" id="" index="0" champ="trnuma" table="piece" style="display:none" class="modecheque limite">Numéro pièce </td>
                                                    <td name="data[piece][0][trnum]" id="" index="0" champ="trnumb" table="piece" style="display:none" class="modecheque limite">
                                                        <div class='form-group' id="" index="0" champ="divnumc" table="piece" style="display:none">
                                                            <label class='col-md-2 limite control-label'></label>
                                                            <div class='col-sm-10' name="data[piece][0][trnum]" id="" index="0" champ="trnumc" table="piece" class="modecheque limite"> </div>
                                                        </div>
                                                        <div class='form-group' id="" index="0" champ="divnump" table="piece" style="display:none">
                                                            <div class='col-sm-12'><?php echo $this->Form->input('num_piece', array('div' => 'form-group', 'class' => 'form-control limite', 'label' => '', 'type' => 'text', 'index' => 0, 'champ' => 'num_piece', 'table' => 'pieceregelemnt', 'name' => 'data[pieceregelemnt][0][num_piece]')); ?></div>
                                                        </div>
                                                    </td>
        ...
        <?php if ($client_id != null) { ?>
            <button type="submit" class="pull-right btn btn-success limite testsubmitachat verifmontant TestBoutonEnregistrer " id="testpersonnel" style="margin-right:48%;margin-top: 20px;margin-bottom:20px;">Enregistrer</button>
        <?php } ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(".limite").on("keyup change mouseover blur ", function() {
            calculerValeurs();
        });
