        ...
        <div class="col-md-12">
            ...
            <div class="box ">
                ...
                <div class="box-body">
                    ...
                    <div class="col-xs-6">
                        <?php echo $this->Form->control('fonction_id', ['options' => $fonctions, 'value' => $type, 'type' => 'hidden', 'empty' => 'Veuillez choisir !!', 'class' => 'form-control']); ?>
                    </div>
                    <div class="col-xs-6">
                    ...
                    <div class="col-xs-6">
                        <?php echo $this->Form->control('pointdevente_id', ['label' => 'Point De Vente', 'options' => $pointdeventes, 'empty' => 'Veuillez choisir !!', 'class' => 'form-control select2 ']); ?>
                    </div>
                    <div class="col-xs-6">
                        <?php echo $this->Form->control('sexe_id', ['options' => $sexes, 'empty' => 'Veuillez choisir !!', 'class' => 'form-control select2 ']); ?>
                    </div>
                    <div class="col-xs-6">
                        <?php echo $this->Form->control('situationfamiliale_id', ['label' => 'Situation Familiale', 'empty' => 'Veuillez choisir !!', 'options' => $situationfamiliales, 'Veuillez choisir !!', 'class' => 'form-control select2 ']); ?>
                    </div>
                    <div class="col-xs-6">
                        <?php echo $this->Form->control('dateentre', ['label' => 'Date Entree', 'empty' => true, 'class' => "form-control"]); ?>
