            ...
            <div class="box ">
                ...
                <div class="row">
                    <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                        <div class="col-xs-3" style="color: blue">
                            ...
                            <select readonly name="fournisseur" class="form-control  control-label pointer-events: none;" id="fournisseur">
                ...
                <div align="center">
                    <div class="pull-right" style="margin-right:40%;margin-top: 20px;">
                        ...
                        <a href="<?php echo $this->Url->build(['action' => 'index', $dhouha]); ?>" class="btn btn-primary">Annuler</a>
                    </div>
                </div>
