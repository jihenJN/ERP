...
$footerUrl = 'https://geniusbusiness.isofterp.com/genuis/webroot/img/footercmdclient.png';
...
<div style="margin:30px">
    ...
    <div style="display:flex">
        <div class="boxblanc" style="width: 47%;height: 160px;margin-left:-1%;">
        ...
        <div class="boxgris" style="width: 55%;height: 160px;margin-left:48%;font-size: 13px;margin-top:-22.59%; ">
    ...
    <div class="" style="width: 104%;height :600px; margin-left:-1%;margin-right:5%;">
        <div class="panel-body">
            <div class="table-responsive ls-table">
                ...
                <div style="display: flex; justify-content: space-between;margin-top: -250px;">
                    <div style="width: 60%;">
                        ...
                        <div class="boxbordergray"
                            ...
                            <div style="margin-left: 3%;">
                                <?php echo ucfirst(int2str(sprintf("%01.3f", str_replace(",", ".", $commandeclient->totalttc)))); ?>
                            </div>
                        </div>
                    ...
                    <div style="width: 50%;margin-left: 59%;margin-top:-23%;font-size: 13px;">
                        <div style="display: flex; justify-content: space-between;">
                            ...
                            <div style="margin-left: 180px;margin-top: -5%;">
                                <?php echo sprintf("%01.3f", str_replace(",", ".", $total_produit)); ?>
                                <?php if ($commandeclient->devis_id) {
                        ...
                        <div style="display: flex; justify-content: space-between;">
                            ...
                            <div style="margin-left: 180px;margin-top: -5%;">
                                <?php echo sprintf("%01.3f", str_replace(",", ".", $total_transportt)); ?>
                                <?php if ($commandeclient->devis_id) {
                                    echo $commandeclient->devise->code;
                                } ?>
                            </div>
