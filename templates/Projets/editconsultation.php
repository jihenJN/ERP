                                            ...
                                            ?>
                                                <tr class="" style="">
                                                    <td align="center" style="background-color: white;">
                                                        ...
                                                        <?php echo $this->Form->input('devise_id', array('value' => $ddd[0]['devise_id'], 'label' => 'Devise', 'empty' => 'Veuillez choisir !!!', 'id' => 'devise_id' . $j, 'name' => 'data[fligne][' . $j . '][devise_id]', 'champ' => 'devise_id', 'index' => $j, 'table' => 'fligne', 'div' => 'form-group', 'between' => '<div class="col-sm-12" >', 'after' => '</div>', 'class' => 'form-control')); ?>
                                                        <?php echo $this->Form->input('conditionreglement_id', array('value' => $ddd[0]['conditionreglement_id'], 'label' => 'Condition de reglement', 'empty' => 'Veuillez choisir !!!', 'id' => 'conditionreglement_id' . $j, 'name' => 'data[fligne][' . $j . '][conditionreglement_id]', 'champ' => 'conditionreglement_id', 'index' => $j, 'table' => 'fligne', 'div' => 'form-group', 'between' => '<div class="col-sm-12" >', 'after' => '</div>', 'class' => 'form-control')); ?>
                                                        <?php echo $this->Form->input('paiement_id', array('title'=>$pname,'label' => 'Mode de reglement', 'empty' => false, 'id' => 'paiement_id' . $j, 'name' => 'data[fligne][' . $j . '][paiement_id]', 'champ' => 'paiement_id', 'index' => $j, 'table' => 'fligne', 'div' => 'form-group', 'between' => '<div class="col-sm-12" >', 'after' => '</div>', 'class' => "form-control selectpicker helloselect", 'multiple', 'data-live-search' => "true", 'onchange' => 'hello(' . $j . ')', 'label' => 'Mode de reglèment', 'options' => $paiements)); ?>
                                                        <?php echo $this->Form->input('methodeexpedition_id', array('value' => $ddd[0]['methodeexpedition_id'], 'label' => 'Méthode d`expédition', 'empty' => 'Veuillez choisir !!!', 'id' => 'methodeexpedition_id' . $j, 'name' => 'data[fligne][' . $j . '][methodeexpedition_id]', 'champ' => 'methodeexpedition_id', 'index' => $j, 'table' => 'fligne', 'div' => 'form-group', 'between' => '<div class="col-sm-12" >', 'after' => '</div>', 'class' => 'form-control')); ?>
                                                        <?php echo $this->Form->input('paim', array('value'=>$pname,'label' => '', 'empty' => false, 'id' => 'paim' . $j, 'name' => 'data[fligne][' . $j . '][paim]', 'champ' => 'paim', 'index' => $j, 'table' => 'fligne', 'div' => 'form-group', 'between' => '<div class="col-sm-12" >', 'after' => '</div>', 'class' => "form-control ",  'type' => 'hidden')); ?>
                                                    ...
                                                    <td style="background-color: white">
                                                                ...
                                                                ?>
                                                                        <tr class="tr" style="">
                                                                            ...
                                                                            <td align="center" table="" style="background-color: white">
                                                                                <?php echo $this->Form->input('codefrs', array('value' => $ligne['codefrs'], 'label' => '', 'id' => 'codefrs' . $j . '-' . $i, 'name' => 'data[fligne][' . $j . '][aligne][' . $i . '][codefrs]', 'champ' => 'codefrs', 'table' => 'fligne', 'tableligne' => 'aligne', 'indexligne' => $i, 'index' => $j, 'div' => 'form-group', 'between' => '<div class="col-sm-12" >', 'after' => '</div>', 'style' => 'font-size: 13px;', 'class' => 'form-control codefrs')); ?>
                                                                            </td>
                                                                            <td align="center">
                                                                                <?php echo $this->Form->input('qte', array('value' => $ligne['qte'], 'readonly' => 'readonly', 'label' => '', 'id' => 'qte' . $j . '-' . $i, 'name' => 'data[fligne][' . $j . '][aligne][' . $i . '][qte]', 'champ' => 'qte', 'table' => 'fligne', 'tableligne' => 'aligne', 'indexligne' => $i, 'index' => $j, 'div' => 'form-group', 'between' => '<div class="col-sm-12" >', 'after' => '</div>', 'style' => 'font-size: 13px;', 'class' => 'form-control calcull')); ?>
                                                                            </td>
                                                                            <td align="center">
                                                                                <?php
                                                                                if ($ligne['prix'] !== null) {
                                                                                    echo $this->Form->input('prix', array('value' => sprintf("%01.3f", $ligne['prix']), 'type' => 'text', 'label' => '', 'step' => 'any', 'id' => 'prix' . $j . '-' . $i, 'name' => 'data[fligne][' . $j . '][aligne][' . $i . '][prix]', 'champ' => 'prix', 'table' => 'fligne', 'tableligne' => 'aligne', 'empty' => true, 'indexligne' => $i, 'index' => $j, 'div' => 'form-group', 'between' => '<div class="col-sm-12" >', 'after' => '</div>', 'style' => 'font-size: 13px;', 'class' => 'form-control number prix calculprix calcull calculll'));
                                                                                } else {
                                                                                    echo $this->Form->input('prix', array('value' => '', 'label' => '', 'step' => 'any', 'type' => 'text', 'id' => 'prix' . $j . '-' . $i, 'name' => 'data[fligne][' . $j . '][aligne][' . $i . '][prix]', 'champ' => 'prix', 'table' => 'fligne', 'tableligne' => 'aligne', 'empty' => true, 'indexligne' => $i, 'index' => $j, 'div' => 'form-group', 'between' => '<div class="col-sm-12" >', 'after' => '</div>', 'style' => 'font-size: 13px;', 'class' => 'form-control number prix calculprix calcull calculll'));
                                                                                }
                                                                                ?>
                                                                            </td>

                                                                            <td align="center">
                                                                                <?php echo $this->Form->input('tauxdemarge', array('value' => $ligne['tauxdemarge'], 'label' => '', 'id' => 'tauxdemarge' . $j . '-' . $i, 'name' => 'data[fligne][' . $j . '][aligne][' . $i . '][tauxdemarge]', 'champ' => 'tauxdemarge', 'table' => 'fligne', 'tableligne' => 'aligne', 'indexligne' => $i, 'index' => $j, 'div' => 'form-group', 'between' => '<div class="col-sm-12" >', 'after' => '</div>', 'style' => 'font-size: 13px;', 'class' => 'form-control calculprix')); ?>

                                                                            </td>
                                                                            <td align="center">
                                                                                <?php echo $this->Form->input('tauxdemarque', array('value' => $ligne['tauxdemarque'], 'label' => '', 'id' => 'tauxdemarque' . $j . '-' . $i, 'name' => 'data[fligne][' . $j . '][aligne][' . $i . '][tauxdemarque]', 'champ' => 'tauxdemarque', 'table' => 'fligne', 'tableligne' => 'aligne', 'indexligne' => $i, 'index' => $j, 'div' => 'form-group', 'between' => '<div class="col-sm-12" >', 'after' => '</div>', 'style' => 'font-size: 13px;', 'class' => 'form-control calculprix')); ?>

                                                                            </td>
                                                                            <td align="center">
                                                                                <?php if ($ligne['tauxdemarge'] !== null) {
                                                                                    echo $this->Form->input('coutrevient', array('value' => $ligne['coutrevient'], 'label' => '', 'id' => 'coutrevient' . $j . '-' . $i, 'name' => 'data[fligne][' . $j . '][aligne][' . $i . '][coutrevient]', 'champ' => 'coutrevient', 'table' => 'fligne', 'tableligne' => 'aligne', 'indexligne' => $i, 'index' => $j, 'div' => 'form-group', 'between' => '<div class="col-sm-12" >', 'after' => '</div>', 'style' => 'font-size: 13px;', 'class' => 'form-control'));
                                                                                } else {
                                                                                    echo $this->Form->input('coutrevient', array('value' => sprintf("%01.3f", $ligne['coutrevient']), 'label' => '', 'id' => 'coutrevient' . $j . '-' . $i, 'name' => 'data[fligne][' . $j . '][aligne][' . $i . '][coutrevient]', 'champ' => 'coutrevient', 'table' => 'fligne', 'tableligne' => 'aligne', 'indexligne' => $i, 'index' => $j, 'div' => 'form-group', 'between' => '<div class="col-sm-12" >', 'after' => '</div>', 'style' => 'font-size: 13px;', 'class' => 'form-control'));
                                                                                }
                                                                                ?>
                                                        ...
                                                        <div class="col-lg-3 col-lg-offset-3 pull-right">
                                                            <?php echo $this->Form->input('t', array('value' => number_format($total_articles[0]['t'], 3, '.', ''), 'label' => 'total des prix des articles:', 'id' => 't' . $j, 'name' => 'data[fligne][' . $j . '][t]', 'champ' => 'total', 'table' => 'fligne', 'index' => $j, 'div' => 'form-group', 'between' => '<div class="col-sm-4" >', 'after' => '</div>', 'class' => 'form-control total')); ?>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php } ?>
