...
<div style="position: relative; top: 0;">
    ...
    <div style="position: absolute; top: 20px; right: 10%; z-index: 1;">
        <a onclick='openWindow(1000, 1000, `<?php echo $wr; ?>/projets/downloadPdftest/<?php echo @$id; ?>`)'>
    ...
    <div style="width: 96%;height :600px; margin-left:0%;margin-right:5%;margin-top: -8px;">
        <div class="panel-body">
            <div class="table-responsive ls-table">
                ...
                <div style="display: flex; justify-content: space-between;margin-left: -1.5%;">
                    <div style="width: 50%;">
                        ...
                        <div class="boxbordergray"
                            style="height: 30px; margin-left: 3%; margin-right: 5%;font-size: 12px;">
                        ...
                        <div
                            style="margin-left: 3%; margin-right: 5%;font-size: 10px ;">
                        ...
                        <div
                            style="margin-left: 3%; margin-right: 5%;font-size: 10px; <?php if ($bicswift) { ?>margin-top: -18px;<?php } ?>">
                ...
                <table border="0">
                    <thead>
                        <tr>
                            ...
                            <td style="width:5%">    <img src="<?= $this->Url->webroot('img/mail.png'); ?>" width="60px"
                            height="60px" style=""></td>
                           <td style="width:5%">
                           <span>
                           <strong>contact@genuisgb.net</strong> </span>
                           </td>
                            <td style="width:5%"></td>
                            <td style="width:5%"><img src="<?= $this->Url->webroot('img/maps.png'); ?>" width="60px"
                            height="60px" style=""></td>
                                    <td style="width:60%">
                                    <strong> 50,
