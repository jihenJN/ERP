            ...
            <div class="box ">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <?php echo $this->Form->control('client_id', ['style' => "pointer-events: none;", 'readonly', 'empty' => 'veuillez choisir ??', 'required' => 'off', 'id' => 'client', 'label' => 'Clients']); ?>
                        </div>
                        <div class="col-xs-6">
                        ...
                        <div class="col-xs-6">
                            <?php echo $this->Form->control('commercial_suivi_id', ['style' => "pointer-events: none;", 'readonly', 'empty' => 'veuillez choisir!!!', 'options' => $personnels, 'required' => 'off', 'id' => 'commercial_suivi_id', 'label' => 'Commercial suivi du contrat']); ?>
                        </div>
                        <div class="col-xs-6">
                            <?php echo $this->Form->control('commercial_signataire_contrat_id', ['style' => "pointer-events: none;", 'readonly', 'empty' => 'veuillez choisir!!!', 'options' => $personnels, 'required' => 'off', 'id' => 'commercial_signataire_contrat_id', 'label' => 'Commercial suivi du contrat']); ?>
                        </div>
                        <div class="col-xs-3">
                        ...
                        <div class="col-xs-3">
                            <?php echo $this->Form->control('projet_id', ['empty' => 'veuillez choisir!!!', 'required' => 'off', 'id' => 'projet_id', 'label' => 'Projets', 'style' => "pointer-events: none;", 'readonly']); ?>
                        </div>
                        <div class="col-xs-6">
...
<script>
    function rendreChampEnLectureSeule(champId) {
        var champ = document.getElementById(champId);
        if (champ) {
            champ.readOnly = true;
        }
    }
    rendreChampEnLectureSeule('numero');
    rendreChampEnLectureSeule('ref_client');
    rendreChampEnLectureSeule('ref_fournisseur');
    rendreChampEnLectureSeule('client');
    rendreChampEnLectureSeule('remise');
    rendreChampEnLectureSeule('commercial_suivi_id');
    rendreChampEnLectureSeule('note_prive');
    rendreChampEnLectureSeule('commercial_signataire_contrat_id');
    rendreChampEnLectureSeule('date');
    rendreChampEnLectureSeule('projet_id');
    rendreChampEnLectureSeule('note_publique');
</script>
