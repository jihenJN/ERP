            ...
            <div class="box ">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <?php echo $this->Form->control('remisetotal', ['id' => 'remisetotal', 'value' => $commandeclient->remisetotal, 'label' => 'Remise relative sur le total en %', 'id' => 'remisetotal', 'type' => 'text', 'min' => 0, 'max' => 100, 'class' => 'form-control number getprixhtson']); ?>
                        </div>
                        <div class="col-md-6">
                            <?php echo $this->Form->control('remisetotalval', ['id' => 'remisetotalval', 'value' => $commandeclient->remisetotalval, 'label' => 'Remise relative sur le total en valeur', 'id' => 'remisetotalval', 'type' => 'text', 'class' => 'form-control number getprixhtson']); ?>
                        </div>
                        <div class="col-md-6">
