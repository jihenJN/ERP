                ...
                <div class="box-body">
                                        ...
                                        <table class="table table-bordered table-striped table-bottomless"
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 8%;" align="center">
                                                            ...
                                                            <div id="divremiseval<?php echo $i; ?>"
                                                                ...
                                                                <?php echo $this->Form->input('remiseval', array('label' => '', 'value' => $res['remiseval'], 'name' => 'data[lignecommandeclients][' . $i . '][remiseval]', 'type' => 'text', 'id' => 'remiseval' . $i, 'table' => 'lignecommandeclients', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control number getprixhtson testremise')); ?>
                                                ...
                                                <tr class='tr' style="display: none !important">
                                                    ...
                                                    <!-- <td align="center">
                                                        <?php echo $this->Form->input('remise', array('champ' => 'remise', 'label' => '', 'name' => '', 'type' => 'text', 'id' => '', 'table' => 'lignecommandeclients', 'index' => '', 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control getprixhtdupp ')); ?>
                                                    </td> -->
                    ...
                    <div class="col-md-6">
                        ...
                        <div id="remisetotalvaldiv" style="display:none">
                            <?php echo $this->Form->control('remisetotalval', ['id' => 'remisetotalval', 'value' => $commandeclient->remisetotalval, 'label' => 'Remise relative sur le total en valeur', 'type' => 'text', 'class' => 'form-control number getprixhtson testremise']); ?>
