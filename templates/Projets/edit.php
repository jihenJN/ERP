        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-xs-6" style="color: blue">
              ...
              ?>
              <?php echo $this->Form->control('personnel_id', ['required' => 'off', 'empty' => 'Veuillez choisir !!!!', 'id' => 'personnel_id', 'class' => 'form-control ', 'label' => 'Commercial']); ?>
                  ...
                  <table class="table table-bordered table-striped table-bottomless" id="tabfichier">
                    ...
                    <tbody>
                      ...
                      foreach ($fichierpdfs as $f => $fichierpdf):
                        ...
                        <tr>
                          <td align="center">
                            <input table="fichier" id="sup1<?php echo $f ?>" name="data[fichier][<?php echo $f ?>][sup1]"
                              champ="sup1" index="<?php echo $f ?>" class="form-control" type="hidden">
                            <input type="hidden" value="<?php echo $fichierpdf['id']; ?>"
                          ...
                          <td align="center">
                            <i index="<?php echo $f ?>" id="" name="" class="fa fa-times supLigne1"
                ...
                <div class="table-responsive ls-table">
                  <table class="table table-bordered table-striped table-bottomless" id="tabligne5">
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td align="center">
                            <div style="position: static; margin-top: 6px;">
                              <a><i class="fa fa fa-plus urlarticlee" style="color: success; font-size: 20px;"
                                  index="<?php echo $i ?>"></i></a>
                            </div>
                          </td>
                          <td align="center">
                      ...
                      <?php endforeach; ?>
                      <input type="hidden" value="<?php echo $i ?>" id="index5">
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td align="center">
                            <input table="lignef" id="sup1<?php echo $i ?>" name="data[lignef][<?php echo $i ?>][sup1]"
                              champ="sup1" index="<?php echo $i ?>" class="form-control" type="hidden">
                            <?php echo $this->Form->control('fournisseur_id', ['value' => $lignef['fournisseur_id'], 'required' => 'off', 'index' => $i, 'id' => 'fournisseur_id' . $i, 'name' => 'data[lignef][' . $i . '][fournisseur_id]', 'champ' => 'fournisseur_id', 'table' => 'lignef', 'empty' => 'Veuillez choisir !!!!', 'class' => 'form-control select2', 'label' => '']); ?>

                           </td>
                          <td align="center">
                            <div style="position: static; margin-top: 6px;">
                              <a><i class="fa fa fa-plus urlfour" style="color: success; font-size: 20px;"
                                  index="<?php echo $i ?>"></i></a>
                            </div>
                          </td>
                          <td align="center">
                            <i index="<?php echo $i ?>" id="" name="" class="fa fa-times supLigneFournisseur"
                              style="color: #c9302c;font-size: 22px;"></i>
                          </td>
                        </tr>
                      <?php endforeach; ?>
                      ...
                      <tr class="tr" style="display: none !important">
                        <td align="center">
                          ...
                          ?>
                          <div id="" index="" champ='f1' class="col-md-12">
                      ...
                      foreach ($lignecli as $i => $lignec):
                        ...
                        <tr>
                          ...
                          <td align="center">
                            ...
                            <div champ="cliselect" id="cliselect<?php echo $i ?>" class="col-md-10">
                          ...
                          <td align="center">
                            <div class="col-xs-1" style="margin-top: 31px;">
                              <a><i class="fa fa fa-plus url" style="color:success;font-size: 25px;"
                                  index="<?php echo $i ?>"></i></a>
                            </div>
                          </td>
                          <td align="center">
                            <i index="<?php echo $i ?>" id="" name="" class="fa fa-times supLignecl"
                              style="color: #c9302c;font-size: 22px;"></i>
                          </td>
                        </tr>
                      <?php endforeach; ?>
                      <input type="hidden" value="<?php echo $i ?>" id="index6">
...
<script>
  $(document).ready(function () {
    ...
    $('.urlarticlee').on('click', function () {
      var index = $(this).attr('index');// alert(index)
