      ...
      <div class="box ">
        ...
        <div class="box-body">
          ...
          <div class="row">
            ...
            <div class="col-xs-6">
              <?php echo $this->Form->control('projet_id', ['empty' => 'Veuillez choisir un projet !!', 'class' => 'form-control select2', 'champ' => 'projet_id', 'label' => 'Fille du projet/tâche']); ?>
            </div>
            ...
            <div class="col-xs-3">
              <?php echo $this->Form->control('personnel_id', ['empty' => 'Veuillez choisir un personnel !!', 'required' => 'off', 'id' => 'personnel_id', 'class' => 'form-control select2', 'label' => 'Affecté à']); ?>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-xs-3">
              ...
              <div>Heures: <?php echo $this->Form->control('duree', ['required' => 'off', 'id' => 'duree', 'type' => 'number', 'class' => 'form-control', 'label' => '', 'placeholder' => 'Heures']); ?></div>
              <div>Minutes:<?php echo $this->Form->control('dureem', ['required' => 'off', 'id' => 'dureem', 'type' => 'number', 'class' => 'form-control', 'label' => '', 'placeholder' => 'Minutes']); ?></div>
            </div>
          </div>
