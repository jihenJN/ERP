        ...
        <div class="box-body">
          ...
          <div class="row">
            ...
            <div class="col-xs-3">
              ...
              <div>Heures:<?php echo $this->Form->control('duree', ['required' => 'off', 'id' => 'duree', 'type' => 'number', 'class' => 'form-control', 'label' => '', 'placeholder' => 'Heures']); ?>
              </div>
              <div>Minutes:<?php echo $this->Form->control('dureem', ['required' => 'off', 'id' => 'dureem', 'type' => 'number', 'class' => 'form-control', 'label' => '', 'placeholder' => 'Minutes']); ?>
              </div>
            </div>
          </div>
