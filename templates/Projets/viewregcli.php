                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php if ($lignesre->factureclient_id == $fac->id) { ?>
                                                                            ...
                                                                            <?php
                                                                            echo @$this->Form->input('Montanttt', array('readonly' => true, 'value' => $lignesre->Montant, 'index' => $i, 'name' => 'data[Lignereglementclient][' . $i . '][Montanttt]', 'id' => 'Montantregler' . $i, 'label' => '', 'type' => 'text', 'class' => 'form-control testmontantreglementclient  testmontantreglementclient1 checkmaxfa calculto  calculmontantt number'));
                                                        ...
                                                        <tr>
                                                            <td colspan="8" style="vertical-align: top;">
                                                                <table>
                                                                    ...
                                                                    <tr <?php if ($piece->paiement_id == 1) { ?> style="display:none" <?php } ?> id="trbanque<?php echo $i; ?>">
                                                                    ...
                                                                    <tr <?php
                                                                        ...
                                                                        <td name="data[piece][<?php echo $i ?>][trechance]" id="trechanceb[<?php echo $i ?>" index="[<?php echo $i ?>" champ="trechanceb" table="piece" class="modecheque"><?php
                                                                                                                                                                                                                                            echo $this->Form->input('echance', array('value' => $piece->echance, 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'readonly', 'class' => 'form-control datetimepicker', 'label' => '', 'type' => 'date', 'id' => 'echance' . $i, 'index' => $i, 'champ' => 'echance', 'table' => 'pieceregelemnt', 'name' => 'data[pieceregelemnt][' . $i . '][echance]'));
                                                                                                                                                                                                                                            ?> </td>
                                                                    </tr>
                                                                    <!-- //***************************************************--->
