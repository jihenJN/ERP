      ...
      <div class="box ">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-xs-6">
              <?php echo $this->Form->control('libelle', ['value' => $code, 'class' => 'form-control ', 'readonly' => 'readonly', 'champ' => 'libelle', 'label' => 'Libellé.']); ?>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-xs-6">
              <?php echo $this->Form->control('client_id', ['value' => $proojet->client_id, 'empty' => 'Veuillez choisir un tier!!', 'class' => 'form-control select2', 'id' => 'client_id', 'label' => 'Tiers']); ?>
            </div>
            <div class="col-xs-6">
          ...
          <div class="row">
            <div class="col-xs-6">
              ...
              <?php echo $this->Form->control('date', ['value' => $proojet->date, 'required' => 'off', 'id' => 'date', 'type' => 'date', 'class' => 'form-control', 'label' => 'Date debut']); ?>
            </div>
            <div class="col-xs-6">

              <?php echo $this->Form->control('datefin', ['value' => $proojet->datefin, 'required' => 'off', 'id' => 'date', 'type' => 'date', 'class' => 'form-control', 'label' => 'Date fin']); ?>
            </div>
          </div>

          <div class="row">
            <div class="col-xs-6">
              <?php echo $this->Form->control('opportunite_id', ['value' => $proojet->opportunite_id, 'required' => 'off', 'empty' => 'Veuillez choisir !!!!', 'id' => 'opportunite_id', 'class' => 'form-control select2', 'label' => 'Statut opportunité']); ?>
              <?php //echo $this->Form->control('budget', ['required' => 'off', 'id' => 'budget', 'class' => 'form-control', 'label' => 'Budget']); 
              ?>
              <?php echo $this->Form->control('personnel_id', ['value' => $proojet->personnel_id, 'required' => 'off', 'empty' => 'Veuillez choisir !!!!', 'id' => 'personnel_id', 'class' => 'form-control select2', 'label' => 'Commercial']); ?>
              <?php //echo $this->Form->control('tags', ['required' => 'off', 'id' => 'budget', 'class' => 'form-control', 'label' => 'Tags/catégories']); 
              ?>
            </div>
            <div class="col-xs-6">
              <?php echo $this->Form->control('devise_id', ['value' => $proojet->devise_id, 'required' => 'off', 'empty' => 'Veuillez choisir !!!! ', 'id' => 'devise_id', 'class' => 'form-control select2', 'label' => 'Devise']); ?>
              <?php echo $this->Form->control('banque_id', ['value' => $proojet->banque_id, 'required' => 'off', 'empty' => 'Veuillez choisir !!!! ', 'id' => 'banque_id', 'class' => 'form-control select2', 'label' => 'Banque']); ?>
            </div>
            <div class="col-xs-6">
              <?php echo $this->Form->control('montant', ['value' => $proojet->montant, 'class' => 'form-control ', 'champ' => 'montant', 'label' => 'Montant opportunité']); ?>
            </div>
            <div class="col-xs-6">
              <?php echo $this->Form->control('budget', ['value' => $proojet->budget, 'class' => 'form-control ', 'champ' => 'name', 'label' => 'Budget']); ?>
            </div>
            <div class="col-xs-6">
              <?php echo $this->Form->control('description', ['value' => $proojet->description, 'required' => 'off', 'id' => 'description', 'type' => 'textarea', 'class' => 'form-control', 'label' => 'Description']); ?>
            </div>
          </div>
                          ...
                          <tr>
                            <td align="center">
                              ...
                              <button type="button">
                                ...
                                <a onclick="openWindow(1000, 1000,'<?php echo $wr; ?>/img/logoclients/<?php echo $fichierpdf['fichier']; ?>');">
          ...
          <div align="center">
            <?php echo $this->Form->submit('Cree Brouillon', ['id' => 'verifenr']); ?>
          </div>
