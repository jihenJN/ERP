...
<div style="display:flex; width: 90%; margin-left:1%;">
    <div class="boxblanc " style="width:47%;height: 160px;">
        ...
        <strong>
            ...
            Email :
            <?= h($commandeclient->client->Email) ?>   <?php } ?>
        </div>
       
    </div>
    <div class="boxgris" style="margin-left:51%;width: 58%;height: 160px;font-size: 13px;margin-top:-23.4%; ">
...
foreach ($commandeclient->lignecommandeclients as $lignecommandeclient) {
    if ($lignecommandeclient->type == 1) {
        ...
        $vmpp1 = calculateTdHeight($lignecommandeclient['description'], 16, 1.5, 62);
        if ($vmpp <= 24) {
    ...
    <tbody>
        ...
        foreach ($commandeclient->lignecommandeclients as  $lignecommandeclient) {
            ...
            if ($lignecommandeclient->type == 1) {
                ...
                if (($heiii1 >= 400 && $nbpage == 0)|| ($heiii1 >= 600 && $nbpage != 0) ) {
                    $nbpage += 1;
       ...
       // $nbpage += ceil(($indexcc - $ki) / 40);
        ...
        foreach ($commandeclient->lignecommandeclients as $lignecommandeclient):
            ...
            var_dump($tabheight);//die;
                ?>
                <tr class="tr">
                    <td align="center"
                        style="        <?php $heitd0=''; if ($heitab>$tabheight[0]['height'] && $pag==0 && $nbpage!=0){ $heitd0=450/(float)$tabheight[0]['nbtr'];} else if ($heipin>$tabheight[$pag]['height'] && $pag!=$nbpage && $nbpage!=0 ) {
                          $heitd0=600/(float)$tabheight[$pag]['nbtr'];
...
//var_dump($tabheight);
                ...
                //if (($k == $ki && $pag == 0 && $ki!=$indexcc) || ($pag != 0 && $k == $kn))
                if($pag==4){
                    $hei=580;  
                }
                if (($hei >= 400 && $pag == 0)|| ($hei >= 600 && $pag != 0) ) {
    ...
    font-size: 18px;">contact@genuisgb.net</strong> </span></td>
        ...
        //     $heighttd1 = $heipin - $hei;
        // } else if ($hei != 0 && $heipin == 0) {
        //     $heighttd1 = $heitab - $hei;
        // } else {
        //     $heighttd1 = 700;
        // }
        ...
        <tr>
            ...
            <td colspan="4" style="vertical-align: top;">
                <table id="totalat" style="width:100%">
                    <tr>
                        <td style="width:60% !important;text-align:left; padding: 1px !important;">
                            Total
                            <?php
                        ...
                        <td style="width:40%;text-align:right ; padding: 1px !important;">
                    ...
                    if ($total_transportt != 0 && $total_transportt != '') {
                        foreach ($lignecommandeclient2sdes as $key => $ligne2) {
                            ...
                            if ($total_transp_ligne != 0) { ?>
                                <tr>
                                    <td style="text-align:left; padding: 1px !important;">
                    ...
                    <tr>
                        <td style="text-align:left; padding: 1px !important;">
                            <?php if ($total_transportt != 0 && $tot_remisetransport != 0 ) { ?>
                        ...
                        <td style="text-align:right; padding: 1px !important;">
                            <?php if ($total_transportt != 0 && $tot_remisetransport != 0 ) { ?>
                                ...
                                <?php echo number_format((float) str_replace(",", ".", $tot_remisetransport), $virg, '.', ' ');
