...
<div style="margin:30px">
    ...
    <div  style="width: 87%;height: 20px;margin-left:75%;margin-right:5%; margin-top: -30px;">
        ...
        <div style=" display: flex; position: relative; justify-content: flex-end !important; color: #103458; font-size: 1.2em; ">
            <strong>Réf. :</strong>
    ...
    <div class="boxbordergrayy" style="width: 104%; height: 19px; margin-left: -1%; margin-right: 5%;margin-top: 1%;">
        <div style="font-size: 13px;">
            Note Publique :
            <span style="color: red; font-weight: bold;">
                <?php
    ...
    white-space: normal; " class="dotted-border">
                        ...
                        ?>
                                        <tr>
                                            ...
                                            <td  height="<?php  echo $heighttd;?>"style="border:1px solid gray;vertical-align:top;">
                                            </td>
