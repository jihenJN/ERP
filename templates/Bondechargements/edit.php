        ...
        <div class="box-body">
          <div class="row">
            <div class="row">
              <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                ...
                <div class="col-xs-6">
                  <?php echo $this->Form->control('pointdevente_id', ['options' => $pointdeventes, 'value' => $this->request->getQuery('name'), 'empty' => 'Veuillez choisir !!',  'required' => 'off', 'label' => 'Site', 'class' => 'form-control select2 control-label']); ?></div>
              </div>
            </div>
            ...
            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
              ...
              <div class="row">
                ...
                <div class="col-xs-6">
                  ...
                  <?php echo $this->Form->control('depot_id', ['options' => $depots, 'empty' => 'Veuillez choisir !!', 'label' => 'Depots', 'class' => 'form-control select2 control-label']); ?>
                </div>
                <div class="col-xs-6">
          ...
          <section class="content" style="width: 99%">
            <div class="row">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <a class="btn btn-primary " table="addtable" index="index" style="
                                       float: right;
                                       margin-bottom: 5px;
                                       " id='ajouter_ligne3'>
                    ...
                    <table class="table table-bordered table-striped table-bottomless" id="tabligne3">
                      ...
                      <tbody>
                            ...
                            <tr>
                              <td>
                                ...
                                <!-- <?php echo $this->Form->control('article_id', array(
                                        'label' => '', 'options' => $articles, 'value' => $lignebonchargements->article_id, 'name' => 'data[ligner][' . $i . '][article_id]',
                                        'id' => 'article_id' . $i, 'table' => 'ligner', 'index' => $i, 'class' => 'form-control articleidbl1'
                                      )); ?> -->

                                <label></label>
                                <select name="<?php echo "data[ligner][" . $i . "][article_id]" ?>" id="<?php echo 'article_id' . $i ?>" table="ligner" index="<?php echo $i ?>" champ="article_id" class="js-example-responsive select2 articleidbl1">
                                ...
                                <?php echo $this->Form->input('id', array(
                                  'champ' => 'id', 'label' => '', 'name' => 'data[ligner][' . $i . '][id]', 'value' => $lignebonchargements->id, 'type' => 'hidden', 'id' => '', 'table' => 'ligner', 'index' => '',
                                )); ?>
                              ...
                              <td align="center" table="ligner">
                                <?php echo $this->Form->input('qte', ['label' => '', 'value' => $lignebonchargements->qte, 'type' => 'number',  'name' => 'data[ligner][' . $i . '][qte]', 'id' => 'qte' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control gettotal']); ?>
                              </td>
                        ...
                        <tr class="tr" style="display: none ">
                          ...
                          <td align="center" table="ligner">
                            <input table="ligner" name="" champ="qte" type="text" id="" class="form-control gettot">
                          </td>
