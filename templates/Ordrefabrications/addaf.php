                    ...
                    <section class="content-header">
                     ...
                     <section class="content" style="width: 99%">
                        <div class="row">
                            <div class="box">
                                <div class="box-header with-border">
                                    <a class="btn btn-primary  " table='addtable' index='index' id='ajouter_ligne66' style="
                                       ...
                                       margin-bottom: 5px;
                                       ">
                                        <i class="fa fa-plus-circle "></i> Ajouter ligne ordre fabrication </a>
                            ...
                            <input type="hidden" id="" champ="sup" name="" table="Article" index="" class="form-control">

                               <select table="ligner"  champ="article_id" class=" selectized fiche">
                              ...
                              <td align="center" table="ligner">
                                                        <input table="ligner" name="" champ="qte" type="text" id="" class="form-control ">
                                                    </td>
...
<!--                            <tr class='tr' style="display: none ;" >
                                <td colspan="2"><table class="table table-bordered table-striped table-bottomless"><tr>
                              <td align="center">
                            ...
                            <div  index="" champ="divmp">
                                        ...
                                        <input type="" value="0" id="indexar" hidden>
