...
<div style="display:flex" align="center">
    ...
    <div style="display:flex;width: 1000%;">
        <div style="width: 10000%;" class="box" align="left">
            <b> Facture Avoir N° : </b><?= h($factureavoirfr->numero) ?> <br>
            <b> Date : </b><?= h($this->Time->format($factureavoirfr->date, 'dd/MM/y'));
                            ?> <br>
    ...
    <div style="display:flex ;width:1000%;margin-left:10%">
        ...
        <div style="width: 10000%;" class="box" align="left"> <b> Fournisseur : </b> <?php
                                                                                        if (isset($factureavoirfr->fournisseur)) {
                                                                                            echo  h($factureavoirfr->fournisseur->name);
                                                                                        } ?><br>
            <b> Code postal: </b><?= h($factureavoirfr->fournisseur->codepostal) ?> <br>

            <b> Telephone : </b><?= h($factureavoirfr->fournisseur->Tel) ?> <br>
        ...
        <div>
            <table border="1">
                ...
                <tbody>
                    ...
                    foreach ($lignefactureavoirfrs as $lignecommande) :
                    ?>
                        ...
                        <tr class="tr" style="font-size:14px;">
                            ...
                            <td style="width: 6%;vertical-align:top" align="center">
                                <?= $this->Number->format($lignecommande->quantite) ?>
                            </td>
                            ...
                            <td style="width: 10%;vertical-align:top" align="center">
                                <?php echo  sprintf("%01.3f", $lignecommande->totalht) ?>
                            </td>
                            ...
                            <td style="width: 8%;vertical-align:top" align="center">
                                <?php echo  sprintf("%01.3f", $lignecommande->totalttc) ?>
                            </td>
            ...
            <div style="display:flex ; margin-top:25px;">
                <div style="width: 50%!important;height:80%!important;">
                    <table style="margin-right:40px;width: 100%!important;;height: 100%!important;">
                        ...
                        <tbody>
                            ...
                            <?php $lignestable = TableRegistry::getTableLocator()->get('Lignefactureavoirfrs');

                            $query = $lignestable->find();
                            $query->select([
                                'tva' => 'Lignefactureavoirfrs.tva',
                                'base' => $query->func()->sum('(quantite*prix - (quantite*prix)* (ifnull(remise,0) / 100) + (quantite*prix - (quantite*prix)* (ifnull(remise,0) / 100)) * ifnull(fodec,0) / 100)'),
                                'total' => $query->func()->sum('((quantite*prix - (quantite*prix)* (ifnull(remise,0) / 100) + (quantite*prix - (quantite*prix)* (ifnull(remise,0) / 100)) * ifnull(fodec,0) / 100)) * tva / 100')
                            ])
                                ->where(['Lignefactureavoirfrs.factureavoirfr_id' => $factureavoirfr->id])
                                ->group('Lignefactureavoirfrs.tva');
                ...
                <div style="display:flex" style="font-size:14px;">
                    ...
                    <div class="table-bordered box" style="width: 150px; " align="right">
                        <?php  ?>
                        <?php echo  sprintf("%01.3f", $factureavoirfr->totalht) ?><br>
                        <!-- <?php //echo  sprintf("%01.3f", $factureavoirfr->fodec) 
                                ?><br><br> -->
                        <?php echo sprintf("%01.3f", $factureavoirfr->remise) ?> <br>
                        <?php echo  sprintf("%01.3f", $factureavoirfr->totaltva1) ?><br>
                        <?php echo  sprintf("%01.3f", $factureavoirfr->totalttc) ?>
                    </div>
                </div>
            </div>
...
<table>
    <tr>
        <td>
            <p>
                <Strong>Commentaire : </Strong><?php echo $factureavoirfr->observation ?>
