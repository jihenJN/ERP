...
<table align="center" class="vertical-text"  style="width: 100px;height:676px;position: relative;top: 50px;" border="0" >
    <tr>
        ...
        <td id="montant" class="Style1" style="width: 164px;position: relative;top: -10px;left: 32px;"><?php if(!empty($depense->montant)){echo '#'.sprintf("%01.3f",$depense->montant).'#' ;} ?></td>
    </tr>
    <tr>
        <td style=""></td>
        <td style=""></td>
    ...
    <tr >
        <td nowrap colspan="3" class="Style1" style="height: 10px;position: relative;top:-28px;left: 33px;"><?php if(!empty($depense->montant)){ echo int2str(sprintf("%01.3f",$depense->montant));} ?></td>
    </tr>
    <tr>
        <td style=""></td>
        <td colspan="3" class="Style1" style="height: 22px;position: relative;top:-25px;left: 90px;"><strong><?php echo $fournisseur->name; ?></strong></td>
    </tr>
    <tr>
        <td style=""></td>
        <td style=""></td>
    ...
    <tr>
        ...
        <td style="position: relative;top: -24px;left: 23px;" class="Style1">
            <table>
                ...
                <tr><td>Sfax&emsp;</td>
                    <td>&emsp;<?php  if(!empty($depense->echeance)  && $depense->echeance  !='1970-01-01') echo date("d/m/Y",strtotime(str_replace('-','/',$depense->echeance))); ?></td>
                </tr>
