...
<table width="659" border="0" background="" cellpadding="0" cellspacing="0" style="position:relative;top: 10px; left:15px; font-family:Arial, Helvetica, sans-serif; font-size:16px;">
    ...
    <tr>
        ...
        <td colspan="5" rowspan="2" align="center" valign="middle" style=" position: relative; top: -15px; padding-left:25px"> #<?php  if(!empty($depense->montant)){echo $depense->montant;}?> # </td>
    </tr>
    <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    ...
    <script src="<?= $this->Url->assetUrl('js/script_money.js') ?>"></script>
            ...
            <script>var ddl= ConvNumberLetter('<?php   echo $depense->montant;?>', 1, 0);
