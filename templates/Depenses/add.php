                ...
                <div class="box-body">
                    <div class="row">
                        <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            ...
                            <div id="divcaisse" style="display:none">
                                <div class="col-xs-6">
                                ...
                                <div class="col-xs-6">
                                    <?php echo $this->Form->control('soldecourant', ['readonly', 'id' => 'soldecourant', 'value' => '', 'label' => 'Solde courant', 'name', 'required' => 'off']); ?>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6">
                                <?php echo $this->Form->control('montant', ['id' => 'montant', 'value' => '', 'label' => 'Montant', 'name' => 'montant', 'required' => 'off', 'class' => 'form-control control-label checkmontant']); ?>
                            </div>

                            <div id="chequediv" style="display:none">
                                <div id="divnumero" class="col-xs-6">
                                    <?php echo $this->Form->control('numeropiece', ['id' => 'numeropiece', 'value' => '', 'label' => 'N° piece', 'name' => 'numeropiece', 'required' => 'off', 'class' => 'form-control control-label']); ?>
                                </div>

                                <div id="divporteur" class="col-xs-6">
                                    <?php echo $this->Form->control('porteur', ['id' => 'porteur', 'value' => '', 'label' => 'Porteur chèque', 'name' => 'porteur', 'required' => 'off', 'class' => 'form-control control-label']); ?>
                                </div>
                            ...
                            <div class="col-xs-6">
                                <?php echo $this->Form->control('fournisseur_id', ['options' => $fournisseurs, 'empty' => 'Veuillez choisir !!', 'required' => 'off', 'label' => 'Fournisseur', 'id' => 'fournisseur_id', 'class' => 'form-control select2 control-label four']); ?>
                            </div>
                            <div class="col-xs-6">
                                <div id="divbc"></div>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.four').on('change', function() {
            // alert('hello');
            id = $('#fournisseur_id').val();
            // alert(id)
            $.ajax({
                method: "GET",
                url: "<?= $this->Url->build(['controller' => 'Depenses', 'action' => 'getbc']) ?>",
                dataType: "json",
                data: {
                    id: id,
                ...
                success: function(data) {
                    // alert(data.select);
                    $('#divbc').html(data.select);
                    $('#commandefournisseur_id').select2();
