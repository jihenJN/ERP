    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box ">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            ...
                            <div class="col-xs-4">
                                <?php
                                // echo 'tt'.$commande;
                                echo $this->Form->control('depot_id', ['class' => 'form-control select2 control-label', 'required' => 'off']);
                                ?>
                            </div>
                    ...
                    <div class="col-xs-12">
                        <div class="col-xs-3">
                            ...
                            <select name="client_id" id="idclient" class="form-control select2  clientinfo  control-label getclientdata  ">
                        ...
                        <div class="col-xs-7" id="blocclient" style="display: none;">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-3">
                                    ...
                                    <?php
                                    echo $this->Form->input('echanciere', array('readonly' => 'readonly',  'label' => 'echanciere', 'style' => 'background-color:#C6FBC6; color:#000000 ;', 'id' => 'echanciere', 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control'));
                                    ?>
                                </div>
                                <!-- <div class="col-xs-3">
                                                <label style="color: #800080;"> Echanciére BL: </label>
                                                <?php
                                                echo $this->Form->input('echancierebl', array('readonly' => 'readonly', 'label' => 'echanciere bl', 'style' => 'background-color:#DB9CDB; color:#000000 ;', 'id' => 'echancierebl', 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control'));
                                                ?>
                                            </div> -->
                ...
                <div class="row">
                    ...
                    <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                        ...
                        <div class="col-xs-6" id="com_id" hidden>
                            <?php
                            echo $this->Form->control('commercial_id', ['class' => 'form-control select2 control-label', 'value' => 30, 'empty' => 'Veuillez choisir !!', 'required' => 'off']);
                            ?>
                        </div>
                ...
                <input type="hidden" value="" name="formule" id="formule" class="" style="margin-right: 20px">
                                        ...
                                        <table class="table table-bordered table-striped table-bottomless" id="tabligne">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="tr" style="display: none;font-size: 18px;font-weight: bold;">
                                                    ...
                                                    <td hidden>
                                                        <input readonly table="ligner" type="text" name="" champ="ttctest" class="form-control   " index>
                    ...
                    <div class="row" id="sec">
                        <div class="row">
                            <!-- <div style=" position: static;">
                                ...
                                <div class="col-xs-4" hidden>
                                    <?php echo $this->Form->control('totalttctest', ['id' => 'ttctest', 'readonly' => 'readonly', 'label' => 'test ttc', 'name', 'class' => 'form-control verifttctotal tot', 'required' => 'off']); ?>
                                </div>
                                <div class="col-xs-4">
                                    <?php echo $this->Form->control('Montant_Regler', ['class' => 'form-control', 'type' => 'hidden', 'value' => 0, 'id' => 'Montant_Regler', 'readonly' => 'readonly', 'label' => 'Montant_Regler', 'name' => 'Montant_Regler', 'required' => 'off']); ?>
                                </div>
    ...
    $(document).ready(function() {
        ...
        $(document).ready(function() {
            ...
            $(document).on('keydown', function(e) {
                ...
                var index = parseInt(focusedElement.attr('index'));

                if (focusedElement.hasClass('articlecode')) {
                    if (e.which === 37) {
                        if (index > 0) {
                            $('#article_id' + (index - 1)).focus();
                            e.preventDefault();
                        }
                    }
                    if (e.which === 39) {
                        $('#articledes' + index).select2('open');
                        e.preventDefault();
                    }
                } else if (focusedElement.hasClass('articlecode2')) {
                    if (e.which === 37) {
                        $('#article_id' + index).focus();
                        e.preventDefault();
                    }
                    if (e.which === 39) {
                        $('#qte' + index).focus();
        ...
        $('.articleidbl1des').on('change', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#qte' + index).focus();
                    // alert(response['donnearticle']["id"]);
