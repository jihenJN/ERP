      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <dl class="dl-horizontal">
            ...
            <dd><?= h($typeutilisateur->name) ?></dd>
            <dt scope="row"><?= __('Id') ?></dt>
            <dd><?= $this->Number->format($typeutilisateur->id) ?></dd>
          </dl>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-solid">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <?php if (!empty($typeutilisateur->clients)): ?>
          <table class="table table-hover">
              ...
              <?php foreach ($typeutilisateur->clients as $clients): ?>
              <tr>
                    <td><?= h($clients->id) ?></td>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-solid">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <?php if (!empty($typeutilisateur->fournisseurs)): ?>
          <table class="table table-hover">
              <tr>
                    <th scope="col"><?= __('Id') ?></th>
                    <th scope="col"><?= __('Name') ?></th>
              ...
              <?php foreach ($typeutilisateur->fournisseurs as $fournisseurs): ?>
              <tr>
