...
<section class="content-header">
    ...
    <?php if ($type == 2) { ?>
        <h1>
            Consultation Bordereau versement chéque
        </h1>
    <?php } else { ?>
        <h1>
        Consultation Bordereau versement traite
        </h1>
    <?php } ?>
    <ol class="breadcrumb">
                    ...
                    <div class="row">
                        <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            <div class="col-xs-6">
                                ...
                                ?>
                                <?php
                                echo $this->Form->control('date', ['readonly','id' => 'date', 'value' => @$date, 'label' => 'Du', 'class' => 'form-control date']);
                                ?>
