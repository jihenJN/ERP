                                                        ...
                                                        ?>
                                                            <tr style="<?php echo $color ?>">
                                                                ...
                                                                <td align="center" table="ligner" id='ss<?php echo $i ?>'>
                                                                    <br>
                                                                    <i id="suptest<?php echo $i ?>" class="fa fa-times supLigne0ch" style="color: #c9302c;font-size: 22px;" index="<?php echo $i ?>"></i>
                                                                </td>
                                                            </tr>
                                                        <?php endforeach; ?>
                                                    <?php endif; ?>
        ...
        <table>
            ...
            <tr>
                <td style="text-align:center;">
                    <?php
                    //  debug($commande->valide);die;
                    if ($commande->valide == 1) {
                        //
                    ?>

                        <div style="margin-bottom:20%">
                            <?= $this->Html->link(__('Annuler validation'), ['action' => 'devalidation', $commande->id], ['class' => 'btn btn-info btn-danger']) ?>
                        </div>
                    <?php } ?>
