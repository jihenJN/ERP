...
<section class="content-header">
  ...
  <td colspan="3">
    <div style="float: left;font-size: 12px;margin-left:10px;"><strong>Ajout tag categorie</strong></div>
      ...
      <div class="box ">
        ...
        <div class="box-body" style="font-size: 12px;">
          <div class="row">
            ...
            <div class="col-xs-6" style="font-size: 12px;">
              <?php
              echo $this->Form->control('couleur', ['label' => 'Couleur']); ?>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-6" style="font-size: 12px;">
...
<script>
  $(document).ready(function () {
    ...
    $("#test").on("mouseover", function () {
      ...
      ref = $("#ref").val();
      if (ref == "") {
        alert(" Veuillez saisir la réference SVP!!", function () { });
        return false;
      }
