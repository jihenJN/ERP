    ...
    <div class="box">
        ...
        <div class="box-body">
                    ...
                    <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                        ...
                        <div class="col-xs-4">
                            ...
                            echo $this->Form->control('confirme', [
                                ...
                                'style' => 'text-align:right',
                                'type' => 'select',
                                'options' => [1 => 'Validée', 2 => 'Non Validée']
            ...
            <div style="text-align:center">
                ...
                <a onclick="openWindow(1000, 1000, 'https://sirepprefaprod.isofterp.com/ERP/Factures/imprimelistefacture?historiquede=<?php echo @$historiquede; ?>&au=<?php echo @$au; ?>&fournisseur_id=<?php echo @$this->request->getQuery('fournisseur_id'); ?>&article_id=<?php echo @$this->request->getQuery('article_id'); ?>&achat=<?php echo @$this->request->getQuery('achat'); ?>&confirme=<?php echo @$this->request->getQuery('confirme'); ?>&service_id=<?php echo @$this->request->getQuery('service_id'); ?>&machine_id=<?php echo @$this->request->getQuery('machine_id'); ?>')" class="btn btn-sm btn-success" style="background-color:#8D6991;">
                    <i class='fa fa-print'></i>
                </a>
                <!-- <a onclick="openWindow(1000, 1000, 'https://sirepprefaprod.isofterp.com/ERP/Factures/imprimelistefacture?historiquede=<?php echo @$historiquede; ?>&au=<?php echo @$au; ?>&fournisseur_id=<?php echo @$this->request->getQuery('fournisseur_id'); ?>&article_id=<?php echo @$this->request->getQuery('article_id'); ?>&achat=<?php echo @$this->request->getQuery('achat'); ?>&confirme=<?php echo @$this->request->getQuery('confirme'); ?>&service_id=<?php echo @$this->request->getQuery('service_id'); ?>&machine_id=<?php echo @$this->request->getQuery('machine_id'); ?>')"
                    class="btn btn-sm btn-success">
                    <i class='fa fa-file-excel-o'></i> 
                </a> -->
                <?php echo $this->Html->link('<i class="fa fa-refresh"></i> Actualiser', ['action' => 'listefacture'], ['class' => 'btn btn-primary btn-sm', 'style' => 'background-color:#d6c38d;', 'escape' => false]) ?>
            </div>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Factures <span id="nameofcaisse"></span></h3>
                </div>
                <div class="box-body">
