...
<td><center>Nom/Raison Sociale</center></td>
...
<!--            <td align="center"><?php echo number_format($historiquearticle['Historiquevente']['totalht'],3, '.', ' '); ?></td>
            ...
            <?php } ?>
            <?php if($historiquearticle['Historiquevente']['indice']==4){ ?>
                <a onClick="flvFPW1(wr+'Bonreceptions/imprimerpourdepot/'+<?php  echo $historiquearticle['Historiquevente']['id_piece'];?>,'UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class='btn btn-xs ls-blue-btn'><i class='fa fa-print'></i></button></a>
            <?php } ?>
            <?php if($historiquearticle['Historiquevente']['indice']==5){ ?>
                <a onClick="flvFPW1(wr+'Factures/imprimerbonrecption/'+<?php  echo $historiquearticle['Historiquevente']['id_piece'];?>,'UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class='btn btn-xs ls-blue-btn'><i class='fa fa-print'></i></button></a>
            <?php } ?>
            <?php if($historiquearticle['Historiquevente']['indice']==6){ ?>
                <a onClick="flvFPW1(wr+'Factureavoirfrs/imprimerfavr/'+<?php  echo $historiquearticle['Historiquevente']['id_piece'];?>,'UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class='btn btn-xs ls-blue-btn'><i class='fa fa-print'></i></button></a>
            <?php } ?>
            <?php if($historiquearticle['Historiquevente']['indice']==7){ ?>
                <a onClick="flvFPW1(wr+'Transferts/imprimer/'+<?php  echo $historiquearticle['Historiquevente']['id_piece'];?>,'UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class='btn btn-xs ls-blue-btn'><i class='fa fa-print'></i></button></a>
            <?php } ?>
            <?php if($historiquearticle['Historiquevente']['indice']==8){ ?>
                <a onClick="flvFPW1(wr+'Bonreceptionstocks/imprimer/'+<?php  echo $historiquearticle['Historiquevente']['id_piece'];?>,'UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class='btn btn-xs ls-blue-btn'><i class='fa fa-print'></i></button></a>
            <?php } ?>
            <?php if($historiquearticle['Historiquevente']['indice']==9){ ?>
                <a onClick="flvFPW1(wr+'Bonsortiestocks/imprimer/'+<?php  echo $historiquearticle['Historiquevente']['id_piece'];?>,'UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class='btn btn-xs ls-blue-btn'><i class='fa fa-print'></i></button></a>
            <?php } ?>
            <?php if($historiquearticle['Historiquevente']['indice']==10){ ?>
                <a onClick="flvFPW1(wr+'Productions/imprimer3/'+<?php  echo $historiquearticle['Historiquevente']['id_piece'];?>,'UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class='btn btn-xs ls-blue-btn'><i class='fa fa-print'></i></button></a>
            <?php } ?>
            <?php if($historiquearticle['Historiquevente']['indice']==11){ ?>
                <a onClick="flvFPW1(wr+'Inventaires/imprimer/'+<?php  echo $historiquearticle['Historiquevente']['id_piece'];?>,'UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class='btn btn-xs ls-blue-btn'><i class='fa fa-print'></i></button></a>
            <?php } ?>
            <?php if($historiquearticle['Historiquevente']['indice']==12){ ?>
                <a onClick="flvFPW1(wr+'Factureavoirfrs/imprimerfavr/'+<?php  echo $historiquearticle['Historiquevente']['id_piece'];?>+'/bl','UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;" ><button class='btn btn-xs ls-blue-btn'><i class='fa fa-print'></i></button></a>
            <?php } ?>    
            </td>  
        </tr>
    <?php } ?>
