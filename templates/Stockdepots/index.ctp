...
<div class="row" >
    <div class="col-md-12" >
        ...
        <?php echo $this->Form->create('Stockdepot',array('type' => 'post','autocomplete' => 'off','class'=>'form-horizontal ls_form')); ?>
 ...
 ?>
               ...
               // echo $this->Form->input('editeur_id',array('value'=>@$editeur_id,'empty'=>'veuillez choisir','div'=>'form-group','label'=>'Editeur','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control'));
                echo $this->Form->input('depot_id',array('id'=>'depot_id','value'=>@$depotid,'empty'=>'veuillez choisir','div'=>'form-group','label'=>'Depot','between'=>'<div class="col-sm-10">','after'=>'</div>','class'=>'form-control'));
      ...
      //   echo 'tt'.$famille_id; ?>
                ...
                <div class="form-group">
                    <div class="col-lg-9 col-lg-offset-3">
                        <button type="submit" class="btn btn-primary testdepot" id="aff">Chercher</button>
...
if($qtestock<0) $qtestock=0;
        ...
        $total=$total+($stockdepot['Article']['prixafodec']*$qtestock);
      //  $dernierprix=$dernierprix+($stockdepot[0]['dernierprix']*$stockdepot[0]['qte']);
            ?>
	<tr>
		
        <td >
			<?php echo $this->Html->link($stockdepot['Article']['codeabarre'], array('controller' => 'etathistoriquearticles', 'action' => 'indexspecial', $stockdepot['Article']['codeabarre'],@$depotid)); ?>

		  </td>
		<td >
			<?php echo $this->Html->link($stockdepot['Article']['designiation'], array('controller' => 'etathistoriquearticles', 'action' => 'indexspecial', $stockdepot['Article']['codeabarre'],@$depotid)); ?>
	 ...
	 <td align="center"><?php
               echo $qtestock
                 ?></td> 
<td >
			<?php echo  $stockdepot['Article']['prixafodec']; 
		...
		?>
              ...
              <!--  <td align="center"><?php echo number_format($stockdepot['Article']['prixafodec'],3,'.',''); ?></td>-->
                <td align="center"><?php              if($stockdepot[0]['qte']>0)  echo number_format($stockdepot['Article']['prixafodec']*$stockdepot[0]['qte'],3,'.',''); ?></td>
                <?php }}?>
...
// pagelimit
  // $page_limit = 20;
// Set Offset
//$page_offset = $page_limit * ($page - 1);
// appel function 
 
//echo   AppController::pagin($page,$page_limit,$page_offset,$count,$this->webroot.'Stockdepots/index/');

 // $this->requestAction('App/pagin/'.$page.'/'.$page_limit.'/'.$page_offset.'/'.$count.'/'.$this->webroot.'Clients/index/');?>
                              					</div> 
                                </div></div></div></div></div>	
