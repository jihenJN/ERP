...
<!--                <td align="left"><?php echo ('PR HT'); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
	...
	<?php //debug($stockdepots);die;
        ...
        $total=$total+($articleanss['Article']['pmp']*$stockdepot[0]['qte']);    
            ?>
	<tr>
		<td style="display:none"><?php echo h($stockdepot['Article']['code']); ?></td>
		<td >
			<?php echo $this->Html->link($stockdepot['Article']['code']." ".$stockdepot['Article']['name'], array('controller' => 'etathistoriquearticles', 'action' => 'index', $stockdepot['Article']['id'])); ?>
		</td>
		...
		<td align="center">
                ...
                ?></td>
<!--                <td align="center"><?php echo number_format($articleanss['Article']['pmp'],3,'.',' '); ?></td>
                <td align="center"><?php echo number_format($articleanss['Article']['pmp']*$stockdepot[0]['qte'],3,'.',' '); ?></td>-->
		
	</tr>
<?php endforeach; ?>
                          </tbody>
<!--                          <tfoot>
                          <td colspan="<?php echo @$d+1; ?>"><strong>Total</strong></td> 
