...
<br><br><br>
 ...
 <table border="1" align="center" cellpadding="2" cellspacing="0"  width="100%" class="table" >       
   <tr bgcolor="#FFFFFF" align="center">
                        <th width="15%" align="center" $zz height="30px" ><strong>Date</strong></th>
                        <th width="15%" align="center" $zz ><strong>Numéro</strong></th>
                        <th width="15%" align="center" $zz ><strong>Action</strong></th>
                        <th width="55%" align="center" $zz ><strong>Client</strong></th>
        ...
        $tbl .= 
    '<tr align="center">    
        <td width="15%" nobr="nobr" align="center" height="30px" $zz><strong>'.date("d-m-Y",strtotime(str_replace('/','-',$historiquearticle['Historiquevente']['date']))).'</strong></td>
        <td width="15%" nobr="nobr" align="center"  $zz>'.$historiquearticle['Historiquevente']['numero'].'</td>
        <td width="15%" nobr="nobr" align="center"  $zz>'.$historiquearticle['Historiquevente']['type'].'</td>
        <td width="55%" nobr="nobr" align="left"  $zz>'.$historiquearticle['Historiquevente']['client'].'</td>
