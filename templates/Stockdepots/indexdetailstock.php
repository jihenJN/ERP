            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="col-lg-9 col-lg-offset-3">
                        ...
                        ?>
                            <a onclick="openWindow(1000, 1000, wr+'Stockdepots/impdepdetails?depot_id=<?php echo @$depotid; ?>&marque_id=<?php echo @$marque_id; ?>&datedebut=<?php echo @$datedebut; ?>&datefin=<?php echo @$datefin; ?>')"><button class="btn btn-primary ">Imprimer</button></a>
                        <?php }  ?>
                        <?php echo $this->Html->link(__('Actualiser'), ['action' => '/indexdetailstock'], ['class' => 'btn btn-primary ']) ?>
