        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="col-xs-6">
                        <?php echo $this->Form->control('echeance', ['label' => 'Echéance', 'empty' => true, 'id' => 'date', 'class' => "form-control"]);
                        ?>
                    </div>
                    <div class="col-xs-6" hidden>
                        <?php echo $this->Form->control('service_id', ['label' => 'Service', 'empty' => 'Veuillez choisir !!', 'options' => $services, 'class' => 'form-control select2 ', 'id' => 'service_id', 'required' => 'off']); ?>
                    </div>
                    <div class="col-xs-6" hidden>
                    ...
                    <div class="col-xs-6">
                        <?php
                        echo $this->Form->control('remarque', ['label' => 'Besoin d`achat']);
                        ?>
                    </div>
                    ...
                    <div class="row">
                        <div class="box">
                            <div class="box-header with-border">
                                <a class="btn btn-primary al" table='tabligne2' index='index2' id='ajouter_ligne2' style="
                                       float: right;
                                       margin-bottom: 5px;">
                                    ...
                                    <table class="table table-bordered table-striped table-bottomless" id="tabligne2">
                                        ...
                                        <tbody>
                                            <tr class="tr" style="display: none !important">
                                                ...
                                                <td align="center">
                                                    <input type="hidden" name="sup2" id="" champ="sup2" table="lignea" index="" class="form-control">

                                                    <div id="" champ='f1' index="" name="" table="lignea" class="col-md-10">

                                                        <select name="" index="" champ="article_id" id="" class="form-control " table="lignea">
                                                    ...
                                                    <!-- <span title="ajout article" index=""> <a href="javascript:;" index="" class="btn btn-primary b2"><i id="" index="" name="" champ="btnajo" table="lignea" class='fa fa fa-plus'></i>
                                                        </a>
                                                    </span> -->
                                                    <div id="" champ='f2' index="" name="" table="lignea" style="display: none !important" class="col-md-10">
                                                        <input table="lignea" type='text' id='id' name='' champ='desginationA' class='form-control ' class='input' empty='Veuillez choisir !!'>
                                                    </div>

                                                </td>
                                                <td align=" center" table="lignea">

                                                    <input table="lignea" name="" index="" name="qte" champ="qte" id="qte" type="text" class="form-control ">
                                                </td>
                                                <td align="center">
                                                    <i index="" id="" class="fa fa-times supLignemelek" style="color: #c9302c;font-size: 22px;"></i>
                                                </td>
                                            </tr>
                                            <?php
                                            $i = -1;
                                                ...
                                                <tr>
                                                    <td style="width: 8%;" align="center">
                                                        ...
                                                        if ($article->article_id != null) {
                                                            ...
                                                            echo $this->Form->control('article_id', array('label' => False, 'options' => $art, 'value' => $article->article_id, 'name' => 'data[lignea][' . $i . '][article_id]', 'id' => 'article_id' . $i, 'table' => 'lignea', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control select2 '));
                                                        } ?>


                                                        <?php
                                                        if ($article->desginationA != null) {
                                                            echo $this->Form->input('desginationA', array('label' => false, 'value' => $article->desginationA, 'name' => 'data[lignea][' . $i . '][desginationA]', 'type' => 'text', 'id' => 'desginationA' . $i, 'table' => 'lignea', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control'));
                                                        } ?>
                                                    ...
                                                    <td align="center">
                                                        <?php echo $this->Form->input('qte', array('label' => false, 'value' => $article->qte, 'name' => 'data[lignea][' . $i . '][qte]', 'type' => 'text', 'id' => 'qte' . $i, 'table' => 'lignea', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control')); ?>
                                                    ...
                                                    <td align="center"><i index="<?php echo $i ?>" class="fa fa-times supLignemelek" style="color: #C9302C;font-size: 22px;"></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    </table><br />
