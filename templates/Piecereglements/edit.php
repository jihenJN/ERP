 ...
 * @var string[]|\Cake\Collection\CollectionInterface $societes
...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $piecereglement->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $piecereglement->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="piecereglements form content">
            ...
            <fieldset>
                <legend><?= __('Edit Piecereglement') ?></legend>
                <?php
