    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div style="text-align:center">
                ...
                <a onclick="openWindow(1000, 1000, 'https://sirepprefaprod.isofterp.com/ERP/Livraisons/imprimelistebl?historiquede=<?php echo @$historiquede; ?>&au=<?php echo @$au; ?>&fournisseur_id=<?php echo @$this->request->getQuery('fournisseur_id'); ?>&article_id=<?php echo @$this->request->getQuery('article_id'); ?>&achat=<?php echo @$this->request->getQuery('achat'); ?>&service_id=<?php echo @$this->request->getQuery('service_id'); ?>&machine_id=<?php echo @$this->request->getQuery('machine_id'); ?>')" class="btn btn-sm btn-success" style="background-color:#8D6991;">
                    <i class='fa fa-print'></i>
                </a>
                <!-- <a onclick="openWindow(1000, 1000, 'https://sirepprefaprod.isofterp.com/ERP/Livraisons/imprimeofprix?historiquede=<?php echo @$historiquede; ?>&au=<?php echo @$au; ?>&fournisseur_id=<?php echo @$this->request->getQuery('fournisseur_id'); ?>&article_id=<?php echo @$this->request->getQuery('article_id'); ?>&achat=<?php echo @$this->request->getQuery('achat'); ?>&service_id=<?php echo @$this->request->getQuery('service_id'); ?>&machine_id=<?php echo @$this->request->getQuery('machine_id'); ?>')"
                    class="btn btn-sm btn-success">
                    <i class='fa fa-file-excel-o'></i> 
                </a> -->
                <?php echo $this->Html->link('<i class="fa fa-refresh"></i> Actualiser', ['action' => 'listebl'], ['class' => 'btn btn-primary btn-sm', 'style' => 'background-color:#d6c38d;', 'escape' => false]) ?>
            </div>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Les bons de livraison <span id="nameofcaisse"></span></h3>
                </div>
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $totalttc = 0;
                            $totalht = 0;
                            foreach ($bonlivraisons as $i => $data) :
                                $totalttc += $data['ttc'];
                                $totalht += $data['ht'];
                            ?>
                                <tr>
