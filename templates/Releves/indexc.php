...
<section class="content-header">
    <header>
        <h1 style="text-align:center;"> Fiche Client</h1>
    </header>
</section>
            ...
            <div class="panel-body">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group input select required">
                        ...
                        <select name="client_id" id="client" class="form-control select2 control-label  ">
                            ...
                            ?>
                                <option <?php if (isset($this->request->getQuery()['client_id']) && $this->request->getQuery()['client_id'] == $client->id) echo "selected" ?> value="<?php echo $client->id; ?>"><?php echo $client->Code . ' ' . $client->Raison_Sociale ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-lg-9 col-lg-offset-3">
                        <button id="breleve" type="submit" style ="border:#a2a2d0;background-color:#a2a2d0;" class="btn btn-primary testhistoriquearticle ">Afficher</button>
                        <!-- <a href="<?= $this->Url->build(['controller' => 'Releves', 'action' => 'imprimerrecherche']) ?>
                                                        
                            ">Imprimer</a> -->
                        <?php if ($countt != 0) { ?>
                            <!-- <a onClick="flvFPW1('/ERP/releves/imprimerrecherche?date1=<?php echo @$date1; ?>&date2=<?php echo @$date2; ?>&name=<?php echo @$name; ?>&soldeint=<?php echo @$soldeint; ?>','UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;"><button class="btn btn-primary">Imprimer</button> </a> -->
                        <?php } ?>
                        <?php echo $this->Html->link(__('Actualiser'), ['action' => '/indexc'], ['style' =>'border:#a2a2d0;background-color:#a2a2d0;','class' => 'btn btn-primary']) ?>
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <!-- <h3 class="panel-title"><?php echo __('Etat client'); ?></h3> -->
            </div>
            <div class="panel-body">
                <div>
                    <table border="1" style="border:2px solid black;width:100%">
                        <thead>
                            ...
                            <?php if (!empty($date1) || !empty($date2)) {  ?>
                                <tr>
                                    <td style="background-color: #a2a2d0;" align="center"><strong> P&eacute;riode </strong></td>
                                    <td colspan="2" bgcolor="#a2a2d0" align="center"><strong><?php echo date("d/m/Y", strtotime(str_replace('-', '/', @$date1))); ?></strong></td>
                                    <td align="center" colspan="2" bgcolor="#a2a2d0"><strong><?php echo date("d/m/Y", strtotime(str_replace('-', '/', @$date2))); ?></strong></td>
                                </tr>
                                <tr>
                                    <td colspan="5" style="height: 10px;"></td>
                                </tr>
                            ...
                            <?php if (!empty($name)) {  ?>
                                <tr>
                                    <td style="background-color: #a2a2d0;" align="center"><strong> Agent </strong></td>
                                    <td colspan="4" bgcolor="#a2a2d0"><strong><?php echo @$name; ?></strong></td>
                                </tr><strong>
                                    <tr>
                                        <td colspan="5" style="height: 10px;"></td>
                                    </tr>
                                ...
                                <?php }  ?>
                                <tr>
                                    <td style="background-color: #a2a2d0;" align="center"><strong> Client </strong></td>
                                    <td colspan="4"><strong>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $cli->Code . "  " . $cli->Raison_Sociale; ?></strong></td>
                                </tr>
                                <tr>
                                    <td colspan="5" style="height: 10px;"></td>
                                </tr>
                                ...
                                <tr style="border:1px solid black;" class="tdreleveclient">
                                    ...
                                    <th style="border:1px solid black;width: 97px;" bgcolor="#a2a2d0"><strong>
                                            <center>Date</center>
                                        </strong></th>
                                    <!--                <th style="border:1px solid black;width: 138px;" bgcolor="#a2a2d0"><strong><center>N� Piece</center></strong></th>-->
                                    <th style="border:1px solid black;width: 642px;" bgcolor="#a2a2d0"><strong>
                                            <center>Libell&eacute; Piece</center>
                                        </strong></th>
                                    <th style="border:1px solid black;width: 118px;" bgcolor="#a2a2d0"><strong>
                                            <center>D&eacute;dit</center>
                                        </strong></th>
                                    <th style="border:1px solid black;width: 106px;" bgcolor="#a2a2d0"><strong>
                                            <center>Cr&eacute;dit</center>
                                        </strong></th>
                                    <!--            <th style="border:1px solid black;width: 105px;" bgcolor="#a2a2d0" ><strong><center>Impay�</center></strong></th>
                <th style="border:1px solid black;width: 105px;" bgcolor="#a2a2d0" ><strong><center>R�glement</center></strong></th>
                <th style="border:1px solid black;width: 96px;" bgcolor="#a2a2d0" ><strong><center>Avoir</center></strong></th>-->
                                    <th style="border:1px solid black;width: 117px;" bgcolor="#a2a2d0"><strong>
                                            <center>Solde</center>
                                        </strong></th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="background-color: #a2a2d0;" align="center" colspan="2"><strong> Solde d&eacute;part </strong></td>
                                    <?php //debug($soldeint); 
                                    ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <?php if ($relefe['client_id'] != $clt_id) { ?>
                                    <?php if ($i != 0) {
                                    ?>
                                        <tr>
                                            <td colspan="5" style="height: 10px;"></td>
                                        ...
                                        <tr style='display:none'>
                                            <td colspan="2" style="background-color: #a2a2d0;" align="center"><strong> Total </strong></td>
                            ...
                            <tr>
                                <td colspan="2" style="background-color: #a2a2d0;" align="center"><strong> Total G&eacute;n&eacute;ral </strong></td>
