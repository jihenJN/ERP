                ...
                <div class="form-group">
                    <div class="col-lg-9 col-lg-offset-3">
                        ...
                        <!-- <a href="<?= $this->Url->build(['controller' => 'Releves', 'action' => 'imprimerrecherche']) ?>
                            ...
                            ">Imprimer</a> -->
                        <?php if ($countt != 0) { ?>
                            <a onClick="flvFPW1('/ERP/releves/imprimerrecherche?date1=<?php echo @$date1; ?>&date2=<?php echo @$date2; ?>&name=<?php echo @$name; ?>&soldeint=<?php echo @$soldeint; ?>&bl=<?php echo @$this->request->getQuery()['bl']; ?>','UPLOAD','width=800,height=1150,scrollbars=yes',0,2,2);return document.MM_returnValue" href="javascript:;"><button class="btn btn-primary">Imprimer</button> </a>
                        <?php } ?>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                    ...
                    <table border="1" style="border:2px solid black;width:100%">
                        <thead>
                            ...
                            <?php if (!empty($date1) || !empty($date2)) {  ?>
                                <tr>
                                    <td style="background-color: #F2D7D5;" align="center"><strong> P&eacute;riode </strong></td>
                                    <td colspan="2" bgcolor="#F2D7D5" align="center"><strong><?php echo date("d/m/Y", strtotime(str_replace('-', '/', @$date1))); ?></strong></td>
                                    <td align="center" colspan="2" bgcolor="#F2D7D5"><strong><?php echo date("d/m/Y", strtotime(str_replace('-', '/', @$date2))); ?></strong></td>
                                </tr>
                                <tr>
                                    <td colspan="5" style="height: 10px;"></td>
                                </tr>
                            ...
                            <?php if (!empty($name)) {  ?>
                                <tr>
                                    <td style="background-color: #F2D7D5;" align="center"><strong> Agent </strong></td>
                                    <td colspan="4" bgcolor="#F2D7D5"><strong><?php echo @$name; ?></strong></td>
                                </tr><strong>
                                    <tr>
                                        <td colspan="5" style="height: 10px;"></td>
                                    </tr>
                                ...
                                <tr style="border:1px solid black;" class="tdreleveclient">
                                    ...
                                    <th style="border:1px solid black;width: 97px;" bgcolor="#F2D7D5"><strong>
                                            <center>Date</center>
                                        </strong></th>
                                    <!--                <th style="border:1px solid black;width: 138px;" bgcolor="#F2D7D5"><strong><center>N� Piece</center></strong></th>-->
                                    <th style="border:1px solid black;width: 642px;" bgcolor="#F2D7D5"><strong>
                ...
                <th style="border:1px solid black;width: 96px;" bgcolor="#F2D7D5" ><strong><center>Avoir</center></strong></th>-->
                                    <th style="border:1px solid black;width: 117px;" bgcolor="#F2D7D5"><strong>
                                            <center>Solde</center>
                                        </strong></th>
                                </tr>
                                <tr>
