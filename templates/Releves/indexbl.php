...
<section class="content-header">
    <header>
        <h1 style="text-align:center;">Relevés client</h1>
    </header>
</section>
...
<div class="row">
                ...
                <div class="form-group">
                    <div class="col-lg-9 col-lg-offset-3">
                       ...
                       ">aaaa</a> -->
                        ...
                        <?php } ?>
                        <?php echo $this->Html->link(__('Actualiser'), ['action' => '/indexbl'], ['class' => 'btn btn-primary']) ?>
                        <!-- <a href="/demo/releves/index" class="btn btn-primary btn-sm">Actualiser</a> -->
                        <!-- <a href="https://www.youtube.com/watch?v=M_7D78HBRIc"F><button type="button" class="btn btn-primary">hachem 26/01/2023</button> </a>
                       -->
                    ...
                    <table border="1" style="border:2px solid black;width:100%">
                        <thead>
                            ...
                            <?php if (!empty($date1) || !empty($date2)) {  ?>
                                <tr>
                                    <td style="background-color: #ECAD6D;" align="center"><strong> P&eacute;riode </strong></td>
                                    <td colspan="2" bgcolor="#ECAD6D" align="center"><strong><?php echo date("d/m/Y", strtotime(str_replace('-', '/', @$date1))); ?></strong></td>
                                    <td align="center" colspan="2" bgcolor="#ECAD6D"><strong><?php echo date("d/m/Y", strtotime(str_replace('-', '/', @$date2))); ?></strong></td>
                                </tr>
                                <tr>
                                    <td colspan="5" style="height: 10px;"></td>
                                </tr>
                            ...
                            <?php if (!empty($name)) {  ?>
                                <tr>
                                    <td style="background-color: #ECAD6D;" align="center"><strong> Agent </strong></td>
                                    <td colspan="4" bgcolor="#ECAD6D"><strong><?php echo @$name; ?></strong></td>
                                </tr><strong>
                                    <tr>
                                        <td colspan="5" style="height: 10px;"></td>
                                    </tr>
                                ...
                                <?php }  ?>
                                <tr>
                                    <td style="background-color: #ECAD6D;" align="center"><strong> Client </strong></td>
                                ...
                                <tr style="border:1px solid black;" class="tdreleveclient">
                                    ...
                                    <th style="border:1px solid black;width: 97px;" bgcolor="#ECAD6D"><strong>
                                            <center>Date</center>
                                        </strong></th>
                                    <!--                <th style="border:1px solid black;width: 138px;" bgcolor="#ECAD6D"><strong><center>N� Piece</center></strong></th>-->
                                    <th style="border:1px solid black;width: 642px;" bgcolor="#ECAD6D"><strong>
                                            <center>Libell&eacute; Piece</center>
                                        </strong></th>
                                    <th style="border:1px solid black;width: 118px;" bgcolor="#ECAD6D"><strong>
                                            <center>D&eacute;dit</center>
                                        </strong></th>
                                    <th style="border:1px solid black;width: 106px;" bgcolor="#ECAD6D"><strong>
                                            <center>Cr&eacute;dit</center>
                                        </strong></th>
                                    <!--            <th style="border:1px solid black;width: 105px;" bgcolor="#ECAD6D" ><strong><center>Impay�</center></strong></th>
                <th style="border:1px solid black;width: 105px;" bgcolor="#ECAD6D" ><strong><center>R�glement</center></strong></th>
                <th style="border:1px solid black;width: 96px;" bgcolor="#ECAD6D" ><strong><center>Avoir</center></strong></th>-->
                                    <th style="border:1px solid black;width: 117px;" bgcolor="#ECAD6D"><strong>
                                            <center>Solde</center>
                                        </strong></th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="background-color: #ECAD6D;" align="center" colspan="2"><strong> Solde d&eacute;part </strong></td>
                                    <?php //debug($soldeint); 
                                    ?>
                                ...
                                <?php if ($relefe['client_id'] != $clt_id) { ?>
                                    ...
                                    ?>
                                        ...
                                        <tr style='display:none'>
                                            <td colspan="2" style="background-color: #ECAD6D;" align="center"><strong> Total </strong></td>
    ...
    <td  align="right"><strong><?php echo number_format(@$totavoir, 3, '.', ' '); ?></strong></td>-->
                            ...
                            <tr>
                                <td colspan="2" style="background-color: #ECAD6D;" align="center"><strong> Total G&eacute;n&eacute;ral </strong></td>
