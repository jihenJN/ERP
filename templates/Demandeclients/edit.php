            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <div class="col-md-12">
                        ...
                        <div class="col-xs-6">
                            <h1 class="box-title" style="color:#3C386E!important;margin-top:5%;"><strong>Modification Formulaire Consultation Client</strong></h1>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td align="center">
                                                                <?php echo $this->Form->input('exigence', array('label' => '', 'value' => $res->exigence, 'name' => 'data[ligner][' . $i . '][exigence]', 'type' => 'text', 'id' => 'exigence' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control  ', 'index')); ?>
                                                            </td>
