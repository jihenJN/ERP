...
<section class="content-header">
    <header>
        <h1 style="text-align:center;"> Paramètrage article</h1>
    </header>
</section>
<?php
/**
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="actions text-center">
                                        ...
                                        echo $this->Html->link("<button index= '" . $i . "' id='parametre" . $i . "' class='btn btn-xs btn-primary'><i class='fa fa-edit'></i></button>", array('action' => 'criteres', $article->id), array('escape' => false));
