...
use Cake\I18n\FrozenTime; // Import the FrozenTime class if you're not already using it
...
$mf = explode('/', $fournisseur->matricule);
...
$Matricule_Fiscale = $fournisseur->matricule;
...
// Assuming $date is your DateTime variable
$annee = $date->format('Y'); // 'Y' format specifier represents the year in four digits
//echo $annee; 
// print_r($annee);
...
<tr><td height="28px">*Revenus des capitaux mobiliers </td>
    <td> </td>
    <td> </td>
    <td> </td>
</tr>
...
<tr>
<td  align="center" height="15px"  style="border: 0px solid black;"></td>
    <td align="center" width="30%"  style="border: 0px solid black;"> ' . 'F N° ' . $ligne->facture->numero . '  </td>

    <td align="right" style="border: 0px solid black;" >' .   $this->Time->format($ligne->facture->date, 'dd/MM/y') . '  </td>
...
<tr><td colspan="4"><strong>C- BENIFICIAIRE </strong><br>
    N° de la carte d\'identité <br> ou de passeport :  <br> ou de séjour pour les étrangers
        ...
        <tr><td colspan="2">Adresse  : ' . $fournisseur->adresse . '<br></td></tr>
...
<tr><td colspan="4"><table><tr><td width="15%"></td>
                   ...
                   Le <strong>' . $this->Time->format($lignep->echance, 'dd/MM/y').'<br><br><br></strong></td>
                        <td width="20%"></td></tr></table><br><br>
</td></tr>
