                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            ...
                            echo $this->Form->control('date', array('value' => $this->request->getQuery('date'), 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control datePickerOnly ', 'type' => 'date', 'label' => 'Encaissement du'));
                            ?>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            ...
                            <?php
                            echo $this->Form->control('fournisseur_id', array('value' => $this->request->getQuery('fournisseur_id'), 'id' => 'fournisseur_id', 'empty' => 'veuillez choisir', 'div' => 'form-group', 'label' => 'Fournisseur', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control select2', 'options' => $fournisseurs));
                            ?>
                        ...
                        <div class="col-xs-6">
                            ...
                            <?php
                            echo $this->Form->control('compte_id', array('id' => 'compte_id', 'value' => $this->request->getQuery('compte_id'), 'empty' => 'veuillez choisir', 'div' => 'form-group', 'label' => 'Compte', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control select2', 'options' => $comptes));
                            ?>
                        </div>
                        <div class="col-xs-6">

                            <?php
                            echo $this->Form->control('paiement_id', array('id' => 'paiement_id', 'value' => $this->request->getQuery('paiement_id'), 'empty' => 'veuillez choisir', 'div' => 'form-group', 'label' => 'Mode Paiements', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control select2', 'options' => $modes));
                            ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="pull-right" style="margin-right:50%;margin-top: 20px;">
                            ...
                            if ($count != 0) {
                            ?>
                                <a onclick="openWindow(1000, 1000, wr+'reglements/imprimereng?date=<?php echo @$datereg; ?>& echance=<?php echo @$echance;  ?>&fournisseurid=<?php echo @$fournisseurid; ?>&compteid=<?php echo @$compteid;  ?>&paiementid=<?php echo @$paiementid;  ?>')"><button class="btn btn-primary ">Imprimer</button></a>
                            <?php }
                            ?>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <?php if ($dataItem->etat_id != 2) { ?>
                                        <input type="checkbox" id="<?php echo $i; ?>" idp="<?php echo $dataItem->id; ?>" idreg="<?php echo $dataItem->reglement->id; ?>" idcompte="<?php echo $dataItem->compte_id; ?>" montant="<?php echo $dataItem->montant; ?>" index="<?php echo $i; ?>" class="afficherbouttonsituation">
                                    <?php } ?>
                                </td>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <input id="id_display_modal" type="hidden" table="etatpieceregelemnts" champ="piecereglement_id" name="piecereglement_id" class="form-control">

                                        <input id="idreg_display_modal" type="hidden" table="etatpieceregelemnts" champ="reglement_id" name="reglement_id" class="form-control">
                                        <label> Montant</label>
