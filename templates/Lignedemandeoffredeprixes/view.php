      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <dl class="dl-horizontal">
            ...
            <dd><?= $lignedemandeoffredeprix->has('demandeoffredeprix') ? $this->Html->link($lignedemandeoffredeprix->demandeoffredeprix->id, ['controller' => 'Demandeoffredeprixes', 'action' => 'view', $lignedemandeoffredeprix->demandeoffredeprix->id]) : '' ?></dd>
            <dt scope="row"><?= __('Article') ?></dt>
            <dd><?= $lignedemandeoffredeprix->has('article') ? $this->Html->link($lignedemandeoffredeprix->article->id, ['controller' => 'Articles', 'action' => 'view', $lignedemandeoffredeprix->article->id]) : '' ?></dd>
            <dt scope="row"><?= __('DesigniationA') ?></dt>
            <dd><?= h($lignedemandeoffredeprix->designiationA) ?></dd>
            <dt scope="row"><?= __('Fournisseur') ?></dt>
            <dd><?= $lignedemandeoffredeprix->has('fournisseur') ? $this->Html->link($lignedemandeoffredeprix->fournisseur->name, ['controller' => 'Fournisseurs', 'action' => 'view', $lignedemandeoffredeprix->fournisseur->id]) : '' ?></dd>
            <dt scope="row"><?= __('NameF') ?></dt>
            <dd><?= h($lignedemandeoffredeprix->nameF) ?></dd>
            <dt scope="row"><?= __('Id') ?></dt>
            <dd><?= $this->Number->format($lignedemandeoffredeprix->id) ?></dd>
            <dt scope="row"><?= __('Qte') ?></dt>
            <dd><?= $this->Number->format($lignedemandeoffredeprix->qte) ?></dd>
          </dl>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-solid">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <?php if (!empty($lignedemandeoffredeprix->lignebandeconsultations)): ?>
          <table class="table table-hover">
              ...
              <?php foreach ($lignedemandeoffredeprix->lignebandeconsultations as $lignebandeconsultations): ?>
              <tr>
