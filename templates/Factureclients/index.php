...
<section class="content-header">
    <header>
        <h1 style="text-align:center;">Facture A Terme</h1>
    </header>
</section>
                            ...
                            ?>
                                <tr style="font-size: 16px;">
                                    ...
                                    <?php if ($facture->client_id == 12) { ?>
                                        <td ><?php echo $facture->client->Code .' '. $facture->nomprenom;?></td>
                                    ...
                                    <td>
                                        ...
                                        <?php } ?>
                                        <?php if ($edit == 1 && $facture->client_id != 12  /*&& $testregler == 0 && $BLTotQte == 0*/) {
                                        ...
                                        <?php if ($delete == 1 && $testregler == 0 && $BLTotQte == 0) {
                                            echo $this->Form->postLink("<button class='deleteConfirm btn btn-xs btn-danger'><i class='fa fa-trash-o'></i></button>", array('action' => 'delete', $facture->id), array('escape' => false, null), __('Veuillez vraiment supprimer cette enregistrement # {0}?', $facture->id));
                                        } ?>
