                ...
                <div class="box-body">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="col-xs-4">
                                <div class="form-group input select required">
                                    ...
                                    <select readonly name="client_id1" id="client1" class="form-control client1 control-label ">
                                                    ...
                                                    ?>
                                                        <tr style="font-size: 18px;font-weight: bold;">
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                ?>
                                                                <?php echo $this->Form->input('puttc', array('label' => '', 'value' => $res->puttc, 'name' => 'data[ligner][' . $i . '][puttc]', 'type' => '', 'id' => 'puttc' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control  findtth1', 'index')); ?>
                                                            </td>
                                                            <td align="center">
                    ...
                    <section class="content" style="width: 99%">
                        <div class="row" id="sec">
                            ...
                            <div class="col-xs-6">
                                <?php echo $this->Form->control('observation', ['label' => 'Commentaire', 'class' => 'form-control', 'value' => $factureclient->observation, 'type' => 'textarea']);
                                ?>
