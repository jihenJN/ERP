    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <?php echo $this->Form->create($factureclient, ['role' => 'form', 'onkeypress' => "return event.keyCode!=13"]); ?>
                        ...
                        <div class="row dalanda">
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-xs-1" hidden>
                                        <?php echo $this->Form->control('type', ['label' => 'Type ', 'value' => $type, 'required' => 'off']); ?>
...
$typereg = $type;
$currentYear = date('Y');
$query = 'SELECT numero FROM factureclients WHERE YEAR(factureclients.date) = :year ';
...
<script>
    function calculateTotalTTC() {
        ...
        var totalTTC = parseFloat($('#ttc').val().replace(',', '.'));
        ...
        if (sum < totalTTC) {
            ...
            // alert('Le montant réglé correspond au total TTC.');
        }
    }

    $(document).on('mouseover', '.testreglement', calculateTotalTTC);
        ...
        $('.articleidbl1des').on('change', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    console.log("idart" + response['donnearticle']['id']);
...
<script>
    $(document).ready(function() {
        ...
        $(".supreg").on("click", function() {
            ...
            // Update Montant_Regler with the new sum
