...
<div style="display:flex;margin-bottom:3px;" align="center">
    <div style="display:flex;width: 1000%;">
        <div style="width: 10000%;border:0px solid black;border-radius: 15px" align="left">
            <br>
            <b style="margin-left:1% ;"> Code: </b><?= h($factureclient->client->Code) ?> <br>
            <b style="margin-left:1% ;"> Matricule fiscale :</b><?= h($factureclient->client->Matricule_Fiscale) ?> <br>
            <b style="margin-left:1% ;"> Client : </b> <?php
                                                        if (isset($factureclient->client)) {
                                                            echo  h($factureclient->client->Raison_Sociale);
                                                        } ?><br>
            <b style="margin-left:1% ;"> Adresse :</b><?= h($factureclient->client->Adresse) ?> <br>
        </div>
    </div>
        ...
        <div>
                        ...
                        <tbody>
                            <tr class="tr">
                                ...
                                <td align="center" style="border:0px solid black;width: 20%;">
                                    <?= $this->Number->format($factureclient->totaltva + $factureclient->tpe) ?>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <table style="border:0px solid black;width: 100%;" >
                ...
                <tr>
                    ...
                    <td align="left"><b align="left" > Total Hors Taxes</td><td align="right"><b align="right"><?= ($factureclient->totalht) ?> </b>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>  <tr>
                    <td align="left"><b align="left" > Total Remise </td><td align="right"><b align="right"><?= ($factureclient->totalremise) ?> </b>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>  <tr>
                    <td align="left"><b align="left" > Total Fodec </td><td align="right"><b align="right"><?= ($factureclient->totalfodec) ?> </b>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>  <tr>
                    <td align="left"><b align="left" > Total TVA </td><td align="right"><b align="right"><?= ($factureclient->totaltva) ?> </b>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>  <tr>
                    <td align="left"><b align="left" > Total TPE </td><td align="right"><b align="right"><?= ($factureclient->tpe) ?> </b>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>  
    
<!--                    <b align="left"  style="margin-right:3% ;"> Total Remise&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </b>&nbsp;&nbsp;&nbsp;<?= $this->Number->format($bonlivraison->totalremise) ?> <br>-->
<!--                    <b align="left"  style="margin-right:3% ;"> Total Fodec&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?= $this->Number->format($bonlivraison->totalfodec) ?> <br>
                    <b align="left" style="margin-right:3% ;"> Total TVA&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b>&nbsp;&nbsp;&nbsp;&nbsp;<?= $this->Number->format($bonlivraison->totaltva) ?> <br>
                    <b align="left" style="margin-right:3% ;"> Total TPE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?= $this->Number->format($bonlivraison->tpe) ?> <br>
                   -->
    ...
    <div style="display:flex">
        ...
        <br>   <br>
        <div style="width: 53%;">
             <strong>ARRETE LE PRESENT FACTURE A LA SOMME DE:</strong><br>
...
<!--                <b style="margin-left:10% ;">-->
                    <strong> <?= ($factureclient->totalttc) ?></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
             </table></div>
    </div>
