...
<section class="content-header">
    <header>
        <h1 style="text-align:center;">Solde Clients Divers</h1>
    </header>
</section>
<br>
<section class="content-header">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="col-lg-9 col-lg-offset-3">
                        <button type="submit" class="btn btn-primary" style="background-color: #72a0c1 ; border: #72a0c1 ;">Afficher</button>
                        <?php if ($this->request->getQuery()) : ?>
                            <a onclick="openWindow(1000, 1000, wr+'Factureclients/impetatdivers?date1=<?= $date1 ?>&date2=<?= $date2 ?>')">
                                <button class="btn btn-primary" style="background-color: #72a0c1 ; border: #72a0c1 ;">Imprimer</button>
                            </a>
                        <?php else : ?>
                            <a onclick="openWindow(1000, 1000, wr+'Factureclients/impetatdivers')">
                                <button class="btn btn-primary" style="background-color: #72a0c1 ; border: #72a0c1 ;">Imprimer</button>
                            </a>
                        <?php endif; ?>
                        <?= $this->Html->link(__('Actualiser'), ['action' => 'etatsoldedivers'], ['class' => 'btn btn-primary', 'style' => 'background-color: #72a0c1 ; border: #72a0c1 ;']) ?>
                    </div>
                </div>
                <?= $this->Form->end(); ?>
            </div>
...
<h3 style="margin-left: 5px;">Les Clients Divers</h3>
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                    ...
                    <table id="example1" class="table table-bordered table-striped table-bottomless">
                        <thead>
                            <tr style="font-size: 20px;">
                                <th width="7%" align="center" style="text-align: center; background-color: #72a0c1 ;">
