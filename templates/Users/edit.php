      ...
      <div class="box ">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-xs-6">
              <input type="checkbox" id="validationfactureachat" name="validationfactureachat" value="0" <?php if ($user->validationfactureachat == 1) {
                                                                                                            $style = 'true'; ?> checked <?php } ?>>
          ...
          <div id="caisseDiv" style="display:<?php echo $style2; ?>" class="col-xs-6 pull-right">
            <?php
            echo $this->Form->control('caisse_id', [
              'multiple' => true,
              'name' => 'caisse_id[]',
              'class' => 'form-control select2 ',
              'default' => $selectedCaisseIds
            ]); ?>
          </div> -->
          </div>
