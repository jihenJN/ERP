 ...
 * @var string[]|\Cake\Collection\CollectionInterface $comptes
 */
?>
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $carnetcheque->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $carnetcheque->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="carnetcheques form content">
            ...
            <fieldset>
                <legend><?= __('Edit Carnetcheque') ?></legend>
                <?php
