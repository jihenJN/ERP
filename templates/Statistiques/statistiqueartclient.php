    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div style="text-align:center">
                ...
                <a href="<?php echo $this->Url->build(['action' => 'statistiqueartclient']); ?>" class="btn btn-primary"> Afficher tous</a>
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            <thead style='background-color: #3cb371  ;color: white;'>
                                                <tr>
                                                    ...
                                                    <th width="19%">CA HT</th>

                                                    <th width="19%">CA TTC</th>
                                            ...
                                            <td align="center"></td>
                                                ...
                                                <td  align="center" style='background-color: #3c8dbc; color: white;'><strong>Total Qte</strong></td>
                                                <td  align="center" style='background-color: #3c8dbc; color: white;'><strong>Total TTC</strong></td>
                                                <td  align="center" style='background-color: #3c8dbc; color: white;'><strong>Total HT</strong></td>

                                            </tr>
                                            <tr style="font-size: 14px;">
                                            <td align="center"></td>

                                                <td align="right"><strong><?php echo $totalqte; ?></strong></td>

                                                <td align="right"><strong><?php echo $totalht; ?></strong></td>
                                                <td align="right"><strong><?php echo $totalttc; ?></strong></td>
...
<section class="content">
    ...
    //     # code...
    //    }
    //     array("label" => "Vente ", "y" => $totalttc),
    //     array("label" => " Cout", "y" => $cout),
    //     array("label" => "Bénéfice ", "y" => $benefice),
