    ...
    <div class="box">
        ...
        <div class="box-body">
                        ...
                        <div class="col-xs-6">
                            <div class="form-group input select required">
                                ...
                                <select name="client_id" id="client_id" class="form-control select2 control-label "
                                    value='<?php $this->request->getQuery('client_id') ?>'>
                                    <option value="" selected="selected">Veuillez choisir !!</option>

                                    <?php foreach ($clients as $id => $cl) {
                                        ?>
                                        <option value="<?php echo $cl->id; ?>" <?php if ($client_id == $cl->id) { ?> selected
                                            <?php } ?>>
            ...
            <div style="text-align:center">
                ...
                <a href="<?php echo $this->Url->build(['action' => 'statistiqueartclient']); ?>"
