    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="row">
                ...
                <div class="row">
                    <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                        ...
                        <div class="col-xs-6">
                            <?php echo $this->Form->control('zone_id', ['required' => 'off', 'value' => $this->request->getQuery('zone_id'), 'options' => $zones, 'name' => 'zone_id', 'label' => 'Zone', 'class' => 'form-control select2', 'empty' => 'Veuillez choisir !!']); ?>
                        </div>
                    </div>
                </div>
            </div>
            <div style="text-align:center">
                ...
                <a href="<?php echo $this->Url->build(['action' => 'statistiquezone']); ?>" class="btn btn-primary">
                    Afficher tous</a>
                <a onclick="openWindow(1000, 1000, 'https://codifaerp.isofterp.com/demo/Statistiques/imprimestatistiquezone?datedebut=<?php echo @$datedebut; ?>&datefin=<?php echo @$datefin; ?>&zone_id=<?php echo @$this->request->getQuery('zone_id'); ?>&article_id=<?php echo @$this->request->getQuery('article_id'); ?>')"
        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Statistique Par Zone</h3>
...
<section class="content">
    ...
    // foreach ($zoness as $key => $gov) {
    
    //     $zonedelegations = $connection->execute('SELECT id FROM zonedelegations WHERE zone_id='.$gov['id'].';')->fetchAll('assoc');
//     $det23="";
//     if ($zonedelegations) {
//         //debug($clients);
//         $zonn2 = '';
//         foreach ($zonedelegations as $zo) {
//             if ($zo['id'] != null) {
//                 $zonn2 = $zonn2 . ',' . $zo['id'];
//             }
//         }
//         $det23 = substr($zonn2, 1);
//     }
//     $ligzone="";
//     if ($det23!="") {
//         $Lignezonedelegations = $connection->execute('SELECT delegation_id FROM lignezonedelegations WHERE zonedelegation_id in ('.$det23.');')->fetchAll('assoc');
    
    //         if ($Lignezonedelegations) {
//             //debug($clients);
//             $zonnn2 = '';
//             foreach ($Lignezonedelegations as $zon) {
//                 if ($zon['delegation_id'] != null) {
//                     $zonnn2 = $zonnn2 . ',' . $zon['delegation_id'];
//                 }
//             }
//             $ligzone = substr($zonnn2, 1);
//         }
//     }
//     $det2="";
//    if ($ligzone!="") {
//     $clients = $connection->execute('SELECT id FROM clients WHERE delegation_id in ('.$ligzone.');')->fetchAll('assoc');
//     //debug($clients);
//     if ($clients) {
//         //debug($clients);
//         $detcl2 = '';
