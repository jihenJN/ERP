    ...
    <div class="box">
        ...
        <div class="box-body">
                    ...
                    <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                        ...
                        <div class="col-xs-6">
                            <div class="form-group input select required">
                                ...
                                <label class="control-label" for="">Commercials</label>

                                <select name="commercial_id" id="client_id" class="form-control select2 control-label "
                                    value='<?php $this->request->getQuery('commercial_id') ?>'>
                                    <option value="" selected="selected">Veuillez choisir !!</option>

                                    <?php foreach ($clients as $id => $cl) {
                                        ?>
                                        <option value="<?php echo $cl->id; ?>" <?php if ($commercial_id == $cl->id) { ?>
                                                selected <?php } ?>>
                                            <?php echo $cl->name ?>
                                        </option>
                                    <?php } ?>
            ...
            <div style="text-align:center">
                ...
                <a href="<?php echo $this->Url->build(['action' => 'statistiquecommercial']); ?>"
                    class="btn btn-primary"> Afficher tous</a>
                <a onclick="openWindow(1000, 1000, 'https://codifaerp.isofterp.com/demo/Statistiques/imprimestatistiquecommercial?datedebut=<?php echo @$datedebut; ?>&datefin=<?php echo @$datefin; ?>&commercial_id=<?php echo @$this->request->getQuery('commercial_id'); ?>&article_id=<?php echo @$this->request->getQuery('article_id'); ?>')"
        ...
        <div class="col-md-12">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Statistique Par Commercial</h3>
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <div class="box box-success">
                ...
                <div class="box-body" style="overflow: auto;">
                    <div id="chartContainerr" class="inverted-labels" style="height: 370px; overflow: auto;"></div>
    ...
    foreach ($tabs as $key => $gov) {
        ...
        foreach ($gov['client'] as $j => $cl) {
            $dataPoints[] = array("label" => $cl['name'], "y" => $cl['qte']);
            $dataPoints2[] = array("label" => $cl['name'], "y" => $cl['ttc']);
        }
    }
    ?>
    <!-- /.row -->
...
<script>
    window.onload = function () {
        ...
        chart1.render();
        var chart2 = new CanvasJS.Chart("chartContainerr", {
            animationEnabled: true,
            theme: "light2", // "light1", "light2", "dark1", "dark2"
            title: {
                text: ""
