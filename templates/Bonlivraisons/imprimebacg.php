...
$filteredLines = array_filter($lignebonlivraisonsArray, function ($line) {
    return $line['qte'] != 0;
});
    ...
    <div class="print-container">
        ...
        <section class="content" style="font-family: 'Times New Roman', Times, serif;<?php echo $page > 0 ? ' page-break' : ''; ?>">
                        ...
                        <tr>
                            ...
                            <td class="client-info" style="width: 35%; border: none; font-size: 15px; height: 70px; vertical-align: top;">
                                ...
                                <b style="font-size: 16px; font-weight: normal; display: block; margin-bottom: 0.5em;">
                                    &nbsp;<?php if (isset($bonlivraison->client)) {
                                                if ($bonlivraison->client_id != 12) {
                                ...
                                <b style="font-size: 16px; font-weight: normal; display: block; margin-bottom: 0.5em;">
                                    ...
                                    <?php //echo 'M.F : ' . (isset($bonlivraison->client) ? h($bonlivraison->client->Matricule_Fiscale) : ''); 
                                    ?> </b>
                            </td>
            ...
            <div style="margin-top: -17.6%;">
                <table border="0" style="border-width: 1px;  width: 100%; border-collapse: collapse; margin-top:29%;">
                    <thead>
                        ...
                        ?>
                            <tr class="fixed-height-row">
                                <td style="text-align:left;width:40%;">
                                    <?php if (!empty($bonlivraison->observation)) : ?>
                                        <b><?php echo $bonlivraison->observation; ?></b>
                                    <?php else : ?>
                                        <b>&nbsp;</b>
                                    <?php endif; ?>
                                </td>
                        ...
                        ?>
                            ...
                            <!-- <tr>
                                <td colspan="6" style="text-align:left;">
                                    <b><?php //echo $bonlivraison->observation; 
                                        ?></b>
                                </td>
                            </tr> -->
                        <?php   }  ?>
            ...
            ?>
                <div style="display:flex; margin-left:8%;">
                    ...
                    <table style="width: 60%;border-collapse: collapse;border-radius: 15px;margin-top:3.4%;">
                        <thead>
                        </thead>
                        <tbody>
                    ...
                    <table style="width: 55%; border-collapse: collapse; border-radius: 15px; margin-top: 0.2%; margin-left: 40%!important;">
                        <thead>
                        </thead>
                        <tbody>
                            <tr>
                                <td style="text-align: left; width: 50%; vertical-align: top;">
                                    ...
                                    <b style=" width: 100px;margin-left:-10!important; line-height: 1.2;">
                                        <?php if ($bonlivraison->totalremise != 0) { ?>
                                    ...
                                    <b style="width: 100px;margin-left:-10!important; line-height: 1.54;"><?php echo 'Timbre:';
                                                                                                            ?><br></b>
                                    <!-- <b><br></b> -->
                                </td>
                                <td style="text-align: left; width: 50%; vertical-align: top;">
                                    ...
                                    <b style="display: inline-block; width: 130px; text-align: right; line-height: 1.2;">
                                        <?php if ($bonlivraison->totalremise != 0) { ?>
                                            <?php echo number_format(abs($bonlivraison->totalremise), 2, ',', ' '); ?><?php } ?><br>
                                    </b>
                                    ...
                                    <b style="font-size: 16px!important; margin-top: -8.6px!important; font-weight: bold; display: inline-block; width: 130px; text-align: right;">
                ...
                <table style="width: 65%;border-collapse: collapse;border-radius: 15px;margin-top:-5.5%;margin-left:-3%;">
                    <thead>
                    </thead>
                    <tbody>
                        <?php
