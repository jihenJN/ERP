    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr style="font-size: 18px;font-weight: bold;">
                                                        ...
                                                        <td align="center">
                                                            <?php echo $this->Form->input('puttc', array('label' => '', 'value' => $res->puttc, 'name' => 'data[ligner][' . $i . '][puttc]', 'type' => '', 'id' => 'puttc' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control  ttcligne calculligne2', 'index')); ?>
                                                        </td>
                                                        <td align="center">
                ...
                <div align="center">
                    <button type="submit" class="pull-right btn btn-success btn-sm testbl Testqtestock chauff testdepqte numerobl" id="boutonlivraison" style="margin-right:48%;margin-top: 20px;margin-bottom:20px;">Enregistrer</button>
