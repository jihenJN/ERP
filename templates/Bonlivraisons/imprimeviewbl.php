...
<?php $page = 0;   //debug($totalPages);die; 
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: left; width: 50%; vertical-align: top;">
                                    ...
                                    <b style=" width: 100px;margin-left:-10!important; line-height: 1.5;"> <?php if ($bonlivraison->totalremise != 0) { ?><?php echo 'Rem Mt:'; ?> <?php } ?><br></b>
                                ...
                                <td style="text-align: left; width: 50%; vertical-align: top;">
                                    ...
                                    <b style="display: inline-block; width: 130px; text-align: right; line-height: 1.5;">
                                        <?php if ($bonlivraison->totalremise != 0) { ?> <?php echo number_format(abs($bonlivraison->totalremise), 2, ',', ' '); ?> <?php } ?><br>
                                    </b>
                    ...
                    <tbody>
                        ...
                        <tr class="tr">
                            <td align="center" height="20px" width="40px">
                                <b style="color:#A8A8A8 ;margin-left:13% ;margin-top:-6%!important; font-size: 17px;!important "><?php echo  'ARRETE LA PRESENTE BL A LA SOMME DE :';
                                                                                                                                    ?></b>
                            </td>
                        </tr>
                        <tr class="tr">
