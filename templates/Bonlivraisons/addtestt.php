                                ...
                                <div class="box">
                                    ...
                                    <div class="panel-body">
                                        <div class="table-responsive ls-table">
                                            <table class="table table-bordered table-striped table-bottomless" id="tabligne">
                                                <thead>
                                                    <tr style="font-size: 20px;">
                                                        <td align="center" style="width: 23%;"><strong>Article</strong> </td>
                                                        <td align="center" style="width: 23%;"><strong>Articletest</strong> </td>
                                            ...
                                            <td champ="tdcode"><input class="getdesignation articleidbl1" champ="article_idcode"  type="text" >

<datalist champ="codearticle_id" >
<?php foreach ($articles as $id => $article) {?>
  ...
  <?php } ?>
    ...
    <td champ="tddes"><input class="getcode articleidbl1des" champ="article_iddes"  type="text" >

<datalist champ="desarticle_id">
<?php foreach ($articles as $id => $article) {?>
  ...
  <?php } ?>
                                                        ...
                                                        <td align="center" hidden>
                                                            ...
                                                            <select table="ligner" index champ="articledes" style="width: 100% !important;" class="form-control  js-example-responsive select articlecode2  articleidbl11">
