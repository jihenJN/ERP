            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="row">
                            ...
                            <div class="col-xs-7" id="blocclient" style="display: true;">
                                ...
                                <div class="col-xs-12">
                                    <div class="col-xs-3" hidden>
                                        ...
                                        <?php
                                        echo $this->Form->input('plafond', array('readonly' => 'readonly', 'value' => $commfirst->client->plafontheorique,   'style' => 'background-color:#FFEFD4; color:#000000 ;', 'label' => 'plafond', 'id' => 'plafond', 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control'));
                                        ?>
                                    </div>
                                    <div class="col-xs-3">
                        ...
                        <?php
                        if ($commfirst->client_id == 12) {
                            $stylee = "display:block;";
                        } else {
                            $stylee = "display:none;";
                        }
                        //if (/*$bonlivraison->typebl == 1 &&*/$commfirst->client_id == 12) {

                        ?>
                        <div class="col-xs-4" id="divnomprenom" style="<?php echo $stylee; ?>">
                            <?php echo $this->Form->control('nomprenom', ['label' => 'Nom / Prénom', 'readonly' => 'readonly', 'value' => $commfirst->nomprenom, 'required' => 'off', 'class' => 'form-control focus']); ?>

                        </div>
                        <div class="col-xs-4" id="divnumeroident" style="<?php echo $stylee; ?>">
                            <?php echo $this->Form->control('numeroidentite', ['label' => 'Numéro identité', 'readonly' => 'readonly', 'value' => $commfirst->numeroidentite, 'required' => 'off', 'class' => 'form-control focus']); ?>

                        </div>
                        <div class="col-xs-4" id="divadresseclt" style="<?php echo $stylee; ?>">
                            <?php echo $this->Form->control('adressediv', ['label' => 'Adresse', 'required' => 'off', 'readonly' => 'readonly', 'value' => $commfirst->adressediv, 'class' => 'form-control focus']); ?>
                        </div>
                        <?php //} 
                        ?>
                                        ...
                                        <table class="table table-bordered table-striped table-bottomless" id="tabligne">
                                            ...
                                            <thead>
                                                <tr style="font-size: 20px;">
                                                    ...
                                                    <td align="center" style="width: 6%;"><strong>Qté Liv</strong></td>
                                                    <td align="center" style="width: 6%;"><strong>Qté R</strong></td>
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $i = -1;
                                                foreach ($lignecommandes as  $res) :
                                                    //debug($res);
                                                    $articleid =  $res->article_id;
                                                    $depotid = $commfirst->depot_id;
                                                    ...
                                                    $lignebls = $connection->execute('SELECT SUM(qte) AS qtelivre FROM lignebonlivraisons WHERE lignecommande_id = :lignecommande_id', ['lignecommande_id' => $res->id])
                                                        ->fetch('assoc');
                                                    $qteliv = 0;
                                                ...
                                                ?>
                                                        <tr style="font-size: 18px;font-weight: bold;">
                                                            ...
                                                            <td align="center">
                                                                <?php echo $this->Form->input('qteStock', array('label' => '', 'value' => $stockk, 'readonly' => 'readonly', 'name' => 'data[ligner][' . $i . '][qteStock]', 'type' => 'text', 'id' => 'qteStock' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control calculligne22 ', 'index')); ?>
                                                            </td>
                                                            <td align="center">

                                                                <?php echo $this->Form->input('qtetot', array('label' => '', 'value' => $res->qte, 'name' => 'data[ligner][' . $i . '][qtetot]', 'type' => 'number', 'id' => 'qtetot' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control  ', 'index', 'readonly')); ?>

                                                                <input type="hidden" table="ligner" name="" id="<?php echo 'pourcentageescompte' . $i ?>" champ="pourcentageescompte" class="calculligne22commande form-control" index="<?php echo $i ?>">
                                                            </td>
                                                            <td align="center">
                                                            ...
                                                            <td align="center">
                                                                <?php echo $this->Form->input('remise', array('readonly' => $readonly, 'label' => '', 'value' => $res->remise, 'name' => 'data[ligner][' . $i . '][remise]', 'type' => 'text', 'id' => 'remise' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control calculligne2', 'index')); ?>
                                                            ...
                                                            <td align="center">
                                                                <?php echo $this->Form->input('prix', array('label' => '', 'readonly' => 'readonly', 'readonly', 'value' => $res->prix, 'name' => 'data[ligner][' . $i . '][prix]', 'type' => 'text', 'id' => 'prix' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control  findtth2 ', 'index')); ?>
                                                            </td>
                                                            <td align="center">
                                                            ...
                                                            <td align="center">
                                                                <?php echo $this->Form->input('ttc', array('readonly', 'label' => '', 'value' => $res->totalttc, 'name' => 'data[ligner][' . $i . '][ttc]', 'type' => '', 'id' => 'ttc' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control verifttc calculinverse', 'index')); ?>
                                                            ...
                                                            <td align="center" hidden>
                                                                <?php echo $this->Form->input('ttctest', array('readonly', 'label' => '', 'value' => $res->totalttc, 'name' => 'data[ligner][' . $i . '][ttctest]', 'type' => '', 'id' => 'ttctest' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control verifttc calculinverse', 'index')); ?>
                                                ...
                                                <tr class="tr" style="display: none ">
                                                    ...
                                                    <td align="center" table="ligner">
                                                        <input table="ligner" type="text" champ="prix" class="form-control calculligne2" index name=''>
                                                    </td>
                                                    <td align="center" table="ligner">
                                                        <input readonly table="ligner" type="text" champ="ht" class="form-control" index name=''>
                                                    </td>
                                                    <td align="center" table="ligner">
                                                        <input table="ligner" type="text" champ="remise" class="form-control calculligne2" index name=''>
                ...
                <section class="content" style="width: 99%">
                    <div class="row" id="sec">
                            ...
                            <div style=" position: static;">
                                <table style="width:55%;margin-left:70%;">
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col-xs-4">
                                                <?php echo $this->Form->control('total', ['id' => 'totalht', 'value' => sprintf("%01.3f", str_replace(",", ".", $commfirst->total)),  'class' => 'form-control', 'readonly' => 'readonly', 'label' => false, 'name', 'required' => 'off']); ?>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col-xs-4">
                                                <?php echo $this->Form->control('tva', ['id' => 'totaltva', 'value' => sprintf("%01.3f", str_replace(",", ".", $commfirst->tva)), 'class' => 'form-control', 'readonly' => 'readonly', 'label' => false, 'name', 'required' => 'off']); ?>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col-xs-4">
                                                <?php echo $this->Form->control('totalttc', ['class' => 'form-control verifttctotal calculinversetot', 'value' => sprintf("%01.3f", str_replace(",", ".", $commfirst->totalttc)),  'id' => 'ttc', 'label' => false, 'name', 'required' => 'off']); ?>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <div class="col-xs-6">
                            <?php echo $this->Form->control('observation', ['value' => $commfirst->observation, 'label' => 'Commentaire', 'readonly' => 'readonly', 'class' => 'form-control',  'type' => 'textarea']); ?>
                        </div><br>
                    </div>
                </section>
