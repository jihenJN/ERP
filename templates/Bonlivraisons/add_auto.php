...
<td style="width:21%" id="" index="" champ="tddesg">
                                                <div class="" style="display:inline; position: relative;">
                                                    <?php echo $this->Form->input('code', array('div' => 'form-group', 'placeholder' => 'Code', 'label' => '', 'name' => '', 'table' => $tablesemi, 'index' => '', 'id' => '', 'champ' => 'code', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control haithamselectt  inputspcial', 'type' => 'text'));
                                                    ?><div id="ress" champ="ress" index=""  class="haithamcss1" onMouseMove="this.style.visibility = 'visible';" ></div>
                                                </div>
                                            </td>                                                       
													   <td align="center">
...
<?php echo $this->Form->input('designation', array('div' => 'form-group', 'placeholder' => 'Designation', 'label' => '', 'name' => '', 'table' => $tablesemi, 'index' => '', 'id' => '', 'champ' => 'designation', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control haithamselect  inputspcial', 'type' => 'text'));
  echo $this->Form->input('article_idd', array('div' => 'form-group', 'label' => '', 'name' => '', 'table' => $tablesemi, 'index' => '', 'id' => '', 'champ' => 'article_idd', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control', 'type' => 'hidden'));
                                                        ...
                                                        <td align="center" table="ligner">
                                                            <input type="number" table="ligner" name="" id="qte" champ="qte" type="text" class="verifqte  focus calculligne form-control focus" index>
                                                        </td>
                                                        <td>
                                                            <input table="ligner" type="text" name="" champ="puttc" class="form-control    findtth  classttc verifttc calculinverse ttcligne" index>
                                                        ...
                                                        <td align="center" table="ligner">
                                                            <input table="ligner" type="text" readonly id="prix" champ="prix" class="form-control calculligne" index name=''>
                                                        </td>
                                                        <td align="center" table="ligner">
                                                            <input readonly table="ligner" readonly type="text" champ="ht" class="form-control" index name=''>
                                                        </td>
                                                        <td align="center" table="ligner">
                                                            <input table="ligner" type="text" id="remise" champ="remise" class="form-control ajoutligneeettc2 calculligne" index name=''>
    ...
    <script type="text/javascript">
		...
		function handleKeyPress(event, id, code, designation, index) {
            alert(event.key);
    if (event.key === 'Enter') { // Vous pouvez vérifier d'autres touches si nécessaire
        setQuery11(id, code, designation, index);
    }
}
        function setQuery11(id, code, des, index) {//alert(index);

    $('#article_idd' + index).val(id);
    $('#designation' + index).val(des);
	 $('#code' + index).val(code);
    //$("#res" + index).css("visibility", "hidden");
	  $("#ress" + index).css("visibility", "hidden");
	   $('#designation' + index).focus();
   // findfamille(index);
   // articleidbl(index);
    ...
    //ajouter_ligne_livraison1('addtable', 'index', 'tr');
		...
		function setQuery1(id, code, des, index) {//alert(index);
 ...
 $('#qte' + index).focus();
    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function() {
			...
			$('.haithamselectt').on('keyup', function () {
        ...
        if(val==''){
            ...
            if (val.length >1 ) {
               ...
               /* $.ajax({
                    type: "POST",
                    url: "../../Bonlivraisons/haithamselect/",
                    dataType: "JSON",
                    data: {
                        val: val
                    }
                    ...
                    $.each(data, function (i, item) {
                        $.each(item, function (i, dd) {
                         //    alert(setQuery1('" + dd.Article.id + "','" + dd.Article.code + "','" + escape(dd.Article.nom) + "','" + index + "'));
                            console.log(dd);
                            dd.Article.nom = dd.Article.nom.replace("'", "`")+' (PVD TTC: '+dd.Article.prixvente.replace("'", "`")+')';
                            result1 = result1 + "<a class='option' id='" + dd.Article.id + "' style='text-decoration:none;z-index: 1000' href=\"javascript:setQuery1('" + dd.Article.id + "','" + dd.Article.code + "','" + escape(dd.Article.nom) + "','" + index + "');\"><div class='aa'>" + dd.Article.nom + "</div></a>";
                        })
                    })
                    var obj = $("#res" + index);
                    obj.html(result1);
        ...
        method: "GET",
        type: "GET",
        url: "<?= $this->Url->build(['controller' => 'Bonlivraisons', 'action' => 'haithamselect']) ?>",
        dataType: "JSON",
        data: {
          val: val 
        },
        success: function(response) {alert('ggggg');
        //  $('#qtestock' + index).val(response.qtestock);
        }
      })*/
	       $.ajax({
                method: "GET",
                url: "<?= $this->Url->build(['controller' => 'Bonlivraisons', 'action' => 'haithamselectt']) ?>",
                dataType: "json",
                data: {
                   val: val ,
                },
		 ...
		 $.each(data.Prix, function (i, dd) {//alert(item)
                       { 
					 //  alert(dd)
                         //    alert(setQuery1('" + dd.Article.id + "','" + dd.Article.code + "','" + escape(dd.Article.nom) + "','" + index + "'));
                           // console.log(dd);
                        //   dd.Dsignation = dd.Dsignation.replace("'", "`");  'onkeypress' => "return event.keyCode != 13",
                          result1 = result1 + "<a class='option' id='" + dd.id + "' style='text-decoration:none;z-index: 1000' href=\"javascript:setQuery11('" + dd.id + "','" + dd.Code + "','" + escape(dd.Dsignation) + "','" + index + "');\"><div class=' item'>" + dd.Code + "</div></a>";
                       //   result1 = result1 + "<a class='option' id='" + dd.id + "' tabindex='0' style='text-decoration:none;z-index: 1000' onkeypress=\"handleKeyPress(event, '" + dd.id + "','" + dd.Code + "','" + escape(dd.Dsignation) + "','" + index + "');\"><div class='aa item'>" + dd.Code + "</div></a>";
    ...
    document.addEventListener('keydown', (event) => { //alert(event.key)
      if (event.key === 'a') {
        ...
        items.forEach((item, index) => { //alert(index+'-----'+currentIndex); 
    ...
    //updateFocus();
                      /*  const container = document.getElementById('ress' + index);
        ...
        // Set focus on container for key events to be captured
        container.focus();
        updateActiveItem(currentIndex);*/
        ...
        //  $('#qtestock' + index).val(response.qtestock);
		 ...
		 $.each(data.Prix, function (i, dd) {//alert(item)
                       { 
                         //    alert(setQuery1('" + dd.Article.id + "','" + dd.Article.code + "','" + escape(dd.Article.nom) + "','" + index + "'));
                            console.log(dd);
                        //   dd.Dsignation = dd.Dsignation.replace("'", "`");
                            result1 = result1 + "<a class='option' id='" + dd.id + "' style='text-decoration:none;z-index: 1000' href=\"javascript:setQuery1('" + dd.id + "','" + dd.Code + "','" + escape(dd.Dsignation) + "','" + index + "');\"><div class='aa'>" + dd.Dsignation + "</div></a>";
                        }
						//alert('t');
						//alert(result1);
						var obj = $("#res" + index);
