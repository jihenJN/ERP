...
<div style="display:flex;margin-bottom:3px;" align="center">
    <div style="display:flex;width: 1000%;">
        <div style="width: 10000%;border:0px solid black;border-radius: 15px" align="left">
            <br>
            <b style="margin-left:1% ;"> Code: </b><?= h($bonlivraison->client->Code) ?> <br>
            <b style="margin-left:1% ;"> Matricule fiscale :</b><?= h($bonlivraison->client->Matricule_Fiscale) ?> <br>
            <b style="margin-left:1% ;"> Client : </b> <?php
                                                        if (isset($bonlivraison->client)) {
                                                            echo  h($bonlivraison->client->Raison_Sociale);
                                                        } ?><br>
            <b style="margin-left:1% ;"> Adresse :</b><?= h($bonlivraison->client->Adresse) ?> <br>
        </div>
    </div>
        ...
        <div>
                        ...
                        <tbody>
                            <tr class="tr">
                                ...
                                <td align="center" style="border:0px solid black;width: 20%;">
                                    <?= $this->Number->format($bonlivraison->totaltva + $bonlivraison->tpe) ?>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <table style="border:0px solid black;width: 100%;" >
                ...
                <tr>
                    ...
                    <td align="left"><b align="left" > Total Hors Taxes</td><td align="right"><b align="right"><?= ($bonlivraison->totalht) ?> </b>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>  <tr>
                    <td align="left"><b align="left" > Total Remise </td><td align="right"><b align="right"><?= ($bonlivraison->totalremise) ?> </b>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>  <tr>
                    <td align="left"><b align="left" > Total Fodec </td><td align="right"><b align="right"><?= ($bonlivraison->totalfodec) ?> </b>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>  <tr>
                    <td align="left"><b align="left" > Total TVA </td><td align="right"><b align="right"><?= ($bonlivraison->totaltva) ?> </b>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>  <tr>
                    <td align="left"><b align="left" > Total TPE </td><td align="right"><b align="right"><?= ($bonlivraison->tpe) ?> </b>&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>  
...
<!--                    <b align="left"  style="margin-right:3% ;"> Total Fodec&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?= $this->Number->format($bonlivraison->totalfodec) ?> <br>
    ...
    <div style="display:flex">
        ...
        <br>   <br>
        <div style="width: 53%;">
             <strong>ARRETE LE PRESENT BON DE LIVRAISON A LA SOMME DE:</strong><br>
...
<!--                <b style="margin-left:10% ;">-->
                    <strong> <?= ($bonlivraison->totalttc) ?></strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></tr>
             </table></div>
    </div>
