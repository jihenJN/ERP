                        ...
                        <div class="row">
                            <div class="row">
                                <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                    ...
                                    <div class="col-xs-6">
                                        <?php echo $this->Form->control('date', ['disabled' => true, "value" => $bonlivraison->date]); ?>
                                    </div>
                            ...
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                <div class="row">
                                    <div class="col-xs-6">
                                        ...
                                        <?php echo $this->Form->control('commercial', ['disabled' => true, 'type' => 'hidden', 'name' => 'commercial_id', 'value' => $bonlivraison->commercial_id, 'label' => '', 'class' => 'form-control ontrol-label']); ?>
                                    ...
                                    <div class="col-xs-6">
                                        <div class="form-group input text required" id="com_id">
                                            <?php echo $this->Form->control('commercial_id', ['disabled' => true, 'value' => $bonlivraison->commercial_id, 'options' => $commercials, 'empty' => 'Veuillez choisir !!', 'required' => 'off', 'label' => 'Commercial', 'class' => 'form-control select2 control-label', 'name' => 'adresse']); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        <?php echo $this->Form->control('observation', ['disabled' => true, 'label' => 'Commentaire', 'class' => 'form-control', 'value' => $bonlivraison->observation, 'type' => 'textarea']); ?>
                                    </div>
                                                      ...
                                                      foreach ($lignebonlivraisons as $i => $res) :
                                                          ...
                                                          if ($res->N != 'N°') { ?>
                                                              <tr>
                                                                  ...
                                                                  <td align="center">
                                                                      <?php echo $this->Form->input('qte', array('readonly' => 'readonly', 'label' => '', 'value' => $res->qte, 'name' => 'data[ligner][' . $i . '][qte]', 'type' => 'text', 'id' => 'qte' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control pourcentescompte ', 'index')); ?>
                                                                  ...
                                                                  <td align="center">
                                                                      <?php echo $this->Form->input('ml', array('readonly' => 'readonly', 'label' => '', 'value' => $thisarticle[0]['ml'], 'name' => 'data[ligner][' . $i . '][ml]', 'type' => 'text', 'id' => 'ml' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control pourcentescompte ', 'index')); ?>
                                                                  </td>
                                                                  <td align="center">
                                                                      <?php echo $this->Form->input('prix', array('readonly' => 'readonly','label' => '', 'value' => $thisarticle[0]['Prix_LastInput'], 'name' => 'data[ligner][' . $i . '][prix]', 'type' => 'text', 'id' => 'prix' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control calculm calculligne', 'index')); ?>
                                                                  </td>
                                                                  <td align="center">
                                                                  ...
                                                                  <td align="center">
                                                                      ...
                                                                      <?php echo $this->Form->input('tva', array('readonly' => 'readonly', 'value' => $ttva, 'label' => '', 'name' => 'data[ligner][' . $i . '][tva]', 'type' => 'text', 'id' => 'tva' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control ', 'index')); ?>
                                                                  </td>
                                                                  <td align="center">
                                                                      ...
                                                                      <?php echo $this->Form->input('fodec', array('readonly' => 'readonly', 'label' => '', 'value' => $fod, 'name' => 'data[ligner][' . $i . '][fodec]', 'type' => '', 'id' => 'fodec' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control ', 'index')); ?>
                            ...
                            <div class="row" id="sec">
                                <div class="row">
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <div class="col-xs-4">
                                            <?php echo $this->Form->control('ttc', ['id' => 'ttc', 'readonly' => 'readonly', 'label' => 'Total ttc', 'name', 'required' => 'off']); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    $(document).ready(function() {
        Calcul();
        $('.calculligne').on('keyup', function() {
            index = $(this).attr('index');


            qte = Number($('#qte' + index).val());
            prix = Number($('#prix' + index).val());
            ml = Number($('#ml' + index).val());
            ...
            ttc = ((qte * prix*ml) + (qte * prix*ml * (ttva / 100)) - (qte * prix*ml * (remise / 100)) + (qte * prix *ml * (fod / 100))).toFixed(3);
            // alert( $('#ttc' + index).val());
