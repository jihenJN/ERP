...
<section class="content-header">
    <h1>
        Modification bon de livraison marchandise
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                <td align="center">
                                                                    <?php echo $this->Form->input('quantiteliv', array( 'label' => '', 'value' => $res->quantiteliv, 'name' => 'data[ligner][' . $i . '][quantiteliv]', 'type' => 'number', 'id' => 'qteliv' . $i, 'table' => 'ligner', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control verifqtelivre calculBonrec', 'index')); ?>
                                                                </td>
