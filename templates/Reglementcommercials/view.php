                    ...
                    <div class="row">
                        ...
                        <div class="row">
                         ...
                         <?php echo $this->Form->control('numero', ['id' => 'numero', 'readonly','class' => ' form-control ']); ?>
                               ...
                               <div class="col-xs-6">
                                    <?php echo $this->Form->control('date', ['id' => 'date','name'=>'date','readonly',
                        ...
                        <div class="row">
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                <div class="col-xs-6">
                                                                    <?php echo $this->Form->control('commercial_id', ['id' => 'commercial', 'disabled'=>'true','empty' => 'Veuillez choisir !!', 'class' => 'select2 form-control commercial']); ?>
                            ...
                            <tr>
                                ...
                                <td style="width:99%;" align="left">
                                    <input
                                     ...
                                     disabled  table ="reglement" name ="data[reglement][<?php echo $i; ?>][montantentre]" id="montantentre<?php echo $i;?>"  type ="text" value ="<?php echo $dat['montantentre'] ;?>"       index = "<?php echo $i ;?>"  >
                        ...
                        <table >
                                ...
                                <td style="width:99%;" align="left">
                                    <input
                                            ...
                                            class ="form-control calculereglementkeyup calculereglementclient testmontantreglementclientl  number"
                                    disabled   table ="bonusreglement" name ="data[bonusreglement][<?php echo $j;?>][montantentrebonus]" id="montantentrebonus<?php echo $j;?>"  type ="text" value ="<?php echo $data['montantentrebonus'] ;?>"       index ="<?php echo $j ;?>"  >
...
<?php endforeach; ?>
    ...
    <input type="hidden" id="index" value="<?php ?>" />
                       ...
                       <table class="col-xs-12" >
                           <tr>
                <td class="col-xs-4">
                    <?php echo $this->Form->control('paiement_id', ['disabled'=>'true','label' => 'Mode paiement', 'name' => 'paiement_id', 'id' => 'paiement_id', 'empty' => 'Veuillez choisir !!', 'class' => 'select2 jour form-control ']); ?>
             ...
             <tr  >  
                                        ...
                                        <td colspan="8" style="vertical-align: top;">
                                            ...
                                            <?php
                                            echo $this->Form->input('numero_cheque', array('readonly','name' => 'numero_cheque', 'label' => 'Numero chéque', 'id' => 'numero_cheque', 'div' => 'form-group',  'after' => '</div>', 'class' => 'form-control ', 'type' => 'number'));
                                            ?>
                              ...
                              <tr class="col-xs-6">
                                            <?php
                                            echo $this->Form->input('banque_id', array('readonly','options'=>$banque,'name' => 'banque_id',  'empty' => 'Veuillez choisir !!','label' => 'Banque', 'id' => 'banque', 'div' => 'form-group',   'class' => 'form-control select2'));
                                            ?>
                             </tr>
                              
                             <tr class="col-xs-6">
                                            <?php
                                            echo $this->Form->input('date_echeance', array('readonly','name' => 'date_echeance', 'label' => 'Date echeance', 'id' => 'date_echeance', 'div' => 'form-group', 'class' => 'form-control ', 'type' =>'date'));
                                            ?>
                                        </tr>
