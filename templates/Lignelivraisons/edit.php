 ...
 * @var \App\Model\Entity\Lignelivraison $lignelivraison
 */
?>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <?php echo $this->Form->create($lignelivraison, ['role' => 'form']); ?>
            <div class="box-body">
              <?php
                echo $this->Form->control('Livraison_id', ['options' => $livraisons, 'empty' => true]);
