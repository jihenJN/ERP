...
<section class="content-header">
    ...
    <div class="choisir" align="center" style="margin-top: 3%;">
        ...
        <button type="button" style="width: 160px;" data-toggle="tab" class="btn btn-primary btn-sm active "
            onclick="afficherDiv('articles')">Données Article</button>


        <button type="button" style="width: 160px;" data-toggle="tab" class="btn btn-primary btn-sm"
            onclick="afficherDiv('prixclient')">Prix Clients</button>
        <button type="button" style="width: 160px; " data-toggle="tab" class="btn btn-primary btn-sm"
            onclick="afficherDiv('objectifs')">Objectifs</button>

        <button type="button" style="width: 160px;" data-toggle="tab" class="deduction btn btn-primary btn-sm"
            onclick="afficherDiv('unitcont')">Unite/Contenance</button>

        <button type="button" style="width: 160px;" data-toggle="tab" class="btn btn-primary btn-sm"
            onclick="afficherDiv('artetape')">Article Etape</button>


        <button type="button" style="width: 160px;" data-toggle="tab" class="btn btn-primary btn-sm"
            onclick="afficherDiv('fichart')">Fiche Article</button>
        <button type="button" style="width: 160px; " data-toggle="tab" class="btn btn-primary btn-sm"
            onclick="afficherDiv('prixFournisseur')">Prix
            Fournisseur</button>
            <button type="button" style="width: 160px; " data-toggle="tab" class="btn btn-primary btn-sm"
            onclick="afficherDiv('COUTarticle')">Cout
            Article</button>
            ...
            <div class="box ">
                ...
                <div class="box-body">
                        ...
                        <div class="tab-content active" id="articles">
                                ...
                                <div
                                    ...
                                    <div class="col-xs-3" id="codeabr">
                                        ...
                                        <div class="input-group">
                                            <span name="codepaysproducteur" class="input-group-addon" style="width:10%">
                                                <?php echo $val ?>
                                            </span>
                                            <input name="codearticle" readonly type="text" id="codearticle"
                                ...
                                <div
                                    ...
                                    <div id="nombrepiece">
                                        ...
                                        <div class="col-xs-6">
                                            ...
                                            <input placeholder="0.000" step="0.001" type="number" class="form-control"
                                                name='poidsbrut' id="poidsbrut">
                                        </div>
                                ...
                                <div
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        <label class="control-label" for="stockable"
                                            style="margin-right: 20px">Stockable
                                            :</label>

                                        OUI <input type="radio" name="stockable" value="0" id="OUI" checked class=""
                            ...
                            <div class="row">
                                <div
                                    ...
                                    <div class="col-xs-6" style="display:true;" id="dprod">
                                        <?php echo $this->Form->control('depotprod_id', ['empty' => 'Veuillez choisir !!', 'options' => $depots, 'class' => 'form-control select2 control-label', 'label' => "Dépôt production:"]); ?>
                                    ...
                                    <div style="margin-top:20px" class="col-xs-8">
                                        <label class="control-label" for="unipxte-id" style="margin-right: 20px">
                                            Destine a
                                            la vente :</label>
                                ...
                                <div style="display:flex;">
                                        ...
                                        <div style="display:flex;">
                                            ...
                                            <div
                                                style="width:100%;    margin-right: 20px; position: static; ">
                                                <div align="center">
                                            ...
                                            <tr class="tr" style="display: none !important">
                                                ...
                                                <td align="left" width="45%">
                                                    <div style="margin-top:1%">
                                                        <input type="hidden" name="" id="" champ="sup1"
                                                            table="clientarticles" index="" class="form-control">
                                                        <select table="clientarticles" index champ="client_id"
                                                ...
                                                <td align="left" width="45%">
                                                    <input style="margin-top: 3% ;" table="clientarticles" type="text"
                                                        class="form-control " index="" name="" id="" champ="prix"
                                                        value="">
                                                </td>
                                    ...
                                    <table class="table table-bordered table-striped table-bottomless" id="tabligne3">
                                        ...
                                        <tbody>
                                            <tr class="tr" style="display: none !important">
                                                ...
                                                <td align="left" width="45%">
                                                    <div style="margin-top:1%">
                                                        <input type="hidden" name="" id="" champ="sup0"
                                                            table="uaprincipals" index="" class="form-control">
                                                ...
                                                <td align="left" width="45%">
                                                    <input style="margin-top: 3% ;" table="uaprincipals" type="text"
                                                        class="form-control " index="" name="" id="" champ="Correspand"
                                                        value="">
                                                </td>
                                                <td align="center" width="10%">
                                    ...
                                    <table class="table table-bordered table-striped table-bottomless" id="tabligne">
                                        ...
                                        <tbody>
                                            <tr class="tr" style="display: none !important">
                                                ...
                                                <td align="center" width="45%">
                                                    <input style="margin-top: 3% ;" table="etapes" type="text"
                                                        class="form-control verif" index="" name="" id="" champ="rang"
                                                        value="">
                                                </td>
                                                <td align="center" width="10%">
                                                    <i index="" id="" class="fa fa-times supLigne"
                    ...
                    <div class=" tab-content" id="objectifs" style="display: none">
                        <!-- /.box-header -->
                        <div align="center" class="row " style="display:true;" id="showhide">
                            <strong style="font-size: 20px ;">Alert Stock</strong>
                            <i class="fa fa-eye-slash HideShow  text-blue"></i>

                        </div>
                        <div align="center" class="row " style="display:true;" id="qteminmax">
                            <table style="width: 30%;" class="table table-bordered table-striped table-bottomless"
                                id="tab">
                                ...
                                foreach ($mois as $m):
                                    ...
                                    <tr style="height:20px">
                                        ...
                                        <td style="text-align: center;">
                                            <input style="height:30px;width:80px" index="<?php echo $i ?>"
                                        ...
                                        <td style="text-align: center;">
                                            <input style="height:30px;width:80px" index="<?php echo $i ?>"
                                                name="<?php echo 'data[seuil][' . $i . '][maximum]' ?>" type="text"
                                                class="seuil form-control" name="" id="max1">
                                        </td>

                                        <td style="text-align: center;">
                                            <input style="height:30px;width:80px" index="<?php echo $i ?>"
                                                name="<?php echo 'data[seuil][' . $i . '][alert]' ?>" type="text"
                        ...
                        <div align="center" class="row " style="display:true;" id="showhide0">
                                ...
                                foreach ($commercials as $s):
                                    ...
                                    <tr style="height:20px">
                                        ...
                                        foreach ($mois as $m):
                                            ...
                                            <td style="width: 10px;">
                                                <input value="<?php echo $m->id ?>" id="<?php echo "mois" . $i ?>"
                                                    index="<?php echo $i ?>"
                                                ...
                                                <input id="<?php echo "objectif" . $i ?>" index="<?php echo $i ?>"
                                                    name="<?php echo 'data[objectifrep][' . $i . '][objectif]' ?>"
                                                    style="height:30px;width:50px" type="text" class="form-control">
                                            </td>
                    ...
                    <div class="tab-content" id="prixFournisseur" style="display: none">
                        <div id="prixfr" style="display:true;">
                            <section class="content-header">
                                <h1 class="box-title">
                                    <?php //debug($ar);die
                                    echo __('Article Fournisseur'); ?>
                                </h1>
                            </section>
                            <section class="content" style="width: 99%">
                                <div class="row">
                                                ...
                                                <table class="table table-bordered table-striped table-bottomless"
                                                    ...
                                                    <tbody>
                                                        <tr class='tr' style="display: none !important">
                                                            ...
                                                            <td><i index="" id="" class="fa fa-times supfr"
                    ...
                    <div class=" tab-content" id="fichart" style="display: none">
                        ...
                        <div class="row">
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                <div class="col-xs-6 ">
                                    <?php echo $this->Form->control('commentaire1', ['class' => 'form-control  control-label', 'type' => "textarea", 'label' => 'Commentaire']); ?>
                    ...
                    <div class=" tab-content" id="COUTarticle" style="display: none">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <a class="btn btn-primary ajouterlignematriceeecout " table='addtableacout' index='index'
                                    tr="tra" style="
                                   float: right; 
                                   position: relative;
                                   top: -25px;
                            ...
                            <div class="panel-body">
                                <table class="table table-bordered table-striped table-bottomless" id="addtableacout"
                                    style="width:100%" align="center">
                                    <thead>
                                        <tr bgcolor="#EDEDED">
                                            <td width="" align="center">Composant1</td>
                                            <td width="" align="center">Qte1</td>
                                            <td width="" align="center">Cout</td>
                                            <td width="" align="center"></td>
                                    ...
                                    <tbody>
                                        <tr champ="tra" class="tra" style="display:none;">
                                            <td align="left">
                                                <?php echo $this->Form->input('sup', array('name' => '', 'id' => '', 'champ' => 'sup', 'table' => 'Ofsflignec', 'index' => '', 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'type' => 'hidden', 'class' => 'form-control')); ?>
                                                <div style="margin-top:10px">
                                                    <?php echo $this->Form->input('article_id', array('empty' => 'Veuillez choisir', 'label' => '', 'id' => 'article_id', 'name' => '', 'table' => 'Ofsflignec', 'champ' => 'article_id', 'index' => '', 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => '')); ?>
                                                </div>
                                            </td>

                                            <td align="center">
                                                <?php
                                                echo $this->Form->input('qte', array('id' => 'qte', 'label' => '', 'name' => '', 'table' => 'Ofsflignec', 'champ' => 'qte', 'index' => '', 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control comp'));
                                                echo $this->Form->input('qt', array('type' => 'hidden', 'id' => 'qt', 'label' => '', 'name' => '', 'table' => 'Ofsflignec', 'champ' => 'qt', 'index' => '', 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control comp'));
                                                ?>
                                            </td>
                                            <td>
                                                <?php 
                                 echo $this->Form->input('cout', array('readonly','id' => 'cout', 'label' => '', 'name' => '', 'table' => 'Ofsflignec', 'champ' => 'cout', 'index' => '', 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control comp'));
                                 ?>  
                                            </td>
                                            ...
                                            <td champ="afef" class="afef" colspan="3" id="" index="">
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        ...
                                                        <a class="btn btn-primary ajouterligne1c " tabletype='addtableaac'
                                                            indexlignetype='indexa' trtype="traaa" style="
                                                           float: right; 
                                                           position: relative;
                                                           top: -25px;
                                                    ...
                                                    <div class="panel-body">
                                                        <table
                                                            class="table table-bordered table-striped table-bottomless"
                                                            index="" indexligne='indexa' champ="addtableaac" id=""
                                                            style="width:100%" align="center">
                                                            <thead>
                                                                <tr bgcolor="#EDEDED">
                                                                    <td align="center">Composant</td>
                                                            ...
                                                            <tbody>
                                                                <tr class="traaa" style="display:none;" id="traaa"
                                                                    champ='traaa' index="">
                                                                    <td>
                                                                        <?php echo $this->Form->input('supp2', array('name' => '', 'type' => 'hidden', 'label' => '', 'indexligne' => '', 'index' => '', 'table' => 'Ofsflignec', 'tableligne' => 'Phaseofsfc', 'champ' => 'supp2', 'id' => '', 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control')); ?>
                                                                        <div style="margin-top:5px">
                                                                            <?php echo $this->Form->input('article_id', array('name' => '', 'label' => '', 'indexligne' => '', 'index' => '', 'table' => 'Ofsflignec', 'tableligne' => 'Phaseofsfc', 'champ' => 'article_idt', 'id' => '', 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => '', 'empty' => 'Veuillez Choisir !!', "style" => "width:100% ; height:32px"));
                                                                            ?>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <?php echo $this->Form->input('qte', array('name' => '', 'label' => '', 'indexligne' => '', 'index' => '', 'table' => 'Ofsflignec', 'tableligne' => 'Phaseofsfc', 'champ' => 'qte', 'id' => 'qte', 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control'));
                                                                        ?>
                                                                    </td>
                                                                    <td>
                                                                    <?php 
                                 echo $this->Form->input('cout', array('readonly','id' => 'cout', 'label' => '', 'name' => '', 'indexligne' => '','table' => 'Ofsflignec', 'tableligne' => 'Phaseofsfc', 'champ' => 'cout', 'index' => '', 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control '));
                                 ?>  
                                                                    </td>
                                                                    ...
                                                                    <td champ="afefligne" class="afefligne" colspan="3"
                                                                        ...
                                                                        <div class="panel panel-default">
                                                                            <div class="panel-heading">
                                                                                ...
                                                                                <a class="btn btn-primary ajouterligne1lignec "
                                                                                    index="" indexligne=""
                                                                                    tabletypeligne='addtableaaligne'
                                                                                    indexligneligne='indexaligne'
                                                                                    indexlignetypeligne='indexaligne'
                                                                                ...
                                                                                <table
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr class="traaaligne"
                                                                                            ...
                                                                                            <td>
                                                                                            <?php 
                                 echo $this->Form->input('cout', array('readonly','id' => 'cout', 'label' => '', 'name' => '', 'indexligne' => '', 'indexligneligne' => '','table' => 'Ofsfligne', 'tableligne' => 'Phaseofsf', 'champ' => 'cout', 'index' => '', 'tableligneligne' => 'Phaseofsfligne','div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control '));
                                 ?>  
                                                                                            </td>
        ...
        $('.famille1').on('change', function () {
            ...
            if (id == 1) {
                ...
                if (id == 2) {
                    ...
                    $('#dstock').attr('style', "display:none;");
                    $('#dprod').attr('style', "display:none;");
                } else {
                    $('#mobile').attr('style', "display:none;");
