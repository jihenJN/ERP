                    ...
                    <div class="row">
                            ...
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                ...
                                <div class="col-xs-6">
                                    <div class="form-group input text">
                                        ...
                                        <input maxlength="4" name="Code" type="tel" id="code" class="form-control">
                                    </div>                               
                                </div>
                                ...
                                <div class="col-xs-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="codearticle" readonly type="text" id="codearticle" class="form-control" style="width:34%;">
                        ...
                        <div class="row">
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                ...
                                <div class=" col-xs-6">
                                    <?php echo $this->Form->control('unitearticle_id', ['label' => 'Unité article', 'options' => $unitearticles, 'empty' => 'Veuillez choisir !!', 'class' => ' form-control select2 control-label  ', 'id' => 'u', 'required' => 'off']); ?>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                ...
                                <div class="col-xs-6">
                                    <?php echo $this->Form->control('unite_id', ['options' => $unites, 'empty' => 'Veuillez choisir SVP !!', 'class' => 'form-control select2 control-label', 'label' => 'Unité contenance']); ?>
                                </div>
