...
<button type="button"  style="width: 160px;<?php if ($article->famille_id == 1 && $comm == 0) { ?>display:true;<?php } else { ?>display:none<?php } ?> " data-toggle="tab" class="btn btn-primary btn-sm"  onclick="afficherDiv('prixclient')">Prix Clients</button>
<button type="button"  style="width: 160px;<?php if ($article->famille_id == 1 && $comm == 0) { ?>display:true;<?php } else { ?>display:none<?php } ?> " data-toggle="tab" class="btn btn-primary btn-sm" onclick="afficherDiv('objectifs')">Objectifs</button>
...
<button type="button"  style="width: 160px;<?php if ($article->famille_id == 1 && $comm == 0) { ?>display:true;<?php } else { ?>display:none<?php } ?> " data-toggle="tab" class="btn btn-primary btn-sm" onclick="afficherDiv('fichart')">Fiche Article</button>
<button type="button"  style="width: 160px;<?php if ($article->famille_id ==2) { ?>display:true;<?php } else { ?>display:none<?php } ?> " data-toggle="tab" class="btn btn-primary btn-sm" onclick="afficherDiv('prixFournisseur')">Prix Fournisseur</button>
                        ...
                        <div class="col-md-12" id="contenu_article" style="display:true;">
                            ...
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                ...
                                <div style="width:80%; margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                    ...
                                    Activ&eacute <input type="radio" name="etat" value="0" id="active" class="" style="margin-right: 20px" <?php if ($article->etat == 0) { ?> checked="checked" <?php } ?>>
