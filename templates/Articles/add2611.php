                ...
                <div class="box-body">
                    <div class="row">
                            ...
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                ...
                                <div class="col-xs-6">
                                    <div class="form-group input text required">
                                        <?php echo $this->Form->control('famille_id', ['empty' => 'Veuillez choisir SVP !!', 'options' => $familles, 'class' => 'form-control select2 control-label famille1 famille ', 'id' => 'salma']); ?>
                            ...
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                ...
                                <div class="col-xs-6">
                                    <div class="form-group input text required" id="divsous">
                                        <?php echo $this->Form->control('sousfamille1', ['name' => 'sousfamille1_id', 'empty' => 'Veuillez choisir SVP !!', 'id'=>'sous','class' => 'form-control select2 control-label sousfamille1', 'label' => 'Sous famille']); ?>
                            ...
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                ...
                                <div class="col-xs-6">
                                    <div class="form-group input text required" id="divsoussous">
                                        <?php echo $this->Form->control('sousfamille1', ['id'=>'soussous','empty' => 'Veuillez choisir SVP !!', 'class' => 'form-control select2 control-label', 'label' => 'Sous sous famille']); ?>
                                    </div>
                                </div>
                                <div class="col-xs-6">
                        ...
                        <div class="row">
                            ...
                            <div id="nombrepiece" style=" margin: 0 auto; display:true; margin-left: 20px; margin-right: 20px; position: static; ">
                                <div class="col-xs-6">
                        ...
                        <div class="row">
                            ...
                            <div id="nbjour" style=" margin: 0 auto; display:true;  margin-left: 20px; margin-right: 20px; position: static; ">
                        ...
                        <!-- /.box-header -->
                        <div align="center" class="row famille1" style="display:none;"  id="qteminmax">
                    ...
                    <div class="col-md-12 famille1" id="fiche"  style="display:none;">
