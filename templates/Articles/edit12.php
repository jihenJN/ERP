                            ...
                            <div class="row">
                                <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        OUI <input type="radio" name="stockable" value="0" id="OUI" <?php if ($article->stockable == 0) { ?> checked="true" <?php } ?> class="" style="margin-right: 20px">
                                        NON <input type="radio" name="stockable" value="1" <?php if ($article->stockable == 1) { ?> checked="true" <?php } ?> id="NON" class="">
                                        ...
                                        <table class="table table-bordered table-striped table-bottomless" id="tabligne">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($articlesetapes as $i => $res) :;  ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <select name="<?php echo "data[etapes][" . $i . "][etape_id]" ?>" id="" class="form-control select2 control-label rang">
                                                                <option value="" selected="selected">Veuillez choisir !!</option>

                                                                <?php foreach ($etapes as $e) {

                                                                ?>
                                                                    <option <?php if ($res->etape_id == $e->id) { ?> selected="selected" <?php } ?> value="<?php echo $e->id; ?>"><?php echo $e->name ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </td>
                                                        <td>
                                                ...
                                                <tr class="tr" style="display: none !important">
                                                    ...
                                                    <td align="center" width="45%">
                                                        <input table="etapes" type="text" class="form-control verif" index="" name="" id="" champ="rang" value="">
                                                    </td>
                                ...
                                <div id="fiche" class="col-md-12 " <?php if ($article->famille_id == 1 && $comm == 0) { ?> style='display:true' <?php } else { ?> style='display:none' <?php } ?>>
                                    <div class="panel panel-default">
                                       ...
                                       "><i class="fa fa-plus-circle"></i> </a>
                                        ...
                                        <td align="center" hidden  champ='tdcomp' index=''  table='Ofsfligne' > <?php
                                                                                ...
                                                                                <table class="table table-bordered table-striped table-bottomless" index="" indexligneligne='indexaligne' champ="addtableaaligne" id="" style="width:100%" align="center">
                                                                                    <thead>
                                                                                        <tr bgcolor="#EDEDED">
                                                                                            ...
                                                                                            <td align="center">Qte</td>
                                                                                            <td align="center">Unite</td>
                                                                                            <td align="center" hidden>Coefficient</td>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td align="center" <?php if(empty($fech['Ligne'])){ ?> hidden <?php } ?> id="tdcomp<?php echo $i ?>" index="<?php echo $i ?>" champ="tdcomp" table="Ofsfligne" name="data[Ofsfligne][<?php echo $i ?>][tdcomp]"> <?php
                                                            ...
                                                            <table class="table table-bordered table-striped table-bottomless" id="addtableaa<?php echo $i; ?>" style="width:100%" align="center">
                                                                <thead>
                                                                    <tr bgcolor="#EDEDED">
                                                                        ...
                                                                        <td align="center">Qte</td>
                                                                        <td align="center">Unite</td>
                                                                        <td align="center" hidden  id='tdcompp' >Coefficient</td>
                                                                ...
                                                                <tbody>
                                                                    <tr class="traa<?php echo $i; ?>" style="display:none;" d="traa<?php echo $i; ?>">
                                                                        ...
                                                                        <td hidden  champ='tdcompp' index='' indexligne=''  table='Ofsfligne' tableligne='Phaseofsf'> <?php
                                                                    ...
                                                                    ?>
                                                                        <tr>
                                                                            ...
                                                                            <td <?php if(empty($fech['ligneligne'])){ ?> hidden <?php } ?> id="tdcompp<?php echo $i ?>-<?php echo $j ?>" champ="tdcompp" table="Ofsfligne" indexligne="<?php echo $j ?>" index="<?php echo $i ?>" name="data[Ofsfligne][<?php echo $i ?>][Phaseofsf][<?php echo $j ?>][tdcompp]"> <?php
