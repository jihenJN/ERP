...
<section class="content-header">
    ...
    <div class="choisir" align="center" style="margin-top: 3%;">
        ...
        <button type="button"
            ...
            data-toggle="tab" class="btn btn-primary btn-sm" onclick="afficherDiv('prixclient')">Prix Clients</button>
        <button type="button"
            style="width: 160px;<?php if ($article->famille_id == 1 && $comm == 0) { ?>display:true;<?php } else { ?>display:none<?php } ?> "
            data-toggle="tab" class="btn btn-primary btn-sm" onclick="afficherDiv('objectifs')">Objectifs</button>
        ...
        <button type="button"
            ...
            data-toggle="tab" class="btn btn-primary btn-sm" onclick="afficherDiv('prixFournisseur')">Prix
            Fournisseur</button>

        <button type="button"
            style="width: 160px;<?php if (($article->famille_id == 1 || $article->famille_id == 4) && $comm == 0) { ?>display:true;<?php } else { ?>display:none<?php } ?> "
            data-toggle="tab" class="btn btn-primary btn-sm" onclick="afficherDiv('fichart2')">Cout </button>
        ...
        <div class="col-md-12">
            <div class="box ">
                ...
                <div class="box-body">
                            ...
                            <div class="col-md-12" id="contenu_article" style="display:true;">
                                    ...
                                    <div
                                        ...
                                        <div class="col-xs-6">
                                            ...
                                            <div class="form-group input text">
                                                <label>Code</label>
                                                <input maxlength="4" value="<?php echo $article->Code ?>" name="Code"
                                                    type="tel" id="code" class="form-control">
                                            </div>
                                            <input value="<?php echo $article->id ?>" readonly type="hidden"
                                                id="idarticle" class="form-control">
                                        </div>
                                        <div class="col-xs-3">
                                        ...
                                        <div style="width: 20px;" class="aff col-xs-4 ">
                                            ...
                                            <img id="img" style='width:150px' <?php if ($url != '') { ?>
                                                    src="<?php echo $url ?>" <?php } ?>>
                                ...
                                <div class="row">
                                    <div
                                        ...
                                        <div class="col-xs-6">
                                            ...
                                            <input value="<?php echo sprintf('%0.3f', $article->Prix_LastInput) ?>"
                                ...
                                <div class="row">
                                    <div
                                        ...
                                        <div class="col-xs-6" id="nombrepiece" <?php if ($article->famille_id == 2) { ?>
                                ...
                                <div class="row">
                                    <div
                                        ...
                                        <div class="col-xs-6" id="nbjour" <?php if ($article->famille_id == 2) { ?>
                                                style='display:none' <?php } else { ?> style='display:true' <?php } ?>>
                                        ...
                                        <div class="col-xs-6" id="nbpoint" <?php if ($article->famille_id == 2) { ?>
                                                style='display:none' <?php } else { ?> style='display:true' <?php } ?>>
                                ...
                                <div class="row">
                                    <div
                                        ...
                                        <div class="col-xs-6" id="coefficient" <?php if ($article->famille_id == 2) { ?>
                                                style='display:none' <?php } else { ?> style='display:true' <?php } ?>>
                                ...
                                <div class="row">
                                    <div
                                        ...
                                        <div class="col-xs-6" id="densite" <?php if ($article->famille_id == 2) { ?>
                                ...
                                <div class="row">
                                    <div
                                        ...
                                        <div class="col-xs-6" id="devise" <?php if ($article->famille_id == 2) { ?>
                                                style='display:true' <?php } else { ?> style='display:none' <?php } ?>>
                                    ...
                                    <div style="width:100%;    margin-right: 20px; position: static; ">
                                        <div align="center">
                                            <div class="form-group input number">
                                                ...
                                                <input class="calculmarge" value="<?php echo $article->cout ?>"
                                    ...
                                    <div style="width:100%; position: static; ">
                                        <div align="center">
                                            <div class="form-group input number">
                                                ...
                                                <input class="calculmarge" value="<?php echo $article->prixttc ?>"
                                                    ...
                                                    <td width="45%">
                                                        ...
                                                        <div style="margin-top:1%">
                                                            <?php //echo $this->Form->control('client_id', array('empty' => 'Veuillez choisir !!', 'value' => $rest->client_id, 'champ' => 'client_id', 'label' => '', 'name' => '', 'id' => '', 'table' => 'clientarticles', 'index' => '', 'div' => 'form-group ', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control select2')); 
                                                                ?>
                                                            <select
                                                                name="<?php echo "data[clientarticles][" . $j . "][client_id]" ?>"
                                                                id="<?php echo 'client_id' . $j ?>" table="clientarticles"
                                                                index="<?php echo $j ?>" champ="client_id"
                                                                ...
                                                                <?php foreach ($clients as $id => $client) {
                                                                    ?>
                                                                    <option <?php if ($rest->client_id == $client->id) { ?>
                                    ...
                                    <table class="table table-bordered table-striped table-bottomless" id="tabligne3">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="tr" style="display: none !important">
                                                ...
                                                <td align="left">
                                                    <input type="hidden" name="" id="" champ="sup0" table="uaprincipals"
                    ...
                    <?php //echo $comm; ?>
                        <div class="row" <?php if (($article->famille_id == 1 || $article->famille_id == 4) && $comm == 0) { ?> style='display:block' <?php } else { ?> style='display:none' <?php } ?> id="showhide00">
                            <div class="row">
                                <div
                                    style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                    <div class="col-xs-6 ">
                                    ...
                                    <div class="col-xs-6 ">
                                        <div style=" margin-left: 20%;">
                                            <label class="control-label" for="unipxte-id"
                                                style="margin-right: 20px">Sauvegarder
                                                Copie :</label>
                                            NON <input type="radio" name="sauv" value="0" id="NON"
                                                class="calculprixarticle" <?php if ($sauvgarde == 0) { ?>
                                                    checked="checked" <?php } ?>>
                                        </div>
                                        <br>
                                        <div style=" margin-left: 20%;">
                                            <label class="control-label" for="unipxte-id"
                                                style="margin-right: 20px">Fiche
                                                Article 2
                                                :</label>
                                            OUI <input type="radio" name="sauv" value="1" id="OUI"
                                                class="calculprixarticle" style="margin-right: 20px" <?php if ($sauvgarde == 1) { ?> checked="checked" <?php } ?>>
                                            <label class="control-label" for="unipxte-id"
                                                style="margin-right: 20px">Fiche
                                                Article 3
                                                :</label>
                                            OUI <input type="radio" name="sauv" value="2" id="OUI"
                                                class="calculprixarticle" style="margin-right: 20px" <?php if ($sauvgarde == 2) { ?> checked="checked" <?php } ?>>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div align="center">
                                ...
                                if ($article->sauv != 0) {
                                    if ($article->sauv == 1) {
                                        ...
                                        $datemodification = $article['dateft2'];
                                        $numfich = '2';
                                    } else {
                                        $datemodification = $article['dateft3'];
                                        $numfich = '3';
                                    }

                                    ?>
                                    <div>
                                        <?php if ($datemodification != null) {
                                            # code...
                                            ?>
                                            <p style="font-size: 17px;"> Cette fiche technique a été modifiée à la date
                                                <?php echo $datemodification->format("Y-m-d H:i:s") ?> et enregistée dans la
                                                fiche
                                                technique <?php echo $numfich ?>
                                            </p>
                                        </div>
                                    <?php } ?>
                                <?php } ?>
                        ...
                        <div id="fiche" class="col-md-12 " <?php if (($article->famille_id == 1 || $article->famille_id == 4) && $comm == 0) { ?> style='display:block' <?php } else { ?>
                                                            ...
                                                            <table
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="traaa" style="display:none;" id="traaa"
                                                                        ...
                                                                        <td>
                                                                            <?php echo $this->Form->input('unite_id', array('name' => '', 'label' => '', 'indexligne' => '', 'index' => '', 'table' => 'Ofsfligne', 'tableligne' => 'Phaseofsf', 'champ' => 'unite_idt', 'id' => '', 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'empty' => 'Veuillez Choisir !!', 'class' => 'form-control'));
                                                                            ?>
                                                                        </td>
                                                                    ...
                                                                    <tr class="traaligne" index="" champ='traaligne'
                                                                        style="display:none">
                                                                        <td width='30%'></td>
                                                                        <td champ="afefligne" class="afefligne"
                                                                            colspan="3" id="" index="">
                                                                            <div class="panel panel-default">
                                                                                <div class="panel-heading">
                                                                                    <h3 class="panel-title">
                    ...
                    <div class=" tab-content" id="fichart2" style="display: none">
                        <?php //echo $comm; ?>
                        <div class="row" <?php if (($article->famille_id == 1 || $article->famille_id == 4) && $comm == 0) { ?> style='display:true' <?php } else { ?> style='display:none' <?php } ?> id="showhide00">
                            <div class="row">
                        ...
                        <div id="fiche" class="col-md-12 " <?php if (($article->famille_id == 1 || $article->famille_id == 4) && $comm == 0) { ?> style='display:true' <?php } else { ?>
                                style='display:none' <?php } ?>>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">
                                    ...
                                    <a class="btn btn-primary ajouterlignematriceeecout " table='addtablea'
                                        index='index' tr="tra" style="
                                       float: right; 
                                       position: relative;
                                       top: -25px;
                                       "><i class="fa fa-plus-circle"></i> </a>
                    ...
                    <div align="center">
                        <?php echo $this->Form->submit(__('Enregistrer'), ['id' => 'ajouarticle', 'class' => ' btn btn-xm btn-success verifierunite']); ?>
                    </div>
