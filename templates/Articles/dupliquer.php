...
<!-- Main content -->
<!--<label>
    <input type="checkbox"  id="check"  class="afficherfichetechnique"  <?php // if ($articlee->vente) {      
                                                                        ?> value="TRUE" <?php // } else {       
                                                                                        ?>
        value="FALSE"
<?php //}  
                ...
                <div class="box-body">
                        ...
                        <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            <div class="col-xs-6">
                                <div class="form-group input text required">
                                    <?php echo $this->Form->control('famille_id', ['empty' => 'Veuillez choisir SVP !!', 'value' => $articlee->famille_id, 'options' => $familles, 'class' => 'form-control select2 control-label famille famille1', 'id' => 'salma']); ?>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="form-group input text required" id="divsous">
                                    <?php echo $this->Form->control('sousfamille1_id', ['id' => 'sous', 'value' => $articlee->sousfamille1_id, 'name' => 'sousfamille1_id', 'empty' => 'Veuillez choisir SVP !!', 'class' => 'form-control select2 control-label sousfamille1', 'label' => 'Sous famille']); ?>
                                </div>
                            </div>
                            <!-- <div class="col-xs-6">
                    ...
                    <div class="row">
                        <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            ...
                            <div class=" col-xs-6">
                                <?php echo $this->Form->control('unite_id', ['label' => 'Unite article ', 'value' => $articlee->unite_id, 'options' => $unites, 'empty' => 'Veuillez choisir !!', 'class' => ' form-control select2 control-label ', 'id' => 'u', 'required' => 'off']); ?>
                            </div>
                            <div class="col-xs-6">
                    ...
                    <div class="row">
                        <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            ...
                            <div class="col-xs-6">
                                <?php echo $this->Form->control('codeabr', ['type' => 'hidden', 'label' => '', 'id' => 'codeabr', 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control ']); ?>
                                <div class="form-group input text">
                                    <label>Code</label>
                                    <input name="Code" type="tel" id="code" class="form-control">
                                    <input value="<?php echo $articlee->id ?>" readonly type="hidden" id="idarticle" class="form-control">
                    ...
                    <div class="row">
                        <div style=" margin-left: 20px; margin-right: 20px; ">
                            ...
                            <div class="col-xs-6">
                                <?php echo $this->Form->control('prixachat', ['label' => 'Prix Achat HT', 'value' => $articlee->prixachat, 'placeholder' => "0.000", 'step' => "0.001", 'id' => 'prixachat']); ?>


                            </div>
                            <div class="col-xs-6">
                                <label> Prix Vente HT</label>
                                <input value="<?php echo  sprintf('%0.3f', $articlee->Prix_LastInput)  ?>" placeholder="0.00" step="0.001" type="number" class="form-control calculprixarticlefinal" name='Prix_LastInput' id="Prix_LastInput">
                            </div>
                            <div class=" col-xs-6" hidden>
                                <?php echo $this->Form->control('machine_id', ['label' => ' Machine', 'value' => $articlee->machine_id, 'options' => $machines, 'empty' => 'Veuillez choisir !!', 'class' => ' form-control select2 control-label', 'id' => 'machine_id', 'required' => 'off']); ?>
                            </div>
                            ...
                            <!-- <div class="col-xs-6">
                                    < ?php echo $this->Form->control('test', ['class' => 'form-control  control-label', 'id' => 'vente', 'value' => $articlee->vente, 'type' => 'hidden']); ?>
                                </div> -->
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div style=" margin-left: 20px; margin-right: 20px; ">
                            ...
                            <div class=" col-xs-3">
                                <?php echo $this->Form->control('tva_id', ['label' => ' Categorie Tva', 'value' => $articlee->tva_id, 'options' => $tvas, 'empty' => 'Veuillez choisir !!', 'class' => ' form-control select2 control-label tva calculprixarticlee', 'id' => 'tvaselect', 'required' => 'off']); ?>
                            </div>
                            <div class="col-xs-3">
                                <?php
                                if ($articlee->tva->valeur != null) {
                                    $tva = $articlee->tva->valeur;
                                } else {
                                    $tva = 0;
                                }
                                echo $this->Form->control('tvaa', ['class' => 'form-control  control-label', 'label' => "Valeur TVA:", 'value' => $tva, 'readonly' => 'readonly', 'id' => 'tva']);
                                ?>
                            </div>
                            <div class=" col-xs-6">
                                <?php echo $this->Form->control('marque_id', ['label' => 'Marque', 'value' => $articlee->marque_id, 'options' => $marques, 'empty' => 'Veuillez choisir !!', 'class' => ' form-control select2 control-label  ', 'id' => 'marque_id', 'required' => false]); ?>
                            </div>
                            <div class="col-xs-6" hidden>
                                <?php echo $this->Form->control('refBureauEtude', ['label' => 'Ref bureau d\'étude', 'required' => 'off', 'id' => 'refBureauEtude', 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control ', 'type' => 'text', 'name' => 'refBureauEtude']);
                                ?>
                    ...
                    <div class="row">
                        <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            ...
                            <!-- <div class="col-xs-6" id="frotation" <?php if ($articlee->famille_id == 2) { ?> style='display:none' <?php } else { ?> style='display:true' <?php } ?>>
                            ...
                            <div class="col-xs-6">
                                <?php echo $this->Form->control('remise', ['class' => 'form-control  control-label', 'value' => $articlee->remise, 'label' => "Remise %:"]); ?>
                            </div>
                        </div>
                    </div>
                    <div hidden class="row">
                        <div hidden style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            <div hidden class="col-xs-6" id="nombrepiece" <?php if ($articlee->famille_id == 2) { ?> style='display:none' <?php } else { ?> style='display:true' <?php } ?>>
                    ...
                    <div hidden class="row">
                        <div hidden style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            <div hidden class="col-xs-6" id="nbjour" <?php if ($articlee->famille_id == 2) { ?> style='display:none' <?php } else { ?> style='display:true' <?php } ?>>
                                <?php echo $this->Form->control('nbjour', ['type' => 'number', 'class' => 'form-control  control-label', 'label' => "Nombre de jour:"]); ?>
                            </div>
                            <div hidden class="col-xs-6" id="nbpoint" <?php if ($articlee->famille_id == 2) { ?> style='display:none' <?php } else { ?> style='display:true' <?php } ?>>
                    ...
                    <div hidden class="row">
                        <div hidden style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            <div hidden class="col-xs-6" id="nbpiecepalette" <?php if ($articlee->famille_id == 2) { ?> style='display:none' <?php } else { ?> style='display:true' <?php } ?>>
                            ...
                            <div hidden class="col-xs-6" id="coefficient" <?php if ($articlee->famille_id == 2) { ?> style='display:none' <?php } else { ?> style='display:true' <?php } ?>>
                    ...
                    <div hidden class="row">
                        <div hidden style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            <div hidden class="col-xs-6" id="densite" <?php if ($articlee->famille_id == 2) { ?> style='display:true' <?php } else { ?> style='display:none' <?php } ?>>
                    ...
                    <div class="row">
                        <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            ...
                            <div class="col-xs-6" id="devise" <?php if ($articlee->famille_id == 2) { ?> style='display:true' <?php } else { ?> style='display:none' <?php } ?>>
                    ...
                    <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                        <div hidden style="margin-top:20px" class="col-xs-8">
                            ...
                            <input class="afficherfiche" type="checkbox" id="ventee" name="vente" value="1" <?php if ($articlee->vente == 1) { ?> checked="true" <?php } ?> </div>
                        </div>
                        <div hidden style="margin-top:20px" id="mobile" class="col-xs-8" <?php if ($articlee->famille_id == 2) { ?> style='display:none' <?php } else { ?> style='display:true' <?php } ?>>
                            <div class="col-xs-6">

                                <label class="control-label" for="unipxte-id" style="margin-right: 20px"> Mobile </label>
                                <input type="hidden" id="mobile" name="mobile">
                                <input class="afficherfiche" type="checkbox" id="mobilee" name="mobile" value="1" <?php if ($articlee->mobile == 1) { ?> checked="true" <?php } ?>>
                            </div>
                        ...
                        <div style="width:75%; margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            ...
                            Activ&eacute <input type="radio" name="etat" value="0" id="active" class="" <?php if ($articlee->etat == 0) { ?> checked="checked" <?php } ?>>
                            D&eacute;sactiv&eacute <input type="radio" name="etat" value="1" id="desactive" class="" <?php if ($articlee->etat == 1) { ?> checked="checked" <?php } ?>>
                            <br>
                            <label hidden class="control-label" for="unipxte-id" style="margin-right: 20px">Fodec :</label>

                            <input hidden type="radio" name="fodec" value="<?php echo $fodec ?>" id="OUI" class="calculprixarticle" style="margin-right: 20px" <?php if ($articlee->fodec != 0) { ?> checked="checked" <?php } ?>>
                            <input hidden type="radio" name="fodec" value="0" id="NON" class="calculprixarticle" <?php if ($articlee->fodec == 0) { ?> checked="checked" <?php } ?>>
                            <br>

                            <label hidden class="control-label" for="unipxte-id" style="margin-right: 20px">Tpe (%):</label>

                            <!-- OUI  -->
                            <input hidden type="radio" name="TXTPE" value="<?php echo $tpe ?>" id="OUItpe" class="calculprixarticle" style="margin-right: 20px" class="" style="margin-right: 20px" <?php if ($articlee->TXTPE != 0) { ?> checked="checked" <?php } ?>>
                            <!-- NON  -->
                            <input hidden type="radio" name="TXTPE" value="0" id="NONtpe" class="calculprixarticle" <?php if ($articlee->TXTPE == 0) { ?> checked="checked" <?php } ?>>
                    ...
                    <div class="row" class="col-md-12 ">
                        ...
                        <div style="display:flex;">
                            <div style="width:80%; margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                <div class="col-xs-6" align="center">
                                    <?php echo $this->Html->image('imgart/' . $articlee->image, ['style' => 'max-width:100px;height:100px;']); ?>
                                </div>
                            ...
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                ...
                                <div class="col-xs-6">
                                    <div class="form-group input number">
                                        ...
                                        <input value="<?php echo $articlee->prixttc ?>" style="color:rgb(255, 0, 0);height: 80px;font-size:40px;width:50%;text-align:center" readonly='readonly' type="text" name="prixttc" id="prixttc">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div align="center">
                            <button type="submit" class="pull-right btn btn-success testdepotd " id="ajouarticle" style="margin-right:48%;margin-top: 20px;margin-bottom:20px;">Enregistrer</button>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.testdepotd').on('mouseover', function() {
            var cc = $('#code').val();
            var des = $('#Dsignation').val();
            if (!des) {
                alert('Veuillez choisir une Désgination');
                return;
            } else if (!cc) {
                alert('Veuillez choisir un Code');
                return;
            }
        });
    ...
    $("#code").on("change", function() {
        ...
        if (code === "") {
            alert("Veuillez remplir Code");
            return false;
        }

        $.ajax({
            method: "GET",
            url: "<?= $this->Url->build(['controller' => 'Articles', 'action' => 'verifcode']) ?>",
            dataType: "json",
            data: {
                code: code
            },
