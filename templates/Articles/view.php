                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            ...
                            <div class="col-xs-6">
                                <?php echo $this->Form->control('codeancienne', ['label' => 'Code Ancienne', 'readonly','id' => 'codeancienne']); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                                <?php echo $this->Form->control('prixachat', ['label' => 'Prix Achat HT','readonly', 'placeholder' => "0.000", 'step' => "0.001", 'id' => 'prixachat']); ?>
                    ...
                    <div class="row">
                        <div style=" margin-left: 20px; margin-right: 20px; ">
                            ...
                            <div class=" col-xs-6">
                                <?php echo $this->Form->control('marque_id', ['label' => 'Marque','disabled'=>'disabled', 'options' => $marques, 'empty' => 'Veuillez choisir !!', 'class' => ' form-control select2 control-label  ', 'id' => 'marque_id', 'required' => false]); ?>
                            </div>
                            <div class="col-xs-6" hidden>
                                <?php echo $this->Form->control('refBureauEtude', ['label' => 'Ref bureau d\'étude','readonly', 'required' => 'off', 'id' => 'refBureauEtude', 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control ', 'type' => 'text', 'name' => 'refBureauEtude']);
                                ?>
                            </div>
                            <!-- <div class="col-xs-6">
                    ...
                    <div class="row">
                        <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            ...
                            <div class="col-xs-6" hidden id="frotation" <?php if ($article->famille_id == 2) { ?> style='display:none' <?php } else { ?> style='display:true' <?php } ?>>
                            ...
                            <div  class="col-xs-6">
                                <?php echo $this->Form->control('remise', ['class' => 'form-control  control-label', 'label' => "Remise %:",'readonly']); ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                        <div hidden  style="margin-top:20px" class="col-xs-8">
                            ...
                            <input hidden class="afficherfiche" type="checkbox" id="ventee" name="vente" value="1" <?php if ($article->vente == 1) { ?> checked="true" <?php } ?> ></div>
                        </div>
                        ...
                        <div style="width:60%; margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            ...
                            Activ&eacute <input  disabled type="radio" name="etat" value="0" id="active" class="" <?php if ($article->etat == 0) { ?> checked="checked" <?php } ?>>
                            D&eacute;sactiv&eacute <input  disabled type="radio" name="etat" value="1" id="desactive" class="" <?php if ($article->etat == 1) { ?> checked="checked" <?php } ?>>
                            <br>
                    ...
                    <div class="row" class="col-md-12 ">
                        ...
                        <div hidden align="center">
                            <?php echo $this->Form->submit(__('Enregistrer'), ['id' => 'ajouarticle', 'class' => ' ']); ?></div>
