...
//debug($i);
                        ...
                        <div class="col-md-12 " <?php if ($article->vente == 1) { ?> style='display:true' <?php } ?>
                            ...
                            <div class="panel panel-default" >
                             ...
                             echo $this->Form->input('article_id', array('empty' => 'Veuillez choisir', 'label' => '', 'id' => 'article_id', 'name' => '', 'table' => 'Ofsfligne', 'champ' => 'article_id', 'index' => '', 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => ''));
                             ?></td>
                                                <td align="center"> <?php
                                   ...
                                   <!--                                         <i indexligne="" index="" class="fa fa-times supor2" style="color: #c9302c;font-size: 22px;">-->
                                                                    ...
                                                                    <tr class="traaligne"  index="" champ='traaligne' style="display:none">
                                                                        <td width='25%'></td>      <td  champ="afefligne" class="afefligne" colspan="3" id="" index="" >
                                                                            <div class="panel panel-default" >
                                                                                <div class="panel-heading">
                                                                                    <h3 class="panel-title"><?php echo __('Article3'); ?></h3>
                                                           ...
                                                           <!--                                         <i indexligneligne="" indexligne="" index="" class="fa fa-times supor3" style="color: #c9302c;font-size: 22px;">-->
                                                            ...
                                                            <input type="hidden" value="0" class="" id="" champ="indexa" />
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                                                ...
                                                                <table class="table table-bordered table-striped table-bottomless" id="addtableaa<?php echo $i; ?>" style="width:100%" align="center" >
                                                                    ...
                                                                    <tbody>
                                                                        <tr class="traa<?php echo $i; ?>" style="display:none;" champ="traa">
                                                                            ...
                                                                            <td align="center">
                                      <!--                                          <i indexligne="0"  index="<?php echo $i; ?>" class="fa fa-times supor1" style="color: #c9302c;font-size: 22px;">-->
                                                                            </td>
    ...
    <?php foreach ($fech['Ligne'] as $j => $fech1) { ?>  
                                                                            <tr>
                                                                                ...
                                                                                <td align="center">
                                         <!--                                           <i indexligne="<?php echo $j; ?>" index="<?php echo $i; ?>"  class="fa fa-times supor1" style="color: #c9302c;font-size: 22px;">-->
                                                                                </td>
