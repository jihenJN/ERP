            ...
            <div class="box ">
                ...
                <div class="box-body">
                        ...
                        <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group input text required">
                                    <?php echo $this->Form->control('famille_id', ['disabled','empty' => 'Veuillez choisir SVP !!', 'options' => $familles, 'class' => 'form-control select2 control-label famille famille1', 'id' => 'salma']); ?>
                        ...
                        <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group input text required" id="divsous">
                                    <?php echo $this->Form->control('sousfamille1_id', ['disabled','id' => 'sous', 'name' => 'sousfamille1_id', 'empty' => 'Veuillez choisir SVP !!', 'class' => 'form-control select2 control-label sousfamille1', 'label' => 'Sous famille']); ?>
                    ...
                    <div class="row">
                        <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            <div class=" col-xs-6">
                                <?php echo $this->Form->control('unitearticle_id', ['disabled','label' => 'Unite article', 'options' => $unitearticles, 'empty' => 'Veuillez choisir !!', 'class' => ' form-control select2 control-label  ', 'id' => 'u', 'required' => 'off']); ?>
                            </div>
                            <div class="col-xs-6">
                                <?php echo $this->Form->control('unite_id', ['disabled','options' => $unitearticles, 'empty' => 'Veuillez choisir SVP !!', 'class' => 'form-control select2 control-label', 'label' => 'Unite contenance']); ?>
                            </div>
                            <div class="col-xs-6">
                                <div class="form-group input text required" id="divsoussous">
                                    <?php if ($article->sousfamille2_id != null && $sousfamille2s != null) { ?>
                                        <?php echo $this->Form->control('sousfamille_id', ['disabled','value' =>  $article->sousfamille2_id, 'options' => $sousfamille2s, 'id' => 'soussous', 'name' => 'sousfamille2_id', 'empty' => 'Veuillez choisir SVP !!', 'class' => 'form-control select2 control-label sousfamille1', 'label' => 'Sous famille 2']); ?>
                                    <?php }
                                    // else  {
                        ...
                        <div class="col-md-12" id="contenu_article" style="display:true;">
                            ...
                            <div class="row">
                                <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                    <div class="col-xs-6">
                                        <?php echo $this->Form->control('codeabr', ['readonly','type' => 'hidden', 'label' => '', 'value' => str_replace(' ', '', $val), 'id' => 'codeabr', 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control ']); ?>
                                        <div class="form-group input text">
                                            <label>Code</label>
                                            <input maxlength="4" value="<?php echo $article->Code ?>" readonly name="Code" type="tel" id="code" class="form-control">
                                        </div>
                            ...
                            <div class="row">
                                <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                    ...
                                    <div class="col-xs-6">
                                        <?php echo $this->Form->control('Dsignation', ['readonly','label' => 'Designation', 'id' => 'Dsignation']); ?>
                            ...
                            <div class="row">
                                <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                    ...
                                    <div class=" col-xs-2 form-group input text required">
                                        <?php echo $this->Form->control('tva_id', ['disabled','label' => ' Categorie Tva', 'options' => $tvas, 'empty' => 'Veuillez choisir !!', 'class' => ' form-control select2 control-label tva calculprixarticlee', 'id' => 'tvaselect', 'required' => 'off']); ?>
                                    </div>
                                    <div class="col-xs-2">
                                        <?php
                                        ...
                                        echo $this->Form->control('tva', ['readonly','class' => 'form-control  control-label', 'label' => "Valeur TVA:", 'value' => $tva, 'readonly' => 'readonly', 'id' => 'tva']);
                                        ?>
                                    </div>

                                    <div class=" col-xs-6 pull-right form-group input text required">
                                    <?php echo $this->Form->control('ml', ['readonly','label' => 'mètre linéaire', 'class' => ' form-control  control-label ', 'id' => 'ml', 'required' => 'off']); ?>
                                </div>

                                    <div class="col-xs-6">
                                        <?php echo $this->Form->control('test', ['readonly','class' => 'form-control  control-label', 'id' => 'vente', 'value' => $article->vente, 'type' => 'hidden']); ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- <div class="row">
                                <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                    ...
                                    <div class="col-xs-6" id="nombrepiece" <?php if ($article->famille_id == 2) { ?> style='display:none' <?php } else { ?> style='display:true' <?php } ?>>
                                        ...
                                        <?php echo $this->Form->control('nombrepiece', ['readonly','type' => 'number', 'class' => 'form-control  control-label', 'label' => "Nombre de piece par carton:"]); ?>
                                    </div>
                            ...
                            <!-- <div class="row">
                                <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                    ...
                                    <div class="col-xs-6" id="nbjour" <?php if ($article->famille_id == 2) { ?> style='display:none' <?php } else { ?> style='display:true' <?php } ?>>
                                        <?php echo $this->Form->control('nbjour', ['readonly','type' => 'number', 'class' => 'form-control  control-label', 'label' => "Nombre de jour:"]); ?>
                            ...
                            <div class="row">
                                <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                    ...
                                    <div class="col-xs-6">
                                <?php echo $this->Form->control('refBureauEtude', ['readonly','label' => 'Ref bureau d\'étude', 'required' => 'off', 'id' => 'refBureauEtude', 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control ', 'type' => 'text', 'name' => 'refBureauEtude']);
                                ?>
                            </div>
                            ...
                            <div class="row">
                                <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                    ...
                                    <div class="col-xs-6" id="frotation" <?php if ($article->famille_id == 2) { ?> style='display:none' <?php } else { ?> style='display:true' <?php } ?>>
                                        <?php echo $this->Form->control('famillerotation_id', ['disabled','empty' => 'Veuillez choisir !!', 'options' => $famillerotations, 'class' => 'form-control select2 control-label', 'label' => "Famille rotation:"]); ?>
                            ...
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                <div style="margin-top:20px" class="col-xs-8">
                                    ...
                                    <input class="afficherfiche" type="checkbox" disabled id="ventee" name="vente" value="1" <?php if ($article->vente == 1) { ?> checked="true" <?php } ?> </div>
                                </div>
                                ...
                                <div style="width:90%; margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                    ...
                                    Activ&eacute <input type="radio" name="etat" value="0" disabled id="active" class="" style="margin-right: 20px" <?php if ($article->etat == 0) { ?> checked="checked" <?php } ?>>
                                    D&eacute;sactiv&eacute <input type="radio" name="etat" disabled value="1" id="desactive" class="" <?php if ($article->etat == 1) { ?> checked="checked" <?php } ?>>
                                   <br><br> <label class="control-label" for="unipxte-id" style="margin-right: 20px">Fodec :</label>

                                    OUI <input type="radio" name="fodec" disabled value="<?php echo $fodec ?>" id="OUI" class="calculprixarticle" style="margin-right: 20px" <?php if ($article->fodec != 0) { ?> checked="checked" <?php } ?>>
                                    NON <input type="radio" name="fodec" disabled value="0" id="NON" class="calculprixarticle" <?php if ($article->fodec == 0) { ?> checked="checked" <?php } ?>>

                                    <label hidden class="control-label" for="unipxte-id" style="margin-right: 20px">Tpe (%):</label>

                                     <input  hidden type="radio" disabled name="TXTPE" value="<?php echo $tpe ?>" id="OUItpe" class="calculprixarticle" style="margin-right: 20px" class="" style="margin-right: 20px" <?php if ($article->TXTPE != 0) { ?> checked="checked" <?php } ?>>
                                     <input hidden type="radio"  disabled name="TXTPE" value="0" id="NONtpe" class="calculprixarticle" <?php if ($article->TXTPE == 0) { ?> checked="checked" <?php } ?>>
