...
<?php echo $comm; ?>
                        <div id="fiche"  class="col-md-12 " <?php if ($article->vente == 1 && $comm == 0) { ?> style='display:true' <?php } ?>    <?php if ($article->vente == 0) { ?> style='display:none' <?php } ?>>
                                                                ...
                                                                <table class="table table-bordered table-striped table-bottomless" id="addtableaa<?php echo $i; ?>" style="width:100%" align="center" >
                                                                    ...
                                                                    <tbody>
                                                                        <tr class="traa<?php echo $i; ?>" style="display:none;" d="traa<?php echo $i; ?>">
                                                                            ...
                                                                            <td> <?php
                                                                                echo $this->Form->input('supp2', array('label' => '', 'type' => 'text', 'div' => 'form-group', 'name' => '', 'indexligne' => '0', 'table' => 'Ofsfligne', 'tableligne' => 'Phaseofsf', 'index' => $i, 'id' => 'supp', 'champ' => 'supp2', 'indextype' => '', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control'));
