    ...
    <div class="box-body">
      <div class="row">
        ...
        <div class="pull-right" style="margin-right:50%;margin-top: 20px;">
          ...
          <a onclick="openWindow(1000, 1000, 'https://codifaerp.isofterp.com/demo/articles/imprime?datedebut=<?php echo @$Date_debut; ?>&datefin=<?php echo @$Date_fin; ?>&commercial_id=<?php echo @$commercial_id; ?>')"><button class="btn btn-primary btn-sm">Imprimer</button></a>
      ...
      <div class="box">
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
              <tr>
                <td colspan="2" align="center"><strong>SOLDE</strong></td>
                <td colspan="4" align="center"><?php echo number_format(@$solde, 3, '.', ' '); ?></td>
              </tr>
              <?php
              $tot = 0;
              $totcr = 0;
                        ...
                        <tr>
                          <td width="40%" align="center">
                            ...
                            <?php if (@$rel['lignebonlivraison_id'] != 0) { ?>
                              Com BL <?php echo @$rel['numero']; ?><br><?php echo @$rel['arti']; ?>
                            <?php  } ?>
                            <?php if (@$rel['lignebonusmalu_id'] != 0) { ?>
                              Com Bonus/Malus <?php echo @$rel['num']; ?><br><?php echo @$rel['art']; ?>
                            <?php  } ?>
                          </td>
