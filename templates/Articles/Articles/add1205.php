                                            ...
                                            <tr class="tr" style="display: none !important">
                                                ...
                                                <td align="right">
                                                    ...
                                                    <div style="margin-top: 0,7% ;">
                                                        <?php echo $this->Form->control('unitearticle_id', array('empty' => 'Veuillez choisir !!', 'options' => $unitearticless, 'champ' => 'unitearticle_id', 'label' => '', 'name' => '', 'id' => '', 'table' => 'uaprincipals', 'index' => '', 'div' => 'form-group ', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'js-example-responsive form-control ')); ?>

                                                    </div>
                                                    <!-- <input table="uaprincipals" type="text" class="form-control" index="" name="" id="" champ="unite_id" value=""> -->
                                                </td>
                                                <td align="right">
