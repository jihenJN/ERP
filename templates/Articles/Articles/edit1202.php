            ...
            <div class="box ">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                            <div class="col-xs-6">
                                <div class="form-group input text required" id="divsoussous" <?php if ($article->sousfamille2_id != 0) { ?>>
                                ...
                                <div class="col-xs-6">
                                    <?php echo $this->Form->control('unite_id', ['options' => $unites, 'empty' => 'Veuillez choisir SVP !!', 'class' => 'form-control select2 control-label', 'label' => '
Unite contenance']); ?>
                                </div>
                                <div class=" col-xs-6">
                                    <?php echo $this->Form->control('unitearticle_id', ['label' => 'Unite article', 'options' => $unitearticles, 'empty' => 'Veuillez choisir !!', 'class' => ' form-control select2 control-label  calculprixarticle', 'id' => 'b', 'required' => 'off']); ?>
                                </div>
                            ...
                            <div class="row">
                                <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                    ...
                                    <div class="col-xs-6" id="nombrepiece" <?php if ($article->famille_id == 2) { ?> style='display:none' <?php } else { ?> style='display:true' <?php } ?>>
                                        ...
                                        <?php echo $this->Form->control('nombrepiece', ['type' => 'number', 'class' => 'form-control  control-label', 'label' => "Nombre de piÃƒÂ¨ces par carton:"]); ?>
                                    </div>
                                                            ...
                                                            ?>
                                                                <tr class=''>
                                                                    <td style="width: 8%;" align="center">
                                                                        ...
                                                                        ?>
                                                                        <div>
                                                                            <?php echo $this->Form->control('fournisseur_id', array('value' => $ca['fournisseur_id'], 'empty' => 'Veuillez choisir !!', 'options' => $frs, 'champ' => 'fournisseur_id', 'label' => '', 'name' => 'data[articlefr][' . $i . '][fournisseur_id]', 'id' => 'fournisseur_id' . $i, 'table' => 'articlefr', 'index' => $i, 'div' => 'form-group ', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control ')); ?>
                                                                        </div>
