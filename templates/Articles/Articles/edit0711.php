...
<!--                    <div id="fichetechnique"    
   ...
   <div class="col-md-12 ">
                            <div class="panel panel-default" >
                                ...
                                <thead>
                                                            <tr bgcolor="#EDEDED">
                                                <td width=""  align="center">Niveaux</td>
                                 ...
                                 <tbody>
                                   <tr class="traaa" style="display:none;" id="traaa"  champ='traaa' index="">
                                    ...
                                    <td> <?php  
                                        ...
                                        echo $this->Form->input('article_id', array('name' => '', 'label' => '', 'indexligne'=>'','index'=>'','table'=>'Ofsfligne','tableligne' => 'Phaseofsf', 'champ' => 'personnel_id','id'=>'article_id','div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => '','empty'=>'Veuillez Choisir !!',"style"=>"width:100% ; height:32px"));
                                            ?>                                    </td>
                                    <td>
                                  ...
                                  <tr class="traaa" style="display:none;" id="traaa"  champ='traaa' index="">
                                        ...
                                        <div class="panel panel-default" >
                                         ...
                                         <a class="btn btn-primary ajouterligne1ligne" tabletype='addtableaaligne'  indexlignetypeligne='indexaligne' trtypeligne="traaaligne" style="
                                    float: right; 
                                    position: relative;
                                    top: -25px;
                                        "><i class="fa fa-plus-circle"  ></i> </a>
                                 ...
                                 <tbody>
                                   <tr class="traaaligne" style="display:none;" id=""  champ='traaaligne' index="">
                                    ...
                                    <td> <?php  
                                        echo $this->Form->input('supp', array('name' => '','type'=>'hidden', 'label' => '', 'indexligneligne'=>'', 'indexligne'=>'','index'=>'','table'=>'Ofsfligne','tableligne' => 'Phaseofsf','tableligne' => 'Phaseofsfligne', 'champ' => 'supp','id'=>'supp','div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control'));
                                    ...
                                    <td>
                                     ...
                                     <td align="center"><i indexligneligne="" indexligne="" index="" class="fa fa-times supor1" style="color: #c9302c;font-size: 22px;"></td>
                                          ...
                                          <input type="text" value="0" class="" id="" champ="indexa" />
                                 </div>
                                  </div>
                                        </td>
                                 </tr>
...
<!--                                <tr > 
                               ...
                               <td align="left"> <?php 
                                                ...
                                                echo $this->Form->input('article_id',array('style'=>'width:250px','label' => '','id' => 'article_id0','label' => '', 'name' => 'data[Ofsfligne][0][article_id]','table'=>'Ofsfligne','champ'=>'article_id','index'=>'0','div'=>'form-group','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control  select' ,'empty'=>'Veuillez choisir')); ?></td>
                                   <td align="center"> <?php 
                                               echo $this->Form->input('qte',array('id' => 'qte0','label' => '', 'name' => 'data[Ofsfligne][0][qte]','table'=>'Ofsfligne','champ'=>'qte','index'=>0,'div'=>'form-group','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control comp' ) );
                                                echo $this->Form->input('qt',array('type'=>'hidden','id' => 'qt0','label' => '', 'name' => 'data[Ofsfligne][0][qt]','table'=>'Ofsfligne','champ'=>'qt','index'=>0,'div'=>'form-group','between'=>'<div class="col-sm-12">','after'=>'</div>','class'=>'form-control comp' ) ); ?></td>
                                          
                                                <td align="center"><i index="0"  class="fa fa-times supor" style="color: #c9302c;font-size: 22px;"></td>
                                            
</tr>  -->
<!--<tr   index="0" align="centre" > <td width='25%'></td><td champ="afef" class="afef" id="afef0" colspan="3"  index="0">
                                        <div class="panel panel-default" width="50%" >
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Article1'); ?></h3>
                                    <a class="btn btn-primary ajouterligne1 " table='addtableaa0' index ='0' indexligne='indexa0' tr="traa0" style="
                                    float: right; 
                                    position: relative;
                                    top: -25px;
                                ...
                                <thead>
                                                            <tr bgcolor="#EDEDED">
                                                                <td  align="center">Niveaux1</td>
                                                                <td  align="center">Qte1</td>
             ...
             <tr    class="traa0" style="display:none;" id="traa0" ondex="="0"> <td width='25%'></td><td champ="afefligne" class="afefligne" id="afefligne0-1" colspan="3"  index="0">
                                        <div class="panel panel-default" width="50%" >
                                <div class="panel-heading">
                                    <h3 class="panel-title"><?php echo __('Article2'); ?></h3>
              ...
              <input type="text" value="0" id="indexaligne0-1" />
</div>
                            </div>
                                        </td></tr>                          
