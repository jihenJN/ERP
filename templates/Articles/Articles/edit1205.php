                                            ...
                                            <tbody>
                                                ...
                                                foreach ($uaprincipals as $i => $res) :;  ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php echo $this->Form->control('unitearticle_id', ['class' => 'form-control  select2', 'value' => $res->unitearticle_id, 'empty' => 'Veuillez choisir !!', 'label' => '', 'required' => 'off', "style" => "width:100% ;"]); ?>
                                                        </td>
                                                        <td>
                                                ...
                                                <tr class="tr" style="display: none !important">
                                                    ...
                                                    <td align="right">
                                                        ...
                                                        <?php echo $this->Form->input('unitearticle_id', array('empty' => 'Veuillez choisir !!', 'options' => $unitearticles, 'champ' => 'unitearticle_id', 'label' => '', 'name' => '', 'id' => '', 'table' => 'uaprincipals', 'index' => '', 'div' => 'form-group ', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control ')); ?>
                                                    </td>
                                                    <td align="right">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <table class="table table-bordered table-striped table-bottomless" id="addtablea" style="width:100%" align="center" >
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr > 
                                                                <td align="left"> <?php
                                                                                    echo $this->Form->input('sup', array('name' => 'data[Ofsfligne][0][sup]', 'id' => '', 'champ' => 'sup', 'table' => 'Ofsfligne', 'index' => '0', 'type' => 'hidden', 'class' => 'form-control'));
