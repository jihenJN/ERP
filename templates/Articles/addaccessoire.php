                ...
                <div class="row" style="padding:3px">
                    ...
                    <div class="col-xs-6">
                        <div class="form-group input text required">
                            <?php echo $this->Form->control('typearticle_id', ['label' => 'Type Article', 'empty' => 'Veuillez choisir !!', 'options' => $typearticles, 'class' => 'form-control select2 control-label ', 'required' => false, 'id' => 'typearticle', 'disabled' => true]); ?>
                        </div>
                    ...
                    <div class="col-xs-6">
                        <div id="divselect" class="form-group input text required">
                            <?php echo $this->Form->control('article_id', ['label' => 'Article Parent', 'empty' => 'Veuillez choisir !!',  'class' => 'form-control select2 control-label ', 'required' => false, 'id' => 'artid', 'disabled' => true]); ?>
                        </div>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group input text required">
                            <?php echo $this->Form->control('famille_id', ['empty' => 'Veuillez choisir !!', 'options' => $familles, 'class' => 'form-control select2 control-label famille famille1', 'required' => false, 'id' => 'salma', 'disabled' => true]); ?>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group input text required" id="divsous">
                            <?php echo $this->Form->control('sousfamille1', ['id' => 'sous', 'name' => 'sousfamille1_id', 'empty' => 'Veuillez choisir !!', 'class' => 'form-control select2 control-label sousfamille1', 'required' => false, 'label' => 'Sous Famille', 'disabled' => true]); ?>
                        </div>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group input text">
                            <?php echo $this->Form->control('Code', ['label' => 'Code', 'id' => 'code', 'readonly' => true]); ?>
                        </div>
                    </div>
