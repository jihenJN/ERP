                ...
                <div class="box-body">
                       ...
                       <div class="row">
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                ...
                                <div class="col-xs-6">
                                    <?php echo $this->Form->control('Poids', ['readonly'=>'readonly','class' => 'form-control  control-label', 'label' => 'Poids net']); ?>
                                </div>
                            ...
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                ...
                                <div class="col-xs-6">
                                    <div class="form-group input text required" id="divsous">
                                        <?php echo $this->Form->control('sousfamille1_id', ['disabled'=>'true','id' => 'sous', 'name' => 'sousfamille1_id', 'empty' => 'Veuillez choisir SVP !!', 'class' => 'form-control select2 control-label sousfamille1', 'label' => 'Sous famille']); ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6">
                                    <?php echo $this->Form->control('contenance', ['readonly'=>'readonly','class' => 'form-control  control-label', 'label' => 'Contenance']); ?>
                                </div>
                            ...
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                <div class="col-xs-6">
                                    <div class="form-group input text required" id="divsoussous">
                                        <?php echo $this->Form->control('sousfamille_id', ['disabled'=>'true','value' => $article->sousfamille2_id, 'options' => $sousfamille2s, 'id' => 'sous', 'name' => 'sousfamille2_id', 'empty' => 'Veuillez choisir SVP !!', 'class' => 'form-control select2 control-label sousfamille1', 'label' => 'Sous famille 2']); ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-6">
                                    <?php echo $this->Form->control('unite_id', ['disabled'=>'true','options' => $unites, 'empty' => 'Veuillez choisir SVP !!', 'class' => 'form-control select2 control-label', 'label' => 'Unit̩s']); ?>
                                </div>
                    ...
                    <div class="col-md-12" id ="contenu_article" style="display:true;">
                        ...
                        <div class="row">
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                <div class="col-xs-6">
                                    <?php echo $this->Form->control('codeabr', ['readonly'=>'readonly','type' => 'hidden', 'label' => '', 'value' => str_replace(' ', '', $val), 'id' => 'codeabr', 'div' => 'form-group', 'between' => '<div class="col-sm-10">', 'after' => '</div>', 'class' => 'form-control ']); ?>
                                    <div class="form-group input text">
                                        <label>Code</label>
                                        <input readonly="readonly" maxlength="4" value="<?php echo $article->Code ?>" name="Code" type="tel" id="code" class="form-control">
                                    </div>
...
//debug($codeart);
                        ...
                        <div class="row">
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                ...
                                <div class="col-xs-6">
                                    <?php echo $this->Form->control('Dsignation', ['readonly'=>'readonly','label' => 'D̩signation', 'id' => 'Dsignation']); ?>
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <input readonly="true" value="<?php echo  sprintf('%0.3f', $article->Prix_LastInput)  ?>" placeholder="0.00" step="0.001" type="number" class="form-control calculprixarticle" name='Prix_LastInput' id="Prix_LastInput">
                        ...
                        <div class="row">
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                ...
                                <div class=" col-xs-6">
                                    <?php echo $this->Form->control('unitearticle_id', ['label' => 'Unit̩ article', 'disabled'=>'true','options' => $unitearticles, 'empty' => 'Veuillez choisir !!', 'class' => ' form-control select2 control-label  calculprixarticle', 'id' => 'b', 'required' => 'off']); ?>
                                </div>
                                ...
                                <div class=" col-xs-2 form-group input text required">
                                    <?php echo $this->Form->control('tva_id', ['disabled'=>'true','label' => ' Cat̩gorie Tva', 'options' => $tvas, 'empty' => 'Veuillez choisir !!', 'class' => ' form-control select2 control-label tva calculprixarticlee', 'id' => 'tvaselect', 'required' => 'off']); ?>
                                </div>
                                <div class="col-xs-2">
                                    <?php
// debug($article->tva->valeur);
                                    ...
                                    echo $this->Form->control('tva', ['disabled'=>'true','class' => 'form-control  control-label', 'label' => "Valeur TVA:", 'value' => $tva, 'readonly' => 'readonly', 'id' => 'tva']);
                                    ?>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                ...
                                <div class="col-xs-6">
                                    <?php echo $this->Form->control('nombrepiece', ['readonly'=>'readonly','type' => 'number', 'class' => 'form-control  control-label', 'label' => "Nombre de pi̬ces par carton:"]); ?>
                                </div>
                                ...
                                <div class="col-xs-6">
                                 ...
                                 <input readonly="readonly" value="<?php echo $article->poidsbrut ?>" placeholder="0.000" step="0.001" type="number" class="form-control" name='poidsbrut' id="poidsbrut">
                        ...
                        <div class="row">
                            ...
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                ...
                                <div class="col-xs-6">
                                    <?php echo $this->Form->control('nbpiecepalette', ['readonly'=>'readonly','type' => 'number', 'class' => 'form-control  control-label', 'label' => "Nombre de carton par palette:"]); ?>
                                </div>

                                <div class="col-xs-6">
                                    <?php echo $this->Form->control('remise', ['readonly'=>'readonly','class' => 'form-control  control-label', 'label' => "Remise %:"]); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                ...
                                <div class="col-xs-6">
                                    <?php echo $this->Form->control('nbjour', ['readonly'=>'readonly','type' => 'number', 'class' => 'form-control  control-label', 'label' => "Nombre de jour:"]); ?>
                                ...
                                <div class="col-xs-6">
                                    <?php echo $this->Form->control('nbpoint', ['readonly'=>'readonly','type' => 'number', 'class' => 'form-control  control-label', 'label' => "Nombre de points:"]); ?>
                        ...
                        <div class="row">
                            ...
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                ...
                                <div class="col-xs-6">
                                    <label> Image </label>
                                    <input disabled type="file" name="image_file" class="form-control" id="ArticleImage">
                                </div>


                                <div class="col-xs-6">
                                    <?php echo $this->Form->control('coefficient', ['readonly'=>'readonly','type' => 'number', 'class' => 'form-control  control-label', 'label' => "Coefficient:"]); ?>
                        ...
                        <div class="row">
                            ...
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                ...
                                <div class="col-xs-6">
                                    <?php echo $this->Form->control('famillerotation_id', ['disabled'=>'true','empty' => 'Veuillez choisir !!', 'options' => $famillerotations, 'class' => 'form-control select2 control-label', 'label' => "Famille rotation:"]); ?>
                                ...
                                <div style="margin-top:20px" class="col-xs-6">
                                    ...
                                    <input disabled  type="hidden" id="vente" name="vente" >
                                    <input disabled class="afficherfiche" type="checkbox" id="ventee" name="vente" value="1" <?php if ($article->vente == 1) { ?>   checked="true"    <?php } ?>>
                                </div>
                        ...
                        <div style="display:flex;">
                            ...
                            <div style="width:80%; margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                ...
                                Activ̩ <input disabled type="radio" name="etat" value="0" id="active" class="" style="margin-right: 20px" <?php if ($article->etat == 0) { ?> checked="checked" <?php } ?>>
                                D̩sactiv̩ <input disabled type="radio" name="etat" value="1" id="desactive" class="" <?php if ($article->etat == 1) { ?> checked="checked" <?php } ?>>
                                ...
                                OUI <input disabled type="radio" name="fodec" value="<?php echo $fodec ?>" id="OUI" class="calculprixarticle" style="margin-right: 20px" <?php if ($article->fodec != 0) { ?> checked="checked" <?php } ?>>
                                NON <input disabled type="radio" name="fodec" value="0" id="NON" class="calculprixarticle" <?php if ($article->fodec == 0) { ?> checked="checked" <?php } ?>>
                                ...
                                OUI <input disabled type="radio" name="TXTPE" value="<?php echo $tpe ?>" id="OUItpe" class="calculprixarticle" style="margin-right: 20px" class="" style="margin-right: 20px" <?php if ($article->TXTPE != 0) { ?> checked="checked" <?php } ?>>
                                NON <input disabled type="radio" name="TXTPE" value="0" id="NONtpe" class="calculprixarticle" <?php if ($article->TXTPE == 0) { ?> checked="checked" <?php } ?>>
                            ...
                            <div style=" margin: 0 auto;  margin-left: 20px; margin-right: 20px; position: static; ">
                                ...
                                <div class="col-xs-6">
                                    <div class="form-group input number">
                                        ...
                                        <input readonly="true" value="<?php echo $article->prixttc ?>" style="color:rgb(255, 0, 0);height: 80px;font-size:40px;width:50%;text-align:center" readonly='readonly' type="text" name="prixttc" id="prixttc">
...
<!--                        <div align="center" style="display:none;"class="row famille1" id="qteminmax">-->
                  <div id="qteminmax"  class="col-md-12 row famille1" <?php if ($article->famille_id == 1) { ?> style='display:true' <?php } ?>    <?php if ($article->famille_id == 0) { ?> style='display:none' <?php } ?>>
                                ...
                                foreach ($seuil as $s) :
                                    ...
                                    <tr style="height:20px">
                                        ...
                                        <td style="text-align: center;">
                                            <input readonly="true" id="<?php echo "min" . $i ?>" index="<?php echo $i ?>" value="<?php echo $s->min ?>" style="height:30px;width:80px" name="<?php echo 'data[seuil][' . $i . '][minimum]' ?>" type="number" class=" seuil form-control">
                                            <input readonly="true" name="<?php echo 'data[seuil][' . $i . '][id]' ?>" value="<?php echo $s->id ?>" style="height:30px;width:80px" table="quantite" type="hidden" class="form-control">


                                        </td>

                                        <td style="text-align: center;">
                                            <input readonly="true" id="<?php echo "max" . $i ?>" index="<?php echo $i ?>" name="<?php echo 'data[seuil][' . $i . '][maximum]' ?>" value="<?php echo $s->max ?>" style="height:30px;width:80px" table="quantite" type="number" class=" seuil form-control">
                                        </td>

                                        <td style="text-align: center;">
                                            <input readonly="true" id="<?php echo "alert" . $i ?>" index="<?php echo $i ?>" name="<?php echo 'data[seuil][' . $i . '][alert]' ?>" value="<?php echo $s->alert ?>" style="height:30px;width:80px" table="quantite" type="number" class=" seuil  form-control">
                                        </td>
                                ...
                                if ($i != 12) {
                                    for ($jj = $fin; $jj <= 12; $jj++) {
                                        ...
                                        <tr style="height:20px">
                                            ...
                                            <td style="text-align: center;">
                                                <input readonly="true" style="height:30px;width:80px" index="<?php echo $jj ?>" name="<?php echo 'data[seuil][' . $jj . '][minimum]' ?>" type="number" class="seuil form-control" name="" id="min1">
                                            </td>

                                            <td style="text-align: center;">
                                                <input readonly="true" style="height:30px;width:80px" index="<?php echo $jj ?>" name="<?php echo 'data[seuil][' . $jj . '][maximum]' ?>" type="number" class="seuil form-control" name="" id="max1">
                                            </td>

                                            <td style="text-align: center;">
                                                <input readonly="true" style="height:30px;width:80px" index="<?php echo $jj ?>" name="<?php echo 'data[seuil][' . $jj . '][alert]' ?>" type="number" class="seuil form-control" name="" id="alert1">
                                            </td>
...
<?php endforeach; ?>
        ...
        <?php //foreach ($objectifrepresentants as $obj) :          ?>
                                            ...
                                            <td style="width: 10px;">
                                                <input readonly="true" value="<?php echo $mm->id ?>" id="<?php echo "mois" . $i ?>" index="<?php echo $i ?>" name="<?php echo 'data[objectifrep][' . $i . '][mois]' ?>" style="height:30px;width:50px" type="hidden" class="form-control">




                                                <input readonly="true"  value="<?php echo $s->id ?>" id="<?php echo "commercial" . $i ?>" index="<?php echo $i ?>" name="<?php echo 'data[objectifrep][' . $i . '][commercial]' ?>" style="height:30px;width:50px" type="hidden" class="form-control">


                                                <input readonly="true" <?php { ?> value="<?php echo @$tab[@$s->id][$mm->id] ?>" <?php } ?> id="<?php echo "objectif" . $i ?>" index="<?php echo $i ?>" name="<?php echo 'data[objectifrep][' . $i . '][objectif]' ?>" style="height:35px;width:80px" type="number" class="form-control">
                                            </td>
                                            <?php // } 
                                            ?>
                                            <?php //$i++ 
...
<?php echo $comm; ?>
                        <div id="fiche"  class="col-md-12 " <?php if ($article->famille_id == 1 && $comm == 0) { ?> style='display:true' <?php } ?>    <?php if ($article->famille_id == 0) { ?> style='display:none' <?php } ?>>
                                            ...
                                            foreach ($dat as $fech) {
                                                ...
                                                <tr > 
                                                    ...
                                                    <td align="left"> <?php
                                                        ...
                                                        echo $this->Form->input('article_id', array('disabled'=>'true','value' => $fech['article_id'], 'style' => 'width:250px', 'label' => '', 'id' => 'article_id' . $i, 'label' => '', 'name' => 'data[Ofsfligne][' . $i . '][article_id]', 'table' => 'Ofsfligne', 'champ' => 'article_id', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control  select', 'empty' => 'Veuillez choisir'));
                                                        ?></td>
                                                    <td align="center"> <?php
                                                        echo $this->Form->input('qte', array('readonly'=>'readonly','value' => $fech['qte'], 'id' => 'qte' . $i, 'label' => '', 'name' => 'data[Ofsfligne][' . $i . '][qte]', 'table' => 'Ofsfligne', 'champ' => 'qte', 'index' => $i, 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control comp'));
                                                        ?></td>
    ...
    <?php foreach ($fech['Ligne'] as $j => $fech1) { ?>  
                                                                            <tr>
                                                                                <td> 
                                                                                    ...
                                                                                    echo $this->Form->input('article_id', array('disabled'=>'true','value' => $fech1['article_id'], 'name' => 'data[Ofsfligne][' . $i . '][Phaseofsf][' . $j . '][article_id]', 'label' => '', 'indexligne' => $j, 'index' => $i, 'table' => 'Ofsfligne', 'tableligne' => 'Phaseofsf', 'champ' => 'article_id', 'id' => 'article_id' . $i . '-' . $j, 'indextype' => '', 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control', 'empty' => 'Veuillez Choisir !!'));
                                                                                    ?>                                    </td>
                                                                                <td> <?php
                                                                                    echo $this->Form->input('qte', array('readonly'=>'readonly','value' => $fech1['qte'], 'name' => 'data[Ofsfligne][' . $i . '][Phaseofsf][' . $j . '][qte]', 'label' => '', 'indexligne' => $j, 'index' => $i, 'table' => 'Ofsfligne', 'tableligne' => 'Phaseofsf', 'champ' => 'qte', 'id' => 'qte' . $i . '-' . $j, 'indextype' => '', 'div' => 'form-group', 'between' => '<div class="col-sm-12">', 'after' => '</div>', 'class' => 'form-control '));
                                                                                    ?> 
                                                                                </td>
