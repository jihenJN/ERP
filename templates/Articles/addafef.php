                        ...
                        <div class="tab-content active" id="articles">
                                ...
                                <div
                                    ...
                                    <div class="col-xs-6">
                                        <div class="form-group input text required">
                                            <?php echo $this->Form->control('famille_id', ['empty' => 'Veuillez choisir SVP !!', 'options' => $familles, 'class' => 'form-control select2 control-label famille famille1 choix', 'id' => 'salma']); ?>
                            ...
                            <div class="row">
                                ...
                                <div style="display:flex;">
                                        ...
                                        <div style="display:flex;" id='coutcout' hidden>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('.famille1').on('change', function () {
            ...
            if (id == 1 || id ==4) {
                $('#coutcout').attr('style', "display:false;");
            }else{
                $('#coutcout').attr('style', "display:true;");
