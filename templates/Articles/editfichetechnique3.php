    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box ">
                ...
                <div class="box-body">
                    <!-- fichearticle2s -->
                    <!-- <div align="center" class="row " style="display:;" id="showhide00">
                            <strong style="font-size: 20px ;"> Fiche technique</strong>
                            <i class="fa fa-eye-slash HideShow00  text-blue"></i>

                        </div> -->
                    <?php if ($article['dateft3']) {
                        # code...
                        ?>
                        <div align="center">
                            <h4 style="   color: crimson;"> Cette fiche technique a été modifiée à la date
                                <?php echo $article['dateft3']->format("Y-m-d H:i:s") ?> depuis la fiche technique de
                                l'article <?php echo $article['Dsignation'] ?> </h4>
                        </div>
                        <br>
                    <?php } ?>
                    <div class="row">
                        <div class="col-xs-6 ">
                            <?php echo $this->Form->control('commentaire3', ['class' => 'form-control  control-label', 'type' => "textarea", 'label' => 'Commentaire']); ?>
                                ...
                                <table class="table table-bordered table-striped table-bottomless" id="addtablea"
                                    ...
                                    <thead>
                                        <tr bgcolor="#EDEDED">
                                            ...
                                            <td hidden width="" align="center" id='tdcomp' hidden>Coefficient</td>
