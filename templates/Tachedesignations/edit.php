...
<section class="content-header">
    ...
    <td colspan="3">
        <div style="float: left;font-size: 12px;margin-left:10px;"><strong> Modifier Taches</strong></div>
            ...
            <div class="box ">
                ...
                <div class="box-body" style="font-size: 12px;">
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <?php echo $this->Form->control('name', ['style' => 'font-size: 12px;', 'id' => 'name', 'style' => 'font-size: 12px;', 'label' => 'Nom']); ?>
                        </div>
                    </div>
