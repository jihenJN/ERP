                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="pull-right" style="margin-right:50%;margin-top: 20px;">
                            <button type="submit" style="background-color: #bdb76b ;border:#bdb76b;" class="btn btn-primary  alertHisto" id="">Afficher</button>

                            <?php
                            //debug($count);
                            if ($count != 0) {
                            ?>
                                <a onclick="openWindow(1000, 1000, wr+'reglementclients/impetatimpaye?echance=<?php echo @$echance;  ?>&clientid=<?php echo @$clientid; ?>&endosse=<?php echo @$endosse;  ?>&echance2=<?php echo @$echance2;  ?>&etat_id=<?php echo @$etat_id;  ?>')"><button class="btn btn-primary " style="background-color: #bdb76b ;border:#bdb76b;">Imprimer</button></a>
                            <?php }
                            ?>
                            <?php echo $this->Html->link(__('Actualiser'), ['action' => '/etatimpaye'], ['style' => 'background-color: #bdb76b ;border:#bdb76b;', 'class' => 'btn btn-primary']) ?>
                ...
                <div class="box-body">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        <tr style="background-color: #bdb76b;">
                            ...
                            <th width="9%" class="actions text-center"><?php echo ('Etat'); ?></th>
                        ...
                        <tr>
                            <td align="center" colspan="1" style="background-color: #bdb76b;">
                                <strong><?php echo 'TOTAL SOGEM SIEGE'; ?></strong>
                            </td>
                            <td align="center" colspan="1" style="background-color: #8fbc8f;">
