                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <input type="checkbox" name="data[Lignereglementclient][<?php echo $i; ?>][bonreception_id]" id="facture_id<?php echo $i; ?>" index="<?php echo $i; ?>" class="afficheinputmontantreglementclient chekreglementfac calculmontantt" value="<?php echo $livraison->id ?>" mnttounssi="<?php echo $livraison->totalttc; ?>" mnt="<?php echo $reste; ?>">
                                                    ...
                                                    <?php if ($type == 2) { ?>
                                                        ...
                                                        ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="checkbox" name="data[Lignereglementclient][<?php echo $i; ?>][client_id]" id="facture_id<?php echo $i; ?>" index="<?php echo $i; ?>" class=" afficheinputmontantreglementclient chekreglementfac calculmontantt" value="<?php echo $compte->id ?>" mnttounssi="<?php echo $compte->soldedebut; ?>" mnt="<?php echo $reste; ?>" compte="">
                                                        ...
                                                        ?>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <input type="checkbox" name="data[Lignereglementclient][<?php echo $i; ?>][factureclient_id]" id="facture_id<?php echo $i; ?>" index="<?php echo $i; ?>" class=" afficheinputmontantreglementclient chekreglementfac calculmontantt" value="<?php echo $fac->id ?>" mnttounssi="<?php echo $fac->totalttc; ?>" mnt="<?php echo $reste; ?>" compte="">
                                                                ...
                                                                foreach ($factureavoirs as $facav) {
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <input type="checkbox" name="data[Lignereglementclient][<?php echo $i; ?>][factureclientav_id]" id="facture_id<?php echo $i; ?>" index="<?php echo $i; ?>" class=" afficheinputmontantreglementclient chekreglementfac calculmontantt" value="<?php echo $facav->id ?>" mnttounssi="<?php echo -$facav->totalttc; ?>" mnt="<?php echo -$reste; ?>" compte="">

                                                                                <?php
                                                                                echo $this->Form->input('Montanttt', array('value' => -$reste, 'style' => 'display:none', 'index' => $i, 'name' => 'data[Lignereglementclient][' . $i . '][Montanttt]', 'id' => 'Montantregler' . $i, 'label' => '',  'type' => 'text', 'class' => 'form-control testmontantreglementclient  chekreglementfac checkmaxfac number calculmontantt '));
                                                                                ?>
...
<script>
    ...
    function toggleCheckboxes(state) {
        var checkboxes = document.querySelectorAll('.afficheinputmontantreglementclient.chekreglementfac.calculmontantt');
    ...
    document.getElementById('cocherTout').addEventListener('click', function(event) {
        ...
        $('.afficheinputmontantreglementclient.chekreglementfac.calculmontantt').click(); // Déclencher l'événement de clic sur les cases à cocher
