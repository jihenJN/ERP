...

{
    ...
    public function getids()
    {
        ...
        foreach ($bonlivraison as $bb) {
            ...
            $connection->execute("INSERT INTO factureclients (numero, date, client_id, depot_id, totalht, totaltva, totalfodec, totalremise, totalttc, observation, user_id, totalputtc ,timbre,bonlivraison_id,type) 
                VALUES ($numero, '$date', $client_id, $depot_id, $totalht, $totaltva, $totalfodec, $totalremise, $totalttc, '$observation', $user_id, $totalputtc ,$timbre,$bonlivraison_id,$type)");
