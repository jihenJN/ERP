...
//                ->where(['Delegations.id  in (' . $tab . ')']);
        ...
        $this->set(compact('pays','clientdoc'  , 'articless', 'bureaupostes', 'cli', 'ar', 'localite', 'deleg', 'gouvernorats', 'type', 'tab', 'articles', 'clientarticles', 'exoner', 'gouvernorats', 'pointdeventes', 'typeclients', 'client', 'commercials', 'gouvernorats', 'typeexonerations', 'paiements', 'adressees', 'responsable', 'banquess', 'banques'));
    }

    public function index() {
        $Gouvernoratoptions = $this->fetchTable('Gouvernorats')->find('list', ['keyfield' => 'id', 'valueField' => 'name']);
        $typeclients = $this->fetchTable('Typeclients')->find('list', ['keyfield' => 'id', 'valueField' => 'type']);
        ...
        $typeclient_id = $this->request->getQuery('typeclient_id');
        ...
        if ($typeclient_id) {
            $cond99 = 'Clients.typeclient_id =' . $typeclient_id . '';
            //debug($cond88);die;
        }
        $query = $this->Clients->find('all')->where([$cond1, $cond2, $cond3, $cond4, $cond5, $cond6, $cond88,$cond99]);
        ...
        $this->set(compact('etats', 'clients', 'Gouvernoratoptions','typeclients'));
    }
...
//    }
    ...
    public function add() {
        ...
        ///debug($this->request->getData());
            //die;
            //$c = $this->Clients->get($this->request->getData('inserted'));
            //debug($c);die;
//            $c->etat = 'TRUE';
//            $this->Clients->save($c);
...
//debug($tab);
        ...
        $pays = $this->fetchTable('Pays')->find('list', ['keyfield' => 'id', 'valueField' => 'name']);
        $this->set(compact('pays','client', 'cli', 'ar', 'articles', 'type', 'delegations', 'localites', 'commercials', 'gouvernorats', 'typeexonerations', 'banques', 'paiements', 'typeclients', 'pointdeventes', 'bureaupostes'));
    }
...
//                ->where(['Delegations.id  in (' . $tab . ')']);
        ...
        $this->set(compact('gouvp','pays','clientdoc','articless', 'bureaupostes', 'cli', 'ar', 'localite', 'deleg', 'gouvernorats', 'type', 'tab', 'articles', 'clientarticles', 'exoner', 'gouvernorats', 'pointdeventes', 'typeclients', 'client', 'commercials', 'gouvernorats', 'typeexonerations', 'paiements', 'adressees', 'responsable', 'banquess', 'banques'));
    }
