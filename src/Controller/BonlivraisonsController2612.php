...
// die;
        ...
        $this->set(compact('exotva', 'exotpe', 'exofodec', 'clientc', 'lignebonlivraisons', 'articles', 'bonlivraison', 'clients', 'depots', 'materieltransports', 'cartecarburants', 'chauffeurs', 'conffaieurs', 'adresselivraisonclients'));
    }
...
//            debug($tab);
        ...
        $this->set(compact('commercials', 'tab', 'commercial', 'exotpe', 'exotva', 'exofodec', 'exotimbre', 'bonus', 'type', 'clientc', 'lignebonlivraisons', 'articles', 'bonlivraison', 'clients', 'depots', 'materieltransports', 'cartecarburants', 'chauffeurs', 'conffaieurs', 'adresselivraisonclients'));
    }
...
//$convoyeurs = $this->Bonlivraisons->Convoyeurs->find('list', ['limit' => 200]);
        ...
        $articles = $this->fetchTable('Articles')->find('all')->where(["Articles.vente " => 1]);
        $this->set(compact('exotva', 'exofodec', 'exotpe', 'tab', 'bonus', 'commercial', 'clientc', 'lignecommandes', 'commande', 'mm', 'articles', 'bonlivraison', 'clients', 'depots', 'materieltransports', 'cartecarburants', 'chauffeurs', 'conffaieurs', 'factureclients', 'adresselivraisonclients'));
    }
