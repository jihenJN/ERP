...
//echo $condliv777. $condliv6. $condliv1. $condlivart;
                $lignelivraison = $this->fetchTable('Lignelivraisons')->find('all', [
                    'contain' => ['Livraisons'],
                ])->where([$condliv777, $condliv6, $condliv1, $condlivart])->first();
       ...
       // echo $condliv777. $condliv2. $condliv3. $condlivart; 
            ...
            ])->where([$condliv777, $condliv2, $condliv3, $condlivart]);
            ...
            foreach ($ligneblachat as $l) {
                ...
                $tablignelivrisons['ptot'] = $l['livraison']['ht'];
            ...
            foreach ($lignebl as $l) {
                ...
                /// $tablignelivrisons['client'] = $client ;
                $tablignelivrisons['date'] = $l['bonlivraison']['date'];
                $tablignelivrisons['type'] = "Bon reservation";
            ...
            $ligneinv = $this->fetchTable('Ligneinventaires')->find('all', [
                ...
                ->select([
                    "qte" =>
                    'SUM(Ligneinventaires.qteStock)', "inventaire_id" => 'Ligneinventaires.inventaire_id',
                    "date" =>
                    '(Inventaires.date)', "inventaire_id" => 'Ligneinventaires.inventaire_id',
                    "article" =>
                    '(Articles.Dsignation)', "inventaire_id" => 'Ligneinventaires.inventaire_id',
                    "numero" =>
                    '(Inventaires.numero)', "inventaire_id" => 'Ligneinventaires.inventaire_id'
                ]);
    ...
    public function index()
    {
        ...
        $this->set(compact('articles', 'familles', 'sousfamille2s', 'sousfamille1s'));
    }
    ...
    public function add()
    {
        ...
        $clients = $this->fetchTable('Clients')->find('all');
        $unitearticless = $this->fetchTable('Unitearticles')->find('list', ['keyfield' => 'id', 'valueField' => 'name']);
        $this->set(compact('clients', 'clientt', 'unitearticless', 'articles', 'frs', 'devices', 'charges', 'famillerotations', 'commercials', 'mois', 'unitearticles', 'tpe', 'unites', 'article', 'familles', 'sousfamille2s', 'sousfamille1s', 'codepays', 'codeproducteur', 'val', 'tvas', 'fodec'));
    }
