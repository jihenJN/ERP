 ...
 */
    ...
    public function edit($id = null)
    {
        ...
        $adresse = $adresses->adresse;
        /******************************************************** */
        $this->set(compact('bonlivraison', 'adresse', 'typeclientname', 'typeclientid', 'lignebloc', 'lignereglements', 'clientc', 'encours', 'solde', 'echancierebl', 'echanciere', 'lignereglementcmds', 'etattransports', 'piecereglementclientoffres', 'banques', 'caisses', 'valeurs', 'paiements', 'piecereglementclients', 'champ', 'BL', 'gs', 'not', 'remes', 'remcli', 'es', 'rz', 'cl', 'typecl', 'exotva', 'exofodec', 'exotimbre', 'exotpe', 'clientc', 'lignecommandes', 'commande', 'depots', 'clients', 'commercials', 'articles', 'timbre', 'pointdeventes', 'escompte', 'type'));
    }
    ...
    public function addcommande($tab = null)
    {
                ...
                if (isset($this->request->getData('data')['ligner']) && (!empty($this->request->getData('data')['ligner']))) {
                    ...
                    foreach ($this->request->getData('data')['ligner'] as $i => $l) {
                        ...
                        if ($l['sup'] != 1) {
                            ...
                            $lignecommande->puttcapr = $l['puttcapr'];
                            $lignecommande->ttchidden = $l['ttchidden'];
                            //  $tab['remisearticle'] = $l['remisearticle'];
       ...
       /********************************************************************** */
        ...
        $this->set(compact('etattransports','lignebloc','typeclientname','typeclientid','adresse', 'echanciere', 'encours', 'solde', 'echancierebl', 'piecereglementclientoffres', 'banques', 'piecereglementclients', 'caisses', 'valeurs', 'paiements', 'cl', 'escompte', 'exotva', 'exofodec', 'exotpe', 'bonus', 'clientc', 'dates', 'commande', 'bonlivraison', 'lignebonlivraisons', 'mm', 'articles', 'commercials', 'clients', 'depots', 'es', 'rz', 'typecl', 'remcli', 'not'));
    }
