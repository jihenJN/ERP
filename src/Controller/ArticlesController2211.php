...
class ArticlesController extends AppController {
    ...
    public function indexarticle() {
        ...
        $cond4 = "Articles.vente = 1";
        $query = $this->Articles->find('all')->where([$cond1, $cond2, $cond3, $cond4]);
        //debug($query);
...
//$articles=$this->Articles->find('list',['keyfield' => 'id', 'valueField' => 'Dsignation'])->where(['Articles.vente=0']);
    ...
    public function getquantite() {
        ...
        $res = $this->prixspeciale($idClient, $articleid);
        // debug($res);
//
...
//        ]);
        ...
        echo json_encode(array("qtestockx" => $qtestock, "ligne" => $res,'donnearticle'=>$donnearticle, "success" => true));
    ...
    public function verif() {
        ...
        $articlelivs = $this->fetchTable('Lignebonlivraisons')->find('all')->where(['Lignebonlivraisons.article_id=' . $id])->count();
        $articlefacts = $this->fetchTable('Lignefactureclients')->find('all')->where(['Lignefactureclients.article_id=' . $id])->count();
