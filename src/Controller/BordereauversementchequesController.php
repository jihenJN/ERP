...
class BordereauversementchequesController extends AppController
{
    ...
    public function index($type = null)
    {
        ...
        $query = $this->Bordereauversementcheques->find('all')->where([$cond1, $cond2, $cond3, $condtyp,$cond4,$cond5])->order(['Bordereauversementcheques.numero' => 'ASC']);
    ...
    public function add($type = null, $compte_id = null, $date = null, $datefin = null, $dateimp = null)
    {
        ...
        $numero = $this->Bordereauversementcheques->find()->select(["numero" =>
        'MAX(Bordereauversementcheques.numero)'])->where(['Bordereauversementcheques.type=' . $type])
            ->first();
