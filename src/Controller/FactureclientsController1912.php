...
class FactureclientsController extends AppController
{
    ...
    public function addfacture($tab = null)
    {
        ...
        $this->set(compact('exotpe', 'exotva', 'exofodec', 'exotimbre', 'client', 'timbre', 'bonlivraison', 'lignebonlivraisons', 'mm', 'articles', 'factureclient', 'clients', 'pointdeventes', 'depots', 'materieltransports', 'cartecarburants', 'chauffeurs', 'conffaieurs', 'adresselivraisonclients'));
    }
    ...
    public function view($id = null)
    {
        ...
        $this->set(compact('exotimbre', 'exotpe', 'exofodec', 'exotva', 'client', 'lignefactureclients', 'articles', 'factureclient', 'clients', 'pointdeventes', 'depots', 'materieltransports', 'cartecarburants', 'chauffeurs', 'conffaieurs', 'adresselivraisonclients'));
    }
    ...
    public function delete($id = null)
    {
        ...
        foreach ($lignefactureclients as $l) {
            $this->fetchTable('$lignefactureclients')->delete($l);
        }
