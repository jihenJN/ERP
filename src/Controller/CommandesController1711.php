...
$dett= substr($det1,1);
        ...
        $query = $this->Commandes->find('all')->where([$cond2, $cond3, $cond4, $cond5, $cond6, $cond7])->order(['Commandes.id' => 'DESC']);
     //  debug($query);die;
        $this->paginate = [
        ...
        $this->set(compact('zones', 'clients', 'commandes', 'commercials', 'clientsoptions', 'commercialsoptions', 'numero', 'client_id', 'commercial_id'));
    }
