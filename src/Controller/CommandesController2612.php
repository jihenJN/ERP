...
//    }
    ...
    public function view($id = null) {
        ...
        $this->set(compact('clientc', 'exotva', 'exofodec', 'exotimbre', 'exotpe', 'lignecommandes', 'commande', 'depots', 'clients', 'commercials', 'articles', 'timbre', 'pointdeventes'));
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $this->set(compact('exotva', 'exofodec', 'exotimbre', 'exotpe', 'clientc', 'lignecommandes', 'commande', 'depots', 'clients', 'commercials', 'articles', 'timbre', 'pointdeventes', 'escompte'));
    }
...
//                              debug($l['ttc']);
        ...
        $clients = $this->fetchTable('Commandes')->Clients->find('list', ['keyfield' => 'id', 'valueField' => 'Raison_Sociale'])->where(["Clients.etat " => 'TRUE']);
        $commercials = $this->fetchTable('Commandes')->Commercials->find('list', ['keyfield' => 'id', 'valueField' => 'name']);
...
$escompte = $esCompte->escompte;
        ...
        $this->set(compact('escompte','exotva', 'exofodec', 'exotpe', 'bonus', 'clientc', 'dates', 'commande', 'bonlivraison', 'lignebonlivraisons', 'mm', 'articles', 'commercials', 'clients', 'depots'));
    }
