...
//dd($ligneplancommercial);
    ...
    //  $depots = $this->Plancommercialindustriels->Depots->find('list', ['limit' => 200])->all();
        ...
        $this->set(compact('plancommercialindustriel', 'mm', 'mois', 'moisdu', 'moisau'));
    }
        ...
        $besoinprodtheoperiode = 0;
            ...
            $qtem3 = $besoinprodtheoperiode + $vent1 + $vent2 + $vent3;
              if($qtprodpratique>0)  {
                ...
                //debug($historiquearticles->toArray());
        }
...
$res =  $res . "<tr>";
    ...
    //$res = $res . "<td><input   id='lancerpdp$i'  value='" . $ch . "' name=data[Pci][" . $i . "][lancerpdp] class='form-control' ></td>";
            $res = $res . " <td ><select style='width:80px!important;' id='lancerpdp$i' class='form-control' name=data[Pci][" . $i . "][lancerpdp] >
                                    <option style='width:50%!important;' value='oui' " . ($pc->qtprodpratique > 0 ? "selected='selected'" : "") . " >oui</option>
                                    <option style='width:50%!important;' value='non' " . ($pc->qtprodpratique < 0 ? "selected='selected'" : "") . " >non</option>
                                </select></td>";

                        $res = $res . "<td ><input style='width:80px!important;' value='" . $pc->rang. "' name=data[Pci][" . $i . "][rang] class='form-control '></td>";
