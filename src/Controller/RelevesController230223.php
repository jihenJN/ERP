...
//                }
               ...
               /// debug($lignereglementclients);

                if (@$detailid != 2) {
                    if (!empty($lignereglementclients)) {
                        $nn = "";
                        //$liste=$liste."<br>";
                        //debug($lignereglementclients);die;
                        foreach ($lignereglementclients as $k => $ligne) {
                            if (!empty($ligne->factureclient_id)) {
...
//            }
        ...
        @$this->set(compact('relefescount','details', 'relefes', 'soldeint', 'solde', 'clientid', 'c5', 'c4', 'c3', 'c2', 'c1', 'piecereglements', 'factureavoirs', 'bonlivraisons', 'factureclients', 'reglementlibres', 'articles', 'clients', 'personnels', 'exercices', 'exerciceid', 'date1', 'clientid', 'marque_id', 'date2', 'name','countt'));
    }
