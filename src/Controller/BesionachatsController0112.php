...
class BesionachatsController extends AppController
{
    ...
    public function view($id = null)
    {
        ...
        $personnels = $this->fetchTable('Personnels')->find('list', ['keyfield' => 'id', 'valueField' => 'nom']);
        $art = $this->fetchTable('Articles')->find('list', ['keyfield' => 'id', 'valueField' => 'Dsignation']);
       ...
       $articles = $this->fetchTable('Articles')->find('all', ['keyfield' => 'id', 'valueField' => 'Dsignation']);
        $this->set(compact('besionachat','lignebesionachats','art','personnels','articles'));
    }
    ...
    public function add()
    {
        ...
        $num = $this->Besionachats->find()->select(["num" =>
        'MAX(Besionachats.numero)'])->first();
       ...
       $articles = $this->fetchTable('Articles')->find('all', ['keyfield' => 'id', 'valueField' => 'Dsignation'])->where(["Articles.famille_id =2"]);
        ...
        $this->set(compact('besionachat','mm','articles','personnels'));
    }
