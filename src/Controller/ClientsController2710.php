...
class ClientsController extends AppController {
    ...
    public function index() {
        $Gouvernoratoptions = $this->Clients->Gouvernorats->find('list', ['keyfield' => 'id', 'valueField' => 'name']);
...
//                ->where(['Delegations.id  in (' . $tab . ')']);
        ...
        $this->set(compact('bureaupostes', 'ar','localite', 'deleg', 'gouvernorats', 'type', 'tab', 'articles', 'clientarticles', 'exoner', 'gouvernorats', 'pointdeventes', 'typeclients', 'client', 'commercials', 'gouvernorats', 'typeexonerations', 'paiements', 'adressees', 'responsable', 'banquess', 'banques'));
...
//debug($tab);
        ...
        $this->set(compact('client', 'articles', 'ar','type', 'delegations', 'localites', 'commercials', 'gouvernorats', 'typeexonerations', 'banques', 'paiements', 'typeclients', 'pointdeventes', 'bureaupostes'));
    }
