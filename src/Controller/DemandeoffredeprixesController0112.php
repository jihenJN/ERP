...
class DemandeoffredeprixesController extends AppController
{
    ...
    public function view($typeof=null,$id = null)
    {
        ...
        $typeof=$demandeoffredeprix->typeoffredeprix;
        ...
        $this->set(compact('lignefs', 'ligneas', 'demandeoffredeprix','typeof'));
    }
    ...
    public function add($typeof = null)
    {
        ...
        $fournisseurs = $this->Demandeoffredeprixes->Fournisseurs->find('list', ['keyfield' => 'id', 'valueField' => 'name']);
        $articles = $this->Demandeoffredeprixes->Articles->find('list', ['keyfield' => 'id','valueField' => function ($article) {return $article->Code . ' (' . $article->Dsignation . ')';}])->where(['Articles.famille_id != 1']);
        $this->set(compact('demandeoffredeprix', 'fournisseurs', 'articles','typeof'));
    }
    ...
    public function edit($typeof = null,$id = null)
    {
        ...
        ])->where(['Articles.famille_id != 1']); // ->where(["Articles.vente =0" ])
        // ;
        ...
        $this->set(compact('ligneas', 'lignefs', 'demandeoffredeprix', 'articles', 'fournisseurs','typeof'));
    }

    

    public function adddemande($tab = null)
    {
        $this->loadModel('Fournisseurs');
        ...
        $demandeoffredeprix = $this->Demandeoffredeprixes->newEmptyEntity();
        $typeof=1;
        $besoin = $this->fetchTable('Besionachats')->find('all')->where(['Besionachats.id' => $tab])->first();
        ...
        $lignes = $this->fetchTable('Lignebesionachats')->find('all', [

            'contain' => [
                'Articles'
            ]
        ])
            ->where(['besionachat_id' => $tab]);
        ...
        $this->set(compact('demandeoffredeprix', 'besoin', 'lignes',  'articles', 'fournisseurs','typeof'));
    }
    /**
     * Delete method
     *
