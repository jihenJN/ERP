...

{
    ...
    public function imprimelistebl($id = null)
    {
        ...
        $query = $this->Bonlivraisons->find('all')->where([$condtype, $conditions,$condcommercial])->order(['Bonlivraisons.id' => 'DESC']);
        $this->paginate = [
            'contain' => [],
        ];
    ...
    public function listeoffreprix()
    {
        ...
        $offprix1 = $this->fetchTable('Bonlivraisons')->find('all')->where(['typebl' => 2, $conditions,$condcommercial])->contain(['Clients', 'Commercials'])->order(['Bonlivraisons.id' => 'DESC'])->ToArray();
    ...
    public function listebl()
    {
        ...
        $offprix1 = $this->fetchTable('Bonlivraisons')->find('all')->where(['typebl' => 1, $conditions,$condcommercial])->contain(['Clients', 'Commercials'])->order(['Bonlivraisons.id' => 'DESC'])->ToArray();
        // debug($offprix1->ToArray());
        $clients = $this->fetchTable('Clients')->find('list', [
            'keyField' => 'id',
            'valueField' =>  function ($art) {
    ...
    public function index($type = null)
    {
        ...
        $query = $this->Bonlivraisons->find('all')->where([$condtyp, $cond1, $cond2, $cond3, $cond4, $cond6, $cond7, $cond8, $cond9, $cond10, $cond11, $cond12,$condcommercial])->order(['Bonlivraisons.id' => 'DESC'])->contain(['Clients', 'Depots', 'Personnels', 'Commercials']);
    ...
    public function view($id = null)
    {
        ...
        $this->set(compact('agents','typetransports','piecereglementclients', 'paiements', 'valeurs', 'caisses', 'banques', 'BL', 'not', 'gs', 'cl', 'commercials', 'tab', 'commercial', 'exotpe', 'exotva', 'exofodec', 'exotimbre', 'bonus', 'type', 'clientc', 'lignebonlivraisons', 'articles', 'bonlivraison', 'clients', 'depots', 'materieltransports', 'cartecarburants', 'chauffeurs', 'conffaieurs', 'adresselivraisonclients', 'es', 'rz', 'remcli', 'remes', 'cmde', 'commande'));
    }
    ...
    public function viewm($id = null)
    {
        ...
        $this->set(compact('agents', 'typetransports', 'BL', 'gs', 'not',  'remcli', 'remes', 'cl', 'exotva', 'exotpe', 'exofodec', 'clientc', 'lignebonlivraisons', 'articles', 'bonlivraison', 'clients', 'depots', 'materieltransports', 'cartecarburants', 'chauffeurs', 'conffaieurs', 'adresselivraisonclients', 'rz', 'es', 'cmde', 'commande'));
    }
    ...
    public function edit($id = null)
    {
        ...
        $this->set(compact('agents', 'typetransports', 'banques', 'piecereglementclients', 'paiements', 'valeurs', 'caisses', 'BL', 'not', 'gs', 'cl', 'commercials', 'tab', 'commercial', 'exotpe', 'exotva', 'exofodec', 'exotimbre', 'bonus', 'type', 'clientc', 'lignebonlivraisons', 'articles', 'bonlivraison', 'clients', 'depots', 'materieltransports', 'cartecarburants', 'chauffeurs', 'conffaieurs', 'adresselivraisonclients', 'es', 'rz', 'remcli', 'remes', 'cmde', 'commande'));
    }
    ...
    public function addbonlivraison($ids = null)
    {
        ...
        $this->set(compact('agents', 'typetransports', 'payment', 'nv_client', 'remes', 'remcli', 'BL', 'not', 'gs', 'es', 'rz', 'cl', 'exotva', 'exofodec', 'exotpe', 'tab', 'bonus', 'commercial', 'clientc', 'lignecommandes', 'commande', 'mm', 'articles', 'bonlivraison', 'clients', 'depots', 'materieltransports', 'cartecarburants', 'chauffeurs', 'conffaieurs', 'factureclients', 'adresselivraisonclients', 'client_id', 'depot_id', 'tab'));
    }
...
$conditionsdepensesolde[] = ["date(Depenses.date) > '" . $thiscaisse->date . "'"];
$conditionstransfertsolde[] = ["date(Transferecaisses.date) > '" . $thiscaisse->date . "'"];
// $conditionstransfertsolde[] = ["date(Transferecaisses.date) >'" . $thiscaisse->date . "'"];
...
->where(['caisse_id' => $caisse_id, $conditionsdepensedebut,$conditionsdepensesolde, $condp2])->all();
echo($depensesini);
$transfertdepartsini = $transferecaissesTable->find()
->select(['total' => $transferecaissesTable->find()->func()->sum('montant')])
->where(['caisse_id' => $caisse_id, $conditionstransfertdebut,$conditionstransfertsolde, $condp3])->all();
debug($transfertdepartsini);

$transfertarrivesini = $transferecaissesTable->find()
->select(['total' => $transferecaissesTable->find()->func()->sum('montant')])
->where(['id_caisse' => $caisse_id, $conditionstransfertdebut,$conditionstransfertsolde, $condp3])->all();
debug($transfertarrivesini);
