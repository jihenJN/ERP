...
//    }
    ...
    public function edit($id = null) {
        ...
        $clienta = $this->fetchTable('Clients')->get($commande->client_id, [
            'contain' => ['Localites', 'Delegations']
        ]);
         //debug($client);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $this->set(compact('exotva', 'exofodec', 'exotimbre', 'exotpe', 'clienta', 'lignecommandes', 'commande', 'depots', 'clients', 'commercials', 'articles', 'timbre', 'pointdeventes', 'escompte'));
    }
