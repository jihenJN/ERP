...
class CommandesController extends AppController
{
     ...
     public function imprimeview($id = null)
    {
        ...
        $this->set(compact('lignecommandes', 'articles', 'commande', 'clients'));
    }
  ...
  public function index()
    {
       ...
       // debug($datefin);
        ...
        $query = $this->Commandes->find('all')->where([$cond2, $cond3, $cond4, $cond5, $cond6]);
        $this->paginate = [
...
//    }
    ...
    public function view($id = null)
    {
        ...
        $this->set(compact('depots', 'commandes', 'lignecommandes', 'articles', 'commande', 'clients', 'commercials', 'commercialsoptions'));
    }
