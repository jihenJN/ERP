...
//        $this->belongsTo('Lignelivraisons', [
//            'foreignKey' => 'lignelivraison_id',
//            'joinType' => 'INNER',
//        ]);
//        $this->belongsTo('Lignebonusmalus', [
//            'foreignKey' => 'lignebonusmalu_id',
//            'joinType' => 'INNER',
//        ]);
    ...
    {
        //$rules->add($rules->existsIn('lignelivraison_id', 'Lignelivraisons'), ['errorField' => 'lignelivraison_id']);
       // $rules->add($rules->existsIn('lignebonusmalu_id', 'Lignebonusmalus'), ['errorField' => 'lignebonusmalu_id']);
