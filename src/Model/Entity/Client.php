 ...
 * @property int|null $typeexoneration_id
 ...
 * @property string $nouveau_client
 * @property \Cake\I18n\FrozenDate|null $date_ajout
 * @property int $compte_comptable
 * @property int $bureauposte
