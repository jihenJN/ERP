...
/**
 * Lignefactureproformat Entity
 *
 * @property int $id
 * @property int|null $factureproformat_id
 ...
 * @property string $tpe
 *
 * @property \App\Model\Entity\Factureproformat $commande
 * @property \App\Model\Entity\Article $article
 */
class Lignefactureproformat extends Entity
{
    /**
